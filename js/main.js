    ...
    if ($.fn.countdown !== undefined && $.fn.countdown !== null) {
        $('.countdown').each(function () {
            ...
            _this.countdown(_this.attr("data-enddate")).on('update.countdown', function (event) {
                _this.html(event.strftime('' + '<div class="counter-container"><div class="countdown-box first"><div class="number">%-D</div><span>روز</span></div>' + '<div class="countdown-box"><div class="number">%H</div><span>ساعت</span></div>' + '<div class="countdown-box"><div class="number">%M</div><span>دقیقه</span></div>' + '<div class="countdown-box last"><div class="number">%S</div><span>ثانیه</span></div></div>'));
            }).on('finish.countdown', function (event) {
                _this.html(event.strftime('' + '<div class="counter-container"><div class="countdown-box first" data-number="00"><div class="number">00</div><span>روز</span></div>' + '<div class="countdown-box"><div class="number">00</div><span>ساعت</span></div>' + '<div class="countdown-box"><div class="number">00</div><span>دقیقه</span></div>' + '<div class="countdown-box last"><div class="number">00</div><span>ثانیه</span></div></div>'));
            });
        });
    }
                ...
                for (var x in response.data) {
                    if (x < parseInt(total)) {
                        if (response.data[x]['media_type'] == 'IMAGE' || response.data[x]['media_type'] == 'CAROUSEL_ALBUM') {
                            ...
                            var link = response.data[x]['permalink'] || '', video = response.data[x]['media_url'] || '';
