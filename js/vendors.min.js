...
!function (e, t) {
    ...
    var o = {
            ...
            autoplay: !0,
            timelineOffset: 0
        }, _ = {duration: 1e3, delay: 0, endDelay: 0, easing: "easeOutElastic(1, .5)", round: 0},
    ...
    function a(n, i) {
        var e = p(n), t = S(x.und(e[0]) ? 1 : e[0], .1, 100), r = S(x.und(e[1]) ? 100 : e[1], .1, 100),
            s = S(x.und(e[2]) ? 10 : e[2], .1, 100), e = S(x.und(e[3]) ? 0 : e[3], .1, 100), a = Math.sqrt(r / t),
            o = s / (2 * Math.sqrt(r * t)), l = o < 1 ? a * Math.sqrt(1 - o * o) : 0,
            c = o < 1 ? (o * a - e) / l : -e + a;
    ...
    function F(b, t, _, i) {
        if (0 <= b && b <= 1 && 0 <= _ && _ <= 1) {
            ...
            if (b !== t || _ !== i) for (var e = 0; e < 11; ++e) w[e] = T(.1 * e, b, _);
            return function (e) {
                return b === t && _ === i || 0 === e || 1 === e ? e : T(function (e) {
                    for (var t = 0, i = 1; 10 !== i && w[i] <= e; ++i) t += .1;
                    var n = t + (e - w[--i]) / (w[i + 1] - w[i]) * .1, r = E(n, b, _);
                    if (.001 <= r) {
                    ...
                    if (0 === r) return n;
                    for (var u, p, h = e, f = t, m = t + .1, g = b, v = _, y = 0; 0 < (u = T(p = f + (m - f) / 2, g, v) - h) ? m = p : f = p, 1e-7 < Math.abs(u) && ++y < 10;) ;
                    return p
                }(e), t, i)
            }
        }
    ...
    t = {
        ...
        Sine: function () {
            ...
            void 0 === t && (t = .5);
            var i = S(e = void 0 === e ? 1 : e, 1, 10), n = S(t, .1, 2);
            return function (e) {
        ...
        var n = i[e];
        t["easeIn" + e] = n, t["easeOut" + e] = function (t, i) {
            return function (e) {
                return 1 - n(t, i)(1 - e)
            }
    ...
    function M(e, t) {
        for (var i, n = e.length, r = 2 <= arguments.length ? t : void 0, s = [], a = 0; a < n; a++) a in e && (i = e[a], t.call(r, i, a, e)) && s.push(i);
        return s
    }
    ...
    function I(e) {
        if (e = /[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?(%|px|pt|em|rem|in|cm|mm|ex|ch|pc|vw|vh|vmin|vmax|deg|rad|turn)?$/.exec(e)) return e[1]
    }
    ...
    function y(e, t, i) {
        var n, r, s;
        return f([i, "deg", "rad", "turn"], I(t)) ? t : (n = u.CSS[t + i], x.und(n) ? (r = document.createElement(e.tagName), (e = e.parentNode && e.parentNode !== document ? e.parentNode : document.body).appendChild(r), r.style.position = "absolute", r.style.width = 100 + i, s = 100 / r.offsetWidth, e.removeChild(r), e = s * parseFloat(t), u.CSS[t + i] = e) : n)
    }

    function N(e, t, i) {
        var n;
        if (t in e.style) return n = t.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase(), t = e.style[t] || getComputedStyle(e).getPropertyValue(n) || "0", i ? y(e, t, i) : t
    }
    ...
    function A(e, t, i, n) {
        switch (b(e, t)) {
            case"transform":
                return r = e, a = n, o = i, l = c(s = t, "scale") ? 1 : 0 + (c(l = s, "translate") || "perspective" === l ? "px" : c(l, "rotate") || c(l, "skew") ? "deg" : void 0), l = H(r).get(s) || l, a && (a.transforms.list.set(s, l), a.transforms.last = s), o ? y(r, l, o) : l;
            case"css":
                return N(e, t, i);
            case"attribute":
                return v(e, t);
    ...
    function O(e, t) {
        var i = /^(\*=|\+=|-=)/.exec(e);
        if (!i) return e;
        var n = I(e) || 0, r = parseFloat(t), s = parseFloat(e.replace(i[0], ""));
        switch (i[0][0]) {
            case"+":
                return r + s + n;
            case"-":
    ...
    function W(e, t) {
        var i, n, r, s, a, o, l;
        return x.col(e) ? (i = e, x.rgb(i) ? (o = /rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec(n = i)) ? "rgba(" + o[1] + ",1)" : n : x.hex(i) ? (o = (o = i).replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function (e, t, i, n) {
            return t + t + i + i + n + n
        }), o = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(o), "rgba(" + parseInt(o[1], 16) + "," + parseInt(o[2], 16) + "," + parseInt(o[3], 16) + ",1)") : x.hsl(i) ? (n = /hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec(n = i) || /hsla\((\d+),\s*([\d.]+)%,\s*([\d.]+)%,\s*([\d.]+)\)/g.exec(n), i = parseInt(n[1], 10) / 360, o = parseInt(n[2], 10) / 100, l = parseInt(n[3], 10) / 100, n = n[4] || 1, 0 == o ? r = s = a = l : (r = c(o = 2 * l - (l = l < .5 ? l * (1 + o) : l + o - l * o), l, i + 1 / 3), s = c(o, l, i), a = c(o, l, i - 1 / 3)), "rgba(" + 255 * r + "," + 255 * s + "," + 255 * a + "," + n + ")") : void 0) : /\s/g.test(e) ? e : (o = (o = I(e)) ? e.substr(0, e.length - o.length) : e, t ? o + t : o);
    ...
    function Y(e) {
        ...
        switch (e.tagName.toLowerCase()) {
            ...
            case"line":
                return L({x: v(t = e, "x1"), y: v(t, "y1")}, {x: v(t, "x2"), y: v(t, "y2")});
            case"polyline":
                return q(e);
            case"polygon":
                return t = e.points, q(e) + L(t.getItem(t.numberOfItems - 1), t.getItem(0))
        }
        var t
    }
    ...
    function $(t, e) {
        var i = (t = (e = e || {}).el || function () {
                for (var e = t.parentNode; x.svg(e) && x.svg(e.parentNode);) e = e.parentNode;
                return e
            }()).getBoundingClientRect(), n = v(t, "viewBox"), r = i.width, i = i.height,
            e = e.viewBox || (n ? n.split(" ") : [0, 0, r, i]);
        return {el: t, viewBox: e, x: +e[0], y: +e[1], w: r, h: i, vW: e[2], vH: e[3]}
    }

    function X(e, t) {
        var i = /[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?/g, n = W(x.pth(e) ? e.totalLength : e, t) + "";
        return {
            original: n,
    ...
    function V(e, t) {
        ...
        for (i in t = r ? k(function (e) {
            ...
            }, []), i = {}, r = 0; r < t.length; r++) !function () {
                var n = t[r];
                i[n] = e.map(function (e) {
                    var t, i = {};
                    for (t in e) x.key(t) ? t == n && (i.value = e[t]) : i[t] = e[t];
                    return i
                })
            }();
            return i
        }(r), t) : t) x.key(i) && n.push({
            name: i, tweens: function (e, i) {
                var t, n = m(i),
                    r = (/^spring/.test(n.easing) && (n.duration = a(n.easing)), x.arr(e) && (2 !== (t = e.length) || x.obj(e[0]) ? x.fnc(i.duration) || (n.duration = i.duration / t) : e = {value: e}), x.arr(e) ? e : [e]);
                return r.map(function (e, t) {
                    return e = x.obj(e) && !x.pth(e) ? e : {value: e}, x.und(e.delay) && (e.delay = t ? 0 : i.delay), x.und(e.endDelay) && (e.endDelay = t === r.length - 1 ? i.endDelay : 0), e
                }).map(function (e) {
                    return k(e, n)
                })
            }(t[i], e)
    ...
    var U = {
        css: function (e, t, i) {
            ...
            var s;
            n.list.set(t, i), t !== n.last && !r || (s = "", n.list.forEach(function (e, t) {
                s += t + "(" + e + ") "
            }), e.style.transform = s)
        }
    };
    ...
    function Q(e, a) {
        G(e).forEach(function (e) {
            for (var t in a) {
                var i = g(a[t], e), n = e.target, r = A(n, t, s = I(i), e), i = O(W(i, s || I(r)), r), s = b(n, t);
    ...
    function K(e, t) {
        return M(d(e.map(function (s) {
            return t.map(function (e) {
                ...
                if (r) return l = n, i = (t = (o = e).tweens.map(function (e) {
                    var t = (e = function (e, t) {
                        ...
                        }(e, l)).value, i = x.arr(t) ? t[1] : t, n = I(i), r = A(l.target, o.name, n, l),
                        s = c ? c.to.original : r, a = x.arr(t) ? t[0] : s, r = I(a) || I(r), n = n || r;
                    return x.und(i) && (i = s), e.from = X(a, n), e.to = X(O(i, a), n), e.start = c ? c.end : 0, e.end = e.start + e.delay + e.duration + e.endDelay, e.easing = C(e.easing, e.duration), e.isPath = x.pth(t), e.isPathTargetInsideSVG = e.isPath && x.svg(l.target), e.isColor = x.col(e.from.original), e.isColor && (e.round = 1), c = e
                }))[t.length - 1], {
                    type: r,
                    property: e.name,
                    animatable: n,
    ...
    var z, J = 0, D = [],
        ee = ("undefined" != typeof document && document.addEventListener("visibilitychange", function () {
    ...
    function R(e) {
        ...
        t = w(o, e = void 0 === e ? {} : e), i = V(n = w(_, e), e), n = Z(i = K(e = G(e.targets), i), n), r = J, J++;
        var t, i, n, r, T = k(t, {
            id: r,
            children: [],
            animatables: e,
        ...
        function m() {
            var e = T.direction;
            "alternate" !== e && (T.direction = "normal" !== e ? "normal" : "reverse"), T.reversed = !T.reversed, l.forEach(function (e) {
        ...
        function y(t) {
            for (var e = 0, i = T.animations, n = i.length; e < n;) {
                for (var r = i[e], s = r.animatable, a = r.tweens, o = a[l = a.length - 1], l = (l && (o = M(a, function (e) {
                    return t < e.end
                })[0] || o), S(t - o.start - o.delay, 0, o.duration) / o.duration), c = isNaN(l) ? 1 : o.easing(l), d = o.to.strings, u = o.round, p = [], h = o.to.numbers.length, f = void 0, m = 0; m < h; m++) {
                    var g = void 0, v = o.to.numbers[m], y = o.from.numbers[m] || 0, g = o.isPath ? function (t, i, e) {
                        function n(e) {
                            return t.el.getPointAtLength(1 <= i + (e = void 0 === e ? 0 : e) ? i + e : 0)
                        }

                        var r = $(t.el, t.svg), s = n(), a = n(-1), o = n(1), l = e ? 1 : r.w / r.vW,
                            c = e ? 1 : r.h / r.vH;
                        switch (t.property) {
                            case"x":
                                return (s.x - r.x) * l;
                ...
                var b = d.length;
                if (b) for (var f = d[0], _ = 0; _ < b; _++) {
                    d[_];
                    var w = d[_ + 1], x = p[_];
                    isNaN(x) || (f += w ? x + w : x + " ")
                } else f = p[0];
                U[r.type](s.target, r.property, f, s.transforms), r.currentValue = f, e++
            }
        }
        ...
        function a(e) {
            var t = T.duration, i = T.delay, n = t - T.endDelay, r = g(e);
            if (T.progress = S(r / t * 100, 0, 100), T.reversePlayback = r < T.currentTime, l) {
                var s = r;
                if (T.reversePlayback) for (var a = p; a--;) v(s, l[a]); else for (var o = 0; o < p; o++) v(s, l[o])
            }
            !T.began && 0 < T.currentTime && (T.began = !0, b("begin")), !T.loopBegan && 0 < T.currentTime && (T.loopBegan = !0, b("loopBegin")), r <= i && 0 !== T.currentTime && y(0), (n <= r && T.currentTime !== t || !t) && y(t), i < r && r < n ? (T.changeBegan || (T.changeBegan = !0, T.changeCompleted = !1, b("changeBegin")), b("change"), y(r)) : T.changeBegan && (T.changeCompleted = !0, T.changeBegan = !1, b("changeComplete")), T.currentTime = S(r, 0, t), T.began && b("update"), t <= e && (d = 0, T.remaining && !0 !== T.remaining && T.remaining--, T.remaining ? (c = u, b("loopComplete"), T.loopBegan = !1, "alternate" === T.direction && m()) : (T.paused = !0, T.completed || (T.completed = !0, b("loopComplete"), b("complete"), !T.passThrough && "Promise" in window && (h(), f(T)))))
        }

        return f(T), T.reset = function () {
            var e = T.direction;
            T.passThrough = !1, T.currentTime = 0, T.progress = 0, T.paused = !0, T.began = !1, T.loopBegan = !1, T.changeBegan = !1, T.completed = !1, T.changeCompleted = !1, T.reversePlayback = !1, T.reversed = "reverse" === e, T.remaining = T.loop, l = T.children;
            for (var t = p = l.length; t--;) T.children[t].reset();
            (T.reversed && !0 !== T.loop || "alternate" === e && 1 === T.loop) && T.remaining++, y(T.reversed ? T.duration : 0)
        }, T._onDocumentVisibility = s, T.set = function (e, t) {
            return Q(e, t), T
        }, T.tick = function (e) {
            ...
            T.paused && (T.completed && T.reset(), T.paused = !1, D.push(T), s(), ee())
        }, T.reverse = function () {
    ...
    function ie(e, t) {
        for (var i = t.length; i--;) f(e, t[i].animatable.target) && t.splice(i, 1)
    }

    function ne(e, t) {
        var i = t.animations, n = t.children;
        ie(e, i);
        for (var r = n.length; r--;) {
            var s = n[r], a = s.animations;
            ie(e, a), a.length || s.children.length || n.splice(r, 1)
        }
        i.length || n.length || t.pause()
    }

    return R.version = "3.2.2", R.speed = 1, R.suspendWhenDocumentHidden = !0, R.running = D, R.remove = function (e) {
        for (var t = P(e), i = D.length; i--;) ne(t, D[i])
    }, R.get = A, R.set = Q, R.convertPx = y, R.path = function (e, t) {
        var i = x.str(e) ? r(e)[0] : e, n = t || 100;
        return function (e) {
        ...
        var o = (t = void 0 === t ? {} : t).direction || "normal", l = t.easing ? C(t.easing) : null, c = t.grid,
            d = t.axis, u = t.from || 0, p = "first" === u, h = "center" === u, f = "last" === u, m = x.arr(e),
            g = m ? parseFloat(e[0]) : parseFloat(e), v = m ? parseFloat(e[1]) : 0, y = I(m ? e[1] : e) || 0,
            b = t.start || 0 + (m ? g : 0), _ = [], w = 0;
        return function (e, t, i) {
            if (p && (u = 0), h && (u = (i - 1) / 2), f && (u = i - 1), !_.length) {
                for (var n, r, s, a = 0; a < i; a++) c ? (n = h ? (c[0] - 1) / 2 : u % c[0], r = h ? (c[1] - 1) / 2 : Math.floor(u / c[0]), n -= a % c[0], r -= Math.floor(a / c[0]), s = Math.sqrt(n * n + r * r), "x" === d && (s = -n), _.push(s = "y" === d ? -r : s)) : _.push(Math.abs(u - a)), w = Math.max.apply(Math, _);
        ...
        return o.duration = 0, o.add = function (e, t) {
            var i = D.indexOf(o), n = o.children;
            ...
            return (i = k(e, w(_, a))).targets = i.targets || a.targets, e = o.duration, i.autoplay = !1, i.direction = o.direction, i.timelineOffset = x.und(t) ? e : O(t, e), r(o), o.seek(i.timelineOffset), r(t = R(i)), n.push(t), e = Z(n, a), o.delay = e.delay, o.endDelay = e.endDelay, o.duration = e.duration, o.seek(0), o.reset(), o.autoplay && o.play(), o
        }, o
    }, R.easing = C, R.penner = l, R.random = function (e, t) {
...
var Atropos = function () {
    ...
    return function (e) {
        ...
        function n(e) {
            v = void 0, "pointerdown" === e.type && "mouse" === e.pointerType || "pointerenter" === e.type && "mouse" !== e.pointerType || ("pointerdown" === e.type && e.preventDefault(), y = e.clientX, b = e.clientY, M.alwaysActive ? m = f = void 0 : (j(), "function" == typeof M.onEnter && M.onEnter()))
        }
        ...
        function s(e) {
            if (M.rotate && C.isActive) {
                ...
                var t = e.clientX, i = e.clientY, n = t - y, r = i - b;
                "string" != typeof M.rotateTouch || 0 == n && 0 == r || void 0 !== v || (25 <= n * n + r * r && (r = 180 * Math.atan2(Math.abs(r), Math.abs(n)) / Math.PI, v = "scroll-y" === M.rotateTouch ? 45 < r : 45 < 90 - r), !1 === v && (T.classList.add("atropos-rotate-touch"), e.cancelable) && e.preventDefault()), "mouse" !== e.pointerType && v || z(t, i)
            }
        }
        ...
        var c, o, l, h, d, u, f, m, p, g, v, y, b, _, w, x, T = (E = e = void 0 === e ? {} : e).el, S = E.eventsEl,
            E = e.isComponent, C = {
                __atropos__: !0,
                params: B({}, N, {
                    onEnter: null,
                    onLeave: null,
                    onRotate: null
                }, (void 0 === (o = e || {}) && (o = {}), l = {}, Object.keys(o).forEach(function (e) {
                    void 0 !== o[e] && (l[e] = o[e])
                }), l)),
                destroyed: !1,
                isActive: !1
                ...
                _ = requestAnimationFrame(function () {
                    k.forEach(function (e) {
                        var t, i;
                        "function" == typeof e ? e() : (t = e.element, i = e.prop, e = e.value, t.style[i] = e)
                ...
                var t = e.rotateXPercentage, r = void 0 === t ? 0 : t, t = e.rotateYPercentage, s = void 0 === t ? 0 : t,
                    a = e.duration, o = e.opacityOnly, l = e.easeOut;
                t = "[data-atropos-offset], [data-atropos-opacity]", c.querySelectorAll(t).forEach(function (e) {
                    I(e, a), A(e, l ? "ease-out" : "");
                    var t, i, n = function (e) {
                        if (e.dataset.atroposOpacity && "string" == typeof e.dataset.atroposOpacity) return e.dataset.atroposOpacity.split(";").map(function (e) {
                            return parseFloat(e)
                        })
                    }(e);
                    0 === r && 0 === s ? (o || O(e, "translate3d(0, 0, 0)"), n && L(e, n[0])) : (t = parseFloat(e.dataset.atroposOffset) / 100, Number.isNaN(t) || o || O(e, "translate3d(" + -s * -t + "%, " + r * -t + "%, 0)"), n && (t = n[0], n = n[1], i = Math.max(Math.abs(r), Math.abs(s)), L(e, t + (n - t) * i / 100)))
                })
            }, z = function (e, t) {
                var i, n = T !== S,
                    r = (f = f || T.getBoundingClientRect(), n && !m && (m = S.getBoundingClientRect()), void 0 === e && void 0 === t && (e = (r = n ? m : f).left + r.width / 2, t = r.top + r.height / 2), 0),
                    s = 0, a = f, o = a.top, l = a.left, c = a.width, a = a.height,
                    d = (n ? (u = (p = m).top, i = p.left, d = p.width, p = p.height, s = M.rotateYMax * (e - i - (c / 2 + (l - i))) / (d - c / 2) * -1, r = M.rotateXMax * (t - u - (a / 2 + (o - u))) / (p - a / 2), i = e - l + "px " + (t - o) + "px") : (s = M.rotateYMax * (e - l - c / 2) / (c / 2) * -1, r = M.rotateXMax * (t - o - a / 2) / (a / 2)), r = Math.min(Math.max(-r, -M.rotateXMax), M.rotateXMax), M.rotateXInvert && (r = -r), s = Math.min(Math.max(-s, -M.rotateYMax), M.rotateYMax), M.rotateYInvert && (s = -s), r / M.rotateXMax * 100),
                    u = s / M.rotateYMax * 100, p = (n ? u / 100 * M.stretchX : 0) * (M.rotateYInvert ? -1 : 1),
                    e = (n ? d / 100 * M.stretchY : 0) * (M.rotateXInvert ? -1 : 1),
                    l = n ? Math.max(Math.abs(d), Math.abs(u)) / 100 * M.stretchZ : 0;
                O(h, "translate3d(" + p + "%, " + -e + "%, " + -l + "px) rotateX(" + r + "deg) rotateY(" + s + "deg)"), i && M.commonOrigin && R(h, i), g && (I(g, M.duration + "ms"), A(g, "ease-out"), O(g, "translate3d(" + .25 * -u + "%, " + .25 * d + "%, 0)"), L(g, Math.max(Math.abs(d), Math.abs(u)) / 100)), P({
                    rotateXPercentage: d,
                    rotateYPercentage: u,
                ...
                }), I(h, M.duration + "ms"), A(h, "ease-out"), O(d, "translate3d(0,0, " + M.activeOffset + "px)"), I(d, M.duration + "ms"), A(d, "ease-out"), p && (I(p, M.duration + "ms"), A(p, "ease-out")), C.isActive = !0
            }, D = function (e) {
                m = f = void 0, !C.isActive || e && "pointerup" === e.type && "mouse" === e.pointerType || e && "pointerleave" === e.type && "mouse" !== e.pointerType || ("string" == typeof M.rotateTouch && v && T.classList.remove("atropos-rotate-touch"), M.alwaysActive ? z() : (k.push(function () {
                    return T.classList.remove("atropos-active")
                }), I(d, M.duration + "ms"), A(d, ""), O(d, "translate3d(0,0, 0px)"), p && (I(p, M.duration + "ms"), A(p, "")), g && (I(g, M.duration + "ms"), A(g, ""), O(g, "translate3d(0, 0, 0)"), L(g, 0)), I(h, M.duration + "ms"), A(h, ""), O(h, "translate3d(0,0,0) rotateX(0deg) rotateY(0deg)"), P({duration: M.duration + "ms"}), C.isActive = !1), "function" == typeof M.onRotate && M.onRotate(0, 0), "function" == typeof M.onLeave && M.onLeave())
            };
        return C.destroy = function () {
            C.destroyed = !0, cancelAnimationFrame(_), i(document, "click", a), i(S, "pointerdown", n), i(S, "pointerenter", n), i(S, "pointermove", s), i(S, "touchmove", r), i(S, "pointerleave", D), i(S, "pointerup", D), i(S, "lostpointercapture", D), delete T.__atropos__
        }, (T = "string" == typeof T ? F(document, T) : T) && !T.__atropos__ && (void 0 !== S ? "string" == typeof S && (S = F(document, S)) : S = T, c = E ? T.parentNode.host : T, Object.assign(C, {el: T}), h = F(T, ".atropos-rotate"), d = F(T, ".atropos-scale"), u = F(T, ".atropos-inner"), T.__atropos__ = C), T && S && (M.shadow && ((p = F(T, ".atropos-shadow")) || ((p = document.createElement("span")).classList.add("atropos-shadow"), w = !0), O(p, "translate3d(0,0,-" + M.shadowOffset + "px) scale(" + M.shadowScale + ")"), w) && h.appendChild(p), M.highlight && ((g = F(T, ".atropos-highlight")) || ((g = document.createElement("span")).classList.add("atropos-highlight"), x = !0), O(g, "translate3d(0,0,0)"), x) && u.appendChild(g), M.rotateTouch && ("string" == typeof M.rotateTouch ? T.classList.add("atropos-rotate-touch-" + M.rotateTouch) : T.classList.add("atropos-rotate-touch")), F(c, "[data-atropos-opacity]") && P({opacityOnly: !0}), t(document, "click", a), t(S, "pointerdown", n), t(S, "pointerenter", n), t(S, "pointermove", s), t(S, "touchmove", r), t(S, "pointerleave", D), t(S, "pointerup", D), t(S, "lostpointercapture", D), M.alwaysActive) && (j(), z()), C
    }
}();
/*!
    Bootstrap
...
!function (e, t) {
    ...
    const c = (e, t = [], i = e) => "function" == typeof e ? e(...t) : i, X = (i, n, e = !0) => {
        if (e) {
            e = (e => {
                if (!e) return 0;
            ...
            n.addEventListener(B, r), setTimeout(() => {
                t || N(n)
            }, e)
        } else c(i)
    }, G = (e, t, i, n) => {
        var r = e.length;
        let s = e.indexOf(t);
        return -1 === s ? !i && n ? e[r - 1] : e[0] : (s += i ? 1 : -1, n && (s = (s + r) % r), e[Math.max(0, Math.min(s, r - 1))])
    }, V = /[^.]*(?=\..*)\.|.*/, U = /\..*/, Q = /::\d+$/, K = {};
    let Z = 1;
    ...
    function se(n, r, s, a, o) {
        if ("string" == typeof r && n) {
            ...
            f ? f.oneOff = f.oneOff && o : (f = te(t, r.replace(V, "")), (r = e ? (u = n, p = s, h = t, function t(i) {
                var n = u.querySelectorAll(p);
                for (let e = i["target"]; e && e !== this; e = e.parentNode) for (const r of n) if (r === e) return le(i, {delegateTarget: e}), t.oneOff && m.off(u, i.type, p, h), h.apply(e, [i])
            }) : (c = n, d = t, function e(t) {
                return le(t, {delegateTarget: c}), e.oneOff && m.off(c, t.type, d), d.apply(c, [t])
            })).delegationSelector = e ? s : null, r.callable = t, r.oneOff = o, a[r.uidEvent = f] = r, n.addEventListener(i, r, e))
        }
    }
    ...
    const m = {
        on(e, t, i, n) {
            ...
            if ("string" == typeof t && e) {
                ...
                if (void 0 !== a) return Object.keys(d).length ? void ae(e, c, o, a, n ? i : null) : void 0;
                if (u) for (const _ of Object.keys(c)) {
                    h = p = y = v = g = m = f = void 0;
                    var p, h, f = e, m = c, g = _, v = t.slice(1), y = m[g] || {};
                    for ([p, h] of Object.entries(y)) p.includes(v) && ae(f, m, g, h.callable, h.delegationSelector)
                }
            ...
            t !== oe(t) && n && (r = n.Event(t, i), n(e).trigger(r), s = !r.isPropagationStopped(), a = !r.isImmediatePropagationStopped(), o = r.isDefaultPrevented());
            n = le(new Event(t, {bubbles: s, cancelable: !0}), i);
            return o && n.preventDefault(), a && e.dispatchEvent(n), n.defaultPrevented && r && r.preventDefault(), n
        }
    };
    ...
    class ue {
        ...
        _mergeConfigObj(e, t) {
            ...
            return {...this.constructor.Default, ..."object" == typeof i ? i : {}, ...s(t) ? d.getDataAttributes(t) : {}, ..."object" == typeof e ? e : {}}
        }
    ...
    class t extends ue {
        constructor(e, t) {
            super(), (e = r(e)) && (this._element = e, this._config = this._getConfig(t), R.set(this._element, this.constructor.DATA_KEY, this))
        }

        dispose() {
            R.remove(this._element, this.constructor.DATA_KEY), m.off(this._element, this.constructor.EVENT_KEY);
    ...
    const pe = t => {
        ...
        if (!i || "#" === i) {
            ...
            e.includes("#") && !e.startsWith("#") && (e = "#" + e.split("#")[1]), i = e && "#" !== e ? F(e.trim()) : null
        }
        return i
    }, u = {
    ...
    class fe extends t {
        ...
        close() {
            var e;
            m.trigger(this._element, "close.bs.alert").defaultPrevented || (this._element.classList.remove("show"), e = this._element.classList.contains("fade"), this._queueCallback(() => this._destroyElement(), this._element, e))
        }
    ...
    const i = ".bs.swipe", ve = (i, i, i, i, i, {endCallback: null, leftCallback: null, rightCallback: null}),
    ...
    var p = ".bs.carousel";
    const _e = "next", h = "prev", f = "left", we = "right", xe = "slid" + p;
    const Te = "carousel", Se = "active", Ee = ".active", Ce = ".carousel-item";
    Ee, Ce;
    const Me = {ArrowLeft: we, ArrowRight: f},
        ke = {interval: 5e3, keyboard: !0, pause: "hover", ride: !1, touch: !0, wrap: !0}, Ie = {
    ...
    class Ae extends t {
        ...
        to(e) {
            ...
            e > i.length - 1 || e < 0 || (this._isSliding ? m.one(this._element, xe, () => this.to(e)) : (t = this._getItemIndex(this._getActive())) !== e && (t = t < e ? _e : h, this._slide(t, i[e])))
        }
        ...
        _addEventListeners() {
            this._config.keyboard && m.on(this._element, "keydown.bs.carousel", e => this._keydown(e)), "hover" === this._config.pause && (m.on(this._element, "mouseenter.bs.carousel", () => this.pause()), m.on(this._element, "mouseleave.bs.carousel", () => this._maybeEnableCycle())), this._config.touch && be.isSupported() && this._addTouchEventListeners()
        }

        _addTouchEventListeners() {
            for (const t of u.find(".carousel-item img", this._element)) m.on(t, "dragstart.bs.carousel", e => e.preventDefault());
            var e = {
        ...
        _keydown(e) {
            var t;
            /input|textarea/i.test(e.target.tagName) || (t = Me[e.key]) && (e.preventDefault(), this._slide(this._directionToOrder(t)))
        }
        ...
        _setActiveIndicatorElement(e) {
            var t;
            this._indicatorsElement && ((t = u.findOne(Ee, this._indicatorsElement)).classList.remove(Se), t.removeAttribute("aria-current"), t = u.findOne(`[data-bs-slide-to="${e}"]`, this._indicatorsElement)) && (t.classList.add(Se), t.setAttribute("aria-current", "true"))
        }
        ...
        _slide(t, e = null) {
            if (!this._isSliding) {
                ...
                if (r !== n) {
                    const s = this._getItemIndex(r), a = e => m.trigger(this._element, e, {
                        relatedTarget: r,
                    ...
                    if (!e.defaultPrevented && n && r) {
                        ...
                        this._queueCallback(() => {
                            r.classList.remove(o, l), r.classList.add(Se), n.classList.remove(Se, l, o), this._isSliding = !1, a(xe)
    ...
    m.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", function (e) {
        ...
        t && t.classList.contains(Te) && (e.preventDefault(), e = Ae.getOrCreateInstance(t), (t = this.getAttribute("data-bs-slide-to")) ? e.to(t) : "next" === d.getDataAttribute(this, "slide") ? e.next() : e.prev(), e._maybeEnableCycle())
    }), m.on(window, "load.bs.carousel.data-api", () => {
        for (const e of u.find('[data-bs-ride="carousel"]')) Ae.getOrCreateInstance(e)
    }), e(Ae);
    const Oe = "show", g = "collapse", Le = "collapsing", Pe = (g, g, '[data-bs-toggle="collapse"]'),
        ze = {parent: null, toggle: !0}, De = {parent: "(null|element)", toggle: "boolean"};

    class Re extends t {
        constructor(e, t) {
            super(e, t), this._isTransitioning = !1, this._triggerArray = [];
            for (const r of u.find(Pe)) {
                var i = u.getSelectorFromElement(r), n = u.find(i).filter(e => e === this._element);
        ...
        show() {
            if (!this._isTransitioning && !this._isShown()) {
                let e = [];
                if (!(e = this._config.parent ? this._getFirstLevelChildren(".collapse.show, .collapse.collapsing").filter(e => e !== this._element).map(e => Re.getOrCreateInstance(e, {toggle: !1})) : e).length || !e[0]._isTransitioning) {
                    ...
                    if (!t.defaultPrevented) {
                        ...
                        this._queueCallback(() => {
                            this._isTransitioning = !1, this._element.classList.remove(Le), this._element.classList.add(g, Oe), this._element.style[i] = "", m.trigger(this._element, "shown.bs.collapse")
        ...
        hide() {
            if (!this._isTransitioning && this._isShown()) {
                ...
                if (!e.defaultPrevented) {
                    ...
                    this._element.style[e] = this._element.getBoundingClientRect()[e] + "px", q(this._element), this._element.classList.add(Le), this._element.classList.remove(g, Oe);
                    ...
                    this._element.style[e] = "", this._queueCallback(() => {
                        this._isTransitioning = !1, this._element.classList.remove(Le), this._element.classList.add(g), m.trigger(this._element, "hidden.bs.collapse")
                    }, this._element, !0)
                }
            }
        }
        ...
        _initializeChildren() {
            if (this._config.parent) for (const t of this._getFirstLevelChildren(Pe)) {
    ...
    m.on(document, "click.bs.collapse.data-api", Pe, function (e) {
        ...
        for (const t of u.getMultipleElementsFromSelector(this)) Re.getOrCreateInstance(t, {toggle: !1}).toggle()
    }), e(Re);
    var M = "top", k = "bottom", I = "right", A = "left", je = "auto", O = [M, k, I, A], L = "start", Be = "end",
        Fe = "clippingParents", Ne = "viewport", He = "popper", We = "reference", qe = O.reduce(function (e, t) {
            return e.concat([t + "-" + L, t + "-" + Be])
        }, []), Ye = [].concat(O, [je]).reduce(function (e, t) {
            return e.concat([t, t + "-" + L, t + "-" + Be])
        }, []), p = "beforeRead", $e = "afterRead", Xe = "beforeMain", Ge = "afterMain", Ve = "beforeWrite",
        Ue = "afterWrite", Qe = [p, "read", $e, Xe, "main", Ge, Ve, "write", Ue];
    ...
    var Ze = {
        name: "applyStyles", enabled: !0, phase: "write", fn: function (e) {
            ...
            Object.keys(r.elements).forEach(function (e) {
                var t = r.styles[e] || {}, i = r.attributes[e] || {}, n = r.elements[e];
                _(n) && v(n) && (Object.assign(n.style, t), Object.keys(i).forEach(function (e) {
                    var t = i[e];
            ...
            return Object.assign(n.elements.popper.style, r.popper), n.styles = r, n.elements.arrow && Object.assign(n.elements.arrow.style, r.arrow), function () {
                Object.keys(n.elements).forEach(function (e) {
                    var t = n.elements[e], i = n.attributes[e] || {},
    ...
    var C = Math.max, Je = Math.min, et = Math.round;
    ...
    function nt(e, t, i) {
        ...
        t && _(e) && (r = 0 < e.offsetWidth && et(n.width) / e.offsetWidth || 1, s = 0 < e.offsetHeight && et(n.height) / e.offsetHeight || 1);
        t = (y(e) ? b(e) : window).visualViewport, e = !it() && i, i = (n.left + (e && t ? t.offsetLeft : 0)) / r, e = (n.top + (e && t ? t.offsetTop : 0)) / s, t = n.width / r, r = n.height / s;
        return {width: t, height: r, top: e, right: i + t, bottom: e + r, left: i, x: i, y: e}
    }
    ...
    function lt(e) {
        for (var t, i = b(e), n = ot(e); n && (t = n, 0 <= ["table", "td", "th"].indexOf(v(t))) && "static" === w(n).position;) n = ot(n);
    ...
    var ft = {
        name: "arrow", enabled: !0, phase: "main", fn: function (e) {
            var t, i, n, r, s = e.state, a = e.name, e = e.options, o = s.elements.arrow,
                l = s.modifiersData.popperOffsets, c = ct(d = P(s.placement)),
                d = 0 <= [A, I].indexOf(d) ? "height" : "width";
            o && l && (e = e.padding, i = s, i = pt("number" != typeof (e = "function" == typeof e ? e(Object.assign({}, i.rects, {placement: i.placement})) : e) ? e : ht(e, O)), e = rt(o), r = "y" === c ? M : A, n = "y" === c ? k : I, t = s.rects.reference[d] + s.rects.reference[c] - l[c] - s.rects.popper[d], l = l[c] - s.rects.reference[c], o = (o = lt(o)) ? "y" === c ? o.clientHeight || 0 : o.clientWidth || 0 : 0, r = i[r], i = o - e[d] - i[n], r = dt(r, n = o / 2 - e[d] / 2 + (t / 2 - l / 2), i), s.modifiersData[a] = ((o = {})[c] = r, o.centerOffset = r - n, o))
        }, effect: function (e) {
            var t = e.state;
    ...
    function vt(e) {
        var t, i = e.popper, n = e.popperRect, r = e.placement, s = e.variation, a = e.offsets, o = e.position,
            l = e.gpuAcceleration, c = e.adaptive, d = e.roundOffsets, e = e.isFixed, u = a.x, u = void 0 === u ? 0 : u,
            p = a.y, p = void 0 === p ? 0 : p, h = "function" == typeof d ? d({x: u, y: p}) : {x: u, y: p},
            h = (u = h.x, p = h.y, a.hasOwnProperty("x")), a = a.hasOwnProperty("y"), f = A, m = M, g = window,
            v = (c && (v = "clientHeight", t = "clientWidth", (y = lt(i)) === b(i) && "static" !== w(y = x(i)).position && "absolute" === o && (v = "scrollHeight", t = "scrollWidth"), r !== M && (r !== A && r !== I || s !== Be) || (m = k, p = (p - ((e && y === g && g.visualViewport ? g.visualViewport.height : y[v]) - n.height)) * (l ? 1 : -1)), r !== A && (r !== M && r !== k || s !== Be) || (f = I, u = (u - ((e && y === g && g.visualViewport ? g.visualViewport.width : y[t]) - n.width)) * (l ? 1 : -1))), Object.assign({position: o}, c && gt)),
            y = !0 === d ? (r = {
                x: u,
                y: p
            }, s = b(i), e = r.x, r = r.y, s = s.devicePixelRatio || 1, {
                x: et(e * s) / s || 0,
                y: et(r * s) / s || 0
            }) : {x: u, y: p};
        return u = y.x, p = y.y, l ? Object.assign({}, v, ((t = {})[m] = a ? "0" : "", t[f] = h ? "0" : "", t.transform = (g.devicePixelRatio || 1) <= 1 ? "translate(" + u + "px, " + p + "px)" : "translate3d(" + u + "px, " + p + "px, 0)", t)) : Object.assign({}, v, ((n = {})[m] = a ? p + "px" : "", n[f] = h ? u + "px" : "", n.transform = "", n))
    }

    var yt = {
        name: "computeStyles", enabled: !0, phase: "beforeWrite", fn: function (e) {
            var t = e.state, e = e.options, i = void 0 === (i = e.gpuAcceleration) || i,
                n = void 0 === (n = e.adaptive) || n, e = void 0 === (e = e.roundOffsets) || e, i = {
    ...
    var _t = {
        name: "eventListeners", enabled: !0, phase: "write", fn: function () {
            ...
            var t = e.state, i = e.instance, n = (e = e.options).scroll, r = void 0 === n || n,
                s = void 0 === (n = e.resize) || n, a = b(t.elements.popper),
            ...
            }), s && a.addEventListener("resize", i.update, bt), function () {
    ...
    function kt(e, t) {
        ...
        var i = function e(t) {
            ...
            }(e), e = i === (null == (e = e.ownerDocument) ? void 0 : e.body), n = b(i),
            n = e ? [n].concat(n.visualViewport || [], Mt(i) ? i : []) : i, i = t.concat(n);
    ...
    function At(e, t, i) {
        return t === Ne ? It((r = i, a = b(n = e), o = x(n), a = a.visualViewport, l = o.clientWidth, o = o.clientHeight, d = c = 0, a && (l = a.width, o = a.height, (s = it()) || !s && "fixed" === r) && (c = a.offsetLeft, d = a.offsetTop), {
            width: l,
            height: o,
            x: c + Ct(n),
            y: d
        })) : y(t) ? ((r = nt(s = t, !1, "fixed" === (r = i))).top = r.top + s.clientTop, r.left = r.left + s.clientLeft, r.bottom = r.top + s.clientHeight, r.right = r.left + s.clientWidth, r.width = s.clientWidth, r.height = s.clientHeight, r.x = r.left, r.y = r.top, r) : It((a = x(e), l = x(a), o = Et(a), c = null == (c = a.ownerDocument) ? void 0 : c.body, n = C(l.scrollWidth, l.clientWidth, c ? c.scrollWidth : 0, c ? c.clientWidth : 0), d = C(l.scrollHeight, l.clientHeight, c ? c.scrollHeight : 0, c ? c.clientHeight : 0), a = -o.scrollLeft + Ct(a), o = -o.scrollTop, "rtl" === w(c || l).direction && (a += C(l.clientWidth, c ? c.clientWidth : 0) - n), {
            width: n,
            height: d,
            x: a,
            y: o
    ...
    function Ot(i, e, t, n) {
        var r,
            s = "clippingParents" === e ? (a = kt(at(s = i)), y(r = 0 <= ["absolute", "fixed"].indexOf(w(s).position) && _(s) ? lt(s) : s) ? a.filter(function (e) {
    ...
    function Lt(e) {
        var t, i = e.reference, n = e.element, e = e.placement, r = e ? P(e) : null, e = e ? mt(e) : null,
            s = i.x + i.width / 2 - n.width / 2, a = i.y + i.height / 2 - n.height / 2;
        switch (r) {
            case M:
    ...
    function Pt(e, t) {
        var n, t = t = void 0 === t ? {} : t, i = t.placement, i = void 0 === i ? e.placement : i, r = t.strategy,
            r = void 0 === r ? e.strategy : r, s = t.boundary, s = void 0 === s ? Fe : s, a = t.rootBoundary,
            a = void 0 === a ? Ne : a, o = t.elementContext, o = void 0 === o ? He : o, l = t.altBoundary,
            l = void 0 !== l && l, t = t.padding, t = void 0 === t ? 0 : t, t = pt("number" != typeof t ? t : ht(t, O)),
            c = e.rects.popper, l = e.elements[l ? o === He ? We : He : o],
            l = Ot(y(l) ? l : l.contextElement || x(e.elements.popper), s, a, r), s = nt(e.elements.reference),
            a = Lt({reference: s, element: c, strategy: "absolute", placement: i}), r = It(Object.assign({}, c, a)),
            c = o === He ? r : s, d = {
        ...
        return o === He && a && (n = a[i], Object.keys(d).forEach(function (e) {
            var t = 0 <= [I, k].indexOf(e) ? 1 : -1, i = 0 <= [M, k].indexOf(e) ? "y" : "x";
            d[e] += n[i] * t
        })), d
    }
    ...
    var zt = {
        name: "flip", enabled: !0, phase: "main", fn: function (e) {
            ...
            if (!u.modifiersData[e]._skip) {
                for (var i = t.mainAxis, n = void 0 === i || i, i = t.altAxis, r = void 0 === i || i, i = t.fallbackPlacements, p = t.padding, h = t.boundary, f = t.rootBoundary, s = t.altBoundary, a = t.flipVariations, m = void 0 === a || a, g = t.allowedAutoPlacements, a = u.options.placement, t = P(a), i = i || (t === a || !m ? [xt(a)] : P(i = a) === je ? [] : (t = xt(i), [St(i), t, St(t)])), o = [a].concat(i).reduce(function (e, t) {
                    return e.concat(P(t) === je ? (i = u, n = (e = e = void 0 === (e = {
                        placement: t,
                        boundary: h,
                        rootBoundary: f,
                        padding: p,
                    ...
                    }) ? {} : e).placement, r = e.boundary, s = e.rootBoundary, a = e.padding, o = e.flipVariations, l = void 0 === (e = e.allowedAutoPlacements) ? Ye : e, c = mt(n), e = c ? o ? qe : qe.filter(function (e) {
                        return mt(e) === c
                    }) : O, d = (n = 0 === (n = e.filter(function (e) {
                        return 0 <= l.indexOf(e)
                    })).length ? e : n).reduce(function (e, t) {
                        return e[t] = Pt(i, {placement: t, boundary: r, rootBoundary: s, padding: a})[P(t)], e
                    ...
                    var _ = o[b], w = P(_), x = mt(_) === L, T = 0 <= [M, k].indexOf(w), S = T ? "width" : "height",
                        E = Pt(u, {placement: _, boundary: h, rootBoundary: f, altBoundary: s, padding: p}),
                        T = T ? x ? I : A : x ? k : M, x = (l[S] > c[S] && (T = xt(T)), xt(T)), S = [];
                    if (n && S.push(E[w] <= 0), r && S.push(E[T] <= 0, E[x] <= 0), S.every(function (e) {
                        return e
                    })) {
                        y = _, v = !1;
                        break
                ...
                if (v) for (var C = m ? 3 : 1; 0 < C; C--) if ("break" === function (t) {
    ...
    var jt = {
        name: "hide", enabled: !0, phase: "main", requiresIfExists: ["preventOverflow"], fn: function (e) {
            var t = e.state, e = e.name, i = t.rects.reference, n = t.rects.popper, r = t.modifiersData.preventOverflow,
                s = Pt(t, {elementContext: "reference"}), a = Pt(t, {altBoundary: !0}), s = Dt(s, i), i = Dt(a, n, r),
                a = Rt(s), n = Rt(i);
            t.modifiersData[e] = {
    ...
    var Bt = {
        name: "offset", enabled: !0, phase: "main", requires: ["popperOffsets"], fn: function (e) {
            var a = e.state, t = e.options, e = e.name, o = void 0 === (t = t.offset) ? [0, 0] : t,
                t = Ye.reduce(function (e, t) {
                    var i, n, r, s;
                    return e[t] = (t = t, i = a.rects, n = o, r = P(t), s = 0 <= [A, M].indexOf(r) ? -1 : 1, t = (i = "function" == typeof n ? n(Object.assign({}, i, {placement: t})) : n)[0] || 0, n = (i[1] || 0) * s, 0 <= [A, I].indexOf(r) ? {
                        x: n,
                        y: t
                    } : {x: t, y: n}), e
                }, {}), i = (n = t[a.placement]).x, n = n.y;
            null != a.modifiersData.popperOffsets && (a.modifiersData.popperOffsets.x += i, a.modifiersData.popperOffsets.y += n), a.modifiersData[e] = t
        }
    };
    var Ft = {
    ...
    var Nt = {
        name: "preventOverflow", enabled: !0, phase: "main", fn: function (e) {
            var t, i, n, r, s, a, o, l, c, d = e.state, u = e.options, e = e.name, p = void 0 === (p = u.mainAxis) || p,
                h = void 0 !== (h = u.altAxis) && h, f = u.boundary, m = u.rootBoundary, g = u.altBoundary,
                v = u.padding, y = void 0 === (y = u.tether) || y, u = void 0 === (u = u.tetherOffset) ? 0 : u,
                f = Pt(d, {boundary: f, rootBoundary: m, padding: v, altBoundary: g}), m = P(d.placement),
                g = !(v = mt(d.placement)), b = ct(m), _ = "x" === b ? "y" : "x", w = d.modifiersData.popperOffsets,
                x = d.rects.reference, T = d.rects.popper,
                u = "number" == typeof (u = "function" == typeof u ? u(Object.assign({}, d.rects, {placement: d.placement})) : u) ? {
                    mainAxis: u,
                    altAxis: u
                } : Object.assign({mainAxis: 0, altAxis: 0}, u),
                S = d.modifiersData.offset ? d.modifiersData.offset[d.placement] : null, E = {x: 0, y: 0};
            w && (p && (p = "y" === b ? "height" : "width", a = (o = w[b]) + f[i = "y" === b ? M : A], l = o - f[c = "y" === b ? k : I], t = y ? -T[p] / 2 : 0, r = (v === L ? x : T)[p], v = v === L ? -T[p] : -x[p], s = d.elements.arrow, s = y && s ? rt(s) : {
                width: 0,
                height: 0
            }, i = (n = d.modifiersData["arrow#persistent"] ? d.modifiersData["arrow#persistent"].padding : ut())[i], n = n[c], c = dt(0, x[p], s[p]), s = g ? x[p] / 2 - t - c - i - u.mainAxis : r - c - i - u.mainAxis, r = g ? -x[p] / 2 + t + c + n + u.mainAxis : v + c + n + u.mainAxis, g = (i = d.elements.arrow && lt(d.elements.arrow)) ? "y" === b ? i.clientTop || 0 : i.clientLeft || 0 : 0, v = o + r - (t = null != (p = null == S ? void 0 : S[b]) ? p : 0), c = dt(y ? Je(a, o + s - t - g) : a, o, y ? C(l, v) : l), w[b] = c, E[b] = c - o), h && (n = "y" == _ ? "height" : "width", r = (i = w[_]) + f["x" === b ? M : A], p = i - f["x" === b ? k : I], s = -1 !== [M, A].indexOf(m), g = null != (t = null == S ? void 0 : S[_]) ? t : 0, a = s ? r : i - x[n] - T[n] - g + u.altAxis, v = s ? i + x[n] + T[n] - g - u.altAxis : p, o = y && s ? (l = dt(l = a, i, c = v), c < l ? c : l) : dt(y ? a : r, i, y ? v : p), w[_] = o, E[_] = o - i), d.modifiersData[e] = E)
    ...
    function Ht(e, t, i) {
        void 0 === i && (i = !1);
        var n = _(t),
            r = _(t) && (a = (r = t).getBoundingClientRect(), s = et(a.width) / r.offsetWidth || 1, a = et(a.height) / r.offsetHeight || 1, 1 !== s || 1 !== a),
            s = x(t), a = nt(e, r, i), e = {scrollLeft: 0, scrollTop: 0}, o = {x: 0, y: 0};
        return !n && i || ("body" === v(t) && !Mt(s) || (e = (n = t) !== b(n) && _(n) ? {
            scrollLeft: n.scrollLeft,
            scrollTop: n.scrollTop
        } : Et(n)), _(t) ? ((o = nt(t, !0)).x += t.clientLeft, o.y += t.clientTop) : s && (o.x = Ct(s))), {
            ...
            var i, s, a = {
                ...
                state: a, setOptions: function (e) {
                    var i, t, e = "function" == typeof e ? e(a.options) : e,
                        e = (d(), a.options = Object.assign({}, p, a.options, e), a.scrollParents = {
                    ...
                    if (!l) {
                        ...
                        if (Yt(t, e)) {
                            ...
                            for (var i, n, r, s = 0; s < a.orderedModifiers.length; s++) !0 === a.reset ? (a.reset = !1, s = -1) : (i = (r = a.orderedModifiers[s]).fn, n = r.options, r = r.name, "function" == typeof i && (a = i({
                                state: a,
                                options: void 0 === n ? {} : n,
                                name: r,
                                instance: c
    ...
    const Gt = Object.freeze(Object.defineProperty({
        ...
        viewport: Ne,
        write: "write"
    }, Symbol.toStringTag, {value: "Module"})), Vt = "dropdown";
    Ge = ".bs.dropdown", $e = ".data-api";
    const Ut = "ArrowDown";
    Ue = "click" + Ge + $e, ft = "keydown" + Ge + $e;
    const Qt = "show", T = '[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)', Kt = (T, ".dropdown-menu"),
        Zt = l() ? "top-end" : "top-start", Jt = l() ? "top-start" : "top-end",
        ei = l() ? "bottom-end" : "bottom-start", ti = l() ? "bottom-start" : "bottom-end",
        ii = l() ? "left-start" : "right-start", ni = l() ? "right-start" : "left-start", ri = {
            autoClose: !0,
    ...
    class S extends t {
        ...
        show() {
            if (!o(this._element) && !this._isShown()) {
                var e = {relatedTarget: this._element}, t = m.trigger(this._element, "show.bs.dropdown", e);
                if (!t.defaultPrevented) {
                    if (this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(".navbar-nav")) for (const i of [].concat(...document.body.children)) m.on(i, "mouseover", W);
                    this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.add(Qt), this._element.classList.add(Qt), m.trigger(this._element, "shown.bs.dropdown", e)
                }
            }
        }
        ...
        _completeHide(e) {
            ...
            if (!t.defaultPrevented) {
                if ("ontouchstart" in document.documentElement) for (const i of [].concat(...document.body.children)) m.off(i, "mouseover", W);
                this._popper && this._popper.destroy(), this._menu.classList.remove(Qt), this._element.classList.remove(Qt), this._element.setAttribute("aria-expanded", "false"), d.removeDataAttribute(this._menu, "popper"), m.trigger(this._element, "hidden.bs.dropdown", e)
            }
        }
        ...
        _getPlacement() {
            ...
            return t.classList.contains("dropend") ? ii : t.classList.contains("dropstart") ? ni : t.classList.contains("dropup-center") ? "top" : t.classList.contains("dropdown-center") ? "bottom" : (e = "end" === getComputedStyle(this._menu).getPropertyValue("--bs-position").trim(), t.classList.contains("dropup") ? e ? Jt : Zt : e ? ti : ei)
        }
        ...
        static clearMenus(e) {
            if (2 !== e.button && ("keyup" !== e.type || "Tab" === e.key)) for (const r of u.find('[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled).show')) {
                var t, i, n = S.getInstance(r);
                n && !1 !== n._config.autoClose && (t = (i = e.composedPath()).includes(n._menu), i.includes(n._element) || "inside" === n._config.autoClose && !t || "outside" === n._config.autoClose && t || n._menu.contains(e.target) && ("keyup" === e.type && "Tab" === e.key || /input|select|option|textarea|form/i.test(e.target.tagName)) || (i = {relatedTarget: n._element}, "click" === e.type && (i.clickEvent = e), n._completeHide(i)))
            }
        }
        ...
        static dataApiKeydownHandler(e) {
            ...
            !n && !i || t && !i || (e.preventDefault(), t = this.matches(T) ? this : u.prev(this, T)[0] || u.next(this, T)[0] || u.findOne(T, e.delegateTarget.parentNode), i = S.getOrCreateInstance(t), n ? (e.stopPropagation(), i.show(), i._selectMenuItem(e)) : i._isShown() && (e.stopPropagation(), i.hide(), t.focus()))
        }
    }

    m.on(document, ft, T, S.dataApiKeydownHandler), m.on(document, ft, Kt, S.dataApiKeydownHandler), m.on(document, Ue, S.clearMenus), m.on(document, "keyup.bs.dropdown.data-api", S.clearMenus), m.on(document, Ue, T, function (e) {
        e.preventDefault(), S.getOrCreateInstance(this).toggle()
    }), e(S);
    const ai = "backdrop", oi = "mousedown.bs." + ai,
        li = {className: "modal-backdrop", clickCallback: null, isAnimated: !1, isVisible: !0, rootElement: "body"},
        ci = {
            className: "string",
    ...
    class di extends ue {
        ...
        dispose() {
            this._isAppended && (m.off(this._element, oi), this._element.remove(), this._isAppended = !1)
        }
        ...
        _append() {
            var e;
            this._isAppended || (e = this._getElement(), this._config.rootElement.append(e), m.on(e, oi, () => {
    ...
    const ui = ".bs.focustrap", pi = (ui, ui, "backward"), hi = {autofocus: !0, trapElement: null},
    ...
    class mi extends ue {
        ...
        activate() {
            this._isActive || (this._config.autofocus && this._config.trapElement.focus(), m.off(document, ui), m.on(document, "focusin.bs.focustrap", e => this._handleFocusin(e)), m.on(document, "keydown.tab.bs.focustrap", e => this._handleKeydown(e)), this._isActive = !0)
        }
    ...
    const gi = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", vi = ".sticky-top", yi = "padding-right",
        bi = "margin-right";
    ...
    class _i {
        ...
        _setElementAttributes(e, i, n) {
            ...
            this._applyManipulationCallback(e, e => {
                var t;
                e !== this._element && window.innerWidth > e.clientWidth + r || (this._saveInitialAttribute(e, i), t = window.getComputedStyle(e).getPropertyValue(i), e.style.setProperty(i, n(Number.parseFloat(t)) + "px"))
            })
        }
        ...
        _applyManipulationCallback(e, t) {
            if (s(e)) t(e); else for (const i of u.find(e, this._element)) t(i)
        }
    }

    const E = ".bs.modal";
    E, E;
    const wi = "hidden" + E, xi = "show" + E;
    E, E, E, E, E;
    E;
    const Ti = "modal-open", Si = "modal-static";
    const Ei = {backdrop: !0, focus: !0, keyboard: !0},
        Ci = {backdrop: "(boolean|string)", focus: "boolean", keyboard: "boolean"};

    class Mi extends t {
        constructor(e, t) {
            super(e, t), this._dialog = u.findOne(".modal-dialog", this._element), this._backdrop = this._initializeBackDrop(), this._focustrap = this._initializeFocusTrap(), this._isShown = !1, this._isTransitioning = !1, this._scrollBar = new _i, this._addEventListeners()
        }
        ...
        show(e) {
            this._isShown || this._isTransitioning || m.trigger(this._element, xi, {relatedTarget: e}).defaultPrevented || (this._isShown = !0, this._isTransitioning = !0, this._scrollBar.hide(), document.body.classList.add(Ti), this._adjustDialog(), this._backdrop.show(() => this._showElement(e)))
        }
        ...
        dispose() {
            m.off(window, E), m.off(this._dialog, E), this._backdrop.dispose(), this._focustrap.deactivate(), super.dispose()
        }
        ...
        _showElement(e) {
            ...
            this._queueCallback(() => {
                this._config.focus && this._focustrap.activate(), this._isTransitioning = !1, m.trigger(this._element, "shown.bs.modal", {relatedTarget: e})
        ...
        _hideModal() {
            this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._backdrop.hide(() => {
                document.body.classList.remove(Ti), this._resetAdjustments(), this._scrollBar.reset(), m.trigger(this._element, wi)
            })
        }
        ...
        _adjustDialog() {
            var e, t = this._element.scrollHeight > document.documentElement.clientHeight,
                i = this._scrollBar.getWidth(), n = 0 < i;
    ...
    m.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', function (e) {
        ...
        ["A", "AREA"].includes(this.tagName) && e.preventDefault(), m.one(t, xi, e => {
    ...
    Xe = ".bs.offcanvas";
    const ki = "showing", Ii = ".offcanvas.show", Ai = "hidePrevented" + Xe, Oi = "hidden" + Xe;
    ...
    class z extends t {
        ...
        show(e) {
            this._isShown || m.trigger(this._element, "show.bs.offcanvas", {relatedTarget: e}).defaultPrevented || (this._isShown = !0, this._backdrop.show(), this._config.scroll || (new _i).hide(), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.classList.add(ki), this._queueCallback(() => {
                this._config.scroll && !this._config.backdrop || this._focustrap.activate(), this._element.classList.add("show"), this._element.classList.remove(ki), m.trigger(this._element, "shown.bs.offcanvas", {relatedTarget: e})
            }, this._element, !0))
        }
        ...
        hide() {
            this._isShown && !m.trigger(this._element, "hide.bs.offcanvas").defaultPrevented && (this._focustrap.deactivate(), this._element.blur(), this._isShown = !1, this._element.classList.add("hiding"), this._backdrop.hide(), this._queueCallback(() => {
                this._element.classList.remove("show", "hiding"), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._config.scroll || (new _i).reset(), m.trigger(this._element, Oi)
            }, this._element, !0))
        }
    ...
    m.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', function (e) {
        var t = u.getElementFromSelector(this);
        ["A", "AREA"].includes(this.tagName) && e.preventDefault(), o(this) || (m.one(t, Oi, () => {
            a(this) && this.focus()
        }), (e = u.findOne(Ii)) && e !== t && z.getInstance(e).hide(), z.getOrCreateInstance(t).toggle(this))
        ...
        for (const e of u.find("[aria-modal][class*=show][class*=offcanvas-]")) "fixed" !== getComputedStyle(e).position && z.getOrCreateInstance(e).hide()
    }), he(z), e(z);
    p = {
    ...
    function Ri(e, t, i) {
        ...
        for (const a of [].concat(...i.body.querySelectorAll("*"))) {
            ...
            if (Object.keys(t).includes(n)) {
                var r = [].concat(...a.attributes), s = [].concat(t["*"] || [], t[n] || []);
                for (const o of r) ((e, t) => {
    ...
    const ji = {
        ...
        template: "string"
    }, Fi = {entry: "(string|element|function|null)", selector: "(string|element)"};
    ...
    class Ni extends ue {
        ...
        toHtml() {
            ...
            var n = i.children[0], r = this._resolvePossibleFunction(this._config.extraClass);
        ...
        _checkContent(e) {
            for (var [t, i] of Object.entries(e)) super._typeCheckConfig({selector: t, entry: i}, Fi)
        }
    ...
    const Hi = new Set(["sanitize", "allowList", "sanitizeFn"]), Wi = "fade";
    const qi = "show", Yi = "hide.bs.modal", $i = "hover", Xi = "focus",
        Gi = {AUTO: "auto", TOP: "top", RIGHT: l() ? "left" : "right", BOTTOM: "bottom", LEFT: l() ? "right" : "left"},
        Vi = {
            allowList: p,
            animation: !0,
            boundary: "clippingParents",
    ...
    class Qi extends t {
        ...
        dispose() {
            clearTimeout(this._timeout), m.off(this._element.closest(".modal"), Yi, this._hideModalHandler), this._element.getAttribute("data-bs-original-title") && this._element.setAttribute("title", this._element.getAttribute("data-bs-original-title")), this._disposePopper(), super.dispose()
        }
        ...
        show() {
            ...
            if (this._isWithContent() && this._isEnabled) {
                ...
                if (!e.defaultPrevented && t) {
                    ...
                    if (this._element.ownerDocument.documentElement.contains(this.tip) || (t.append(e), m.trigger(this._element, this.constructor.eventName("inserted"))), this._popper = this._createPopper(e), e.classList.add(qi), "ontouchstart" in document.documentElement) for (const i of [].concat(...document.body.children)) m.on(i, "mouseover", W);
                    this._queueCallback(() => {
        ...
        hide() {
            if (this._isShown()) {
                ...
                if (!e.defaultPrevented) {
                    if (this._getTipElement().classList.remove(qi), "ontouchstart" in document.documentElement) for (const t of [].concat(...document.body.children)) m.off(t, "mouseover", W);
                    this._activeTrigger.click = !1, this._activeTrigger[Xi] = !1, this._activeTrigger[$i] = !1, this._isHovered = null;
                    this._queueCallback(() => {
        ...
        _createTipElement(e) {
            ...
            if (!e) return null;
            e.classList.remove(Wi, qi), e.classList.add(`bs-${this.constructor.NAME}-auto`);
            var t = (e => {
                for (; e += Math.floor(1e6 * Math.random()), document.getElementById(e);) ;
                return e
            })(this.constructor.NAME).toString();
            return e.setAttribute("id", t), this._isAnimated() && e.classList.add(Wi), e
        }
        ...
        _createPopper(e) {
            var t = c(this._config.placement, [this, e, this._element]), t = Gi[t.toUpperCase()];
        ...
        _setListeners() {
            ...
            }) : "manual" !== i && (e = i === $i ? this.constructor.eventName("mouseenter") : this.constructor.eventName("focusin"), t = i === $i ? this.constructor.eventName("mouseleave") : this.constructor.eventName("focusout"), m.on(this._element, e, this._config.selector, e => {
                var t = this._initializeOnDelegatedTarget(e);
                t._activeTrigger["focusin" === e.type ? Xi : $i] = !0, t._enter()
            }), m.on(this._element, t, this._config.selector, e => {
                var t = this._initializeOnDelegatedTarget(e);
                t._activeTrigger["focusout" === e.type ? Xi : $i] = t._element.contains(e.relatedTarget), t._leave()
            }));
    ...
    const rn = {offset: null, rootMargin: "0px 0px -25%", smoothScroll: !1, target: null, threshold: [.1, .5, 1]},
        sn = {
            offset: "(number|null)",
            rootMargin: "string",
    ...
    class an extends t {
        ...
        _observerCallback(e) {
            ...
            for (const a of e) if (a.isIntersecting) {
        ...
        _initializeTargetsAndObservables() {
            ...
            for (const t of u.find(nn, this._config.target)) t.hash && !o(t) && (e = u.findOne(decodeURI(t.hash), this._element), a(e)) && (this._targetLinks.set(decodeURI(t.hash), t), this._observableSections.set(t.hash, e))
        }

        _process(e) {
            this._activeTarget !== e && (this._clearActiveClass(this._config.target), (this._activeTarget = e).classList.add(tn), this._activateParents(e), m.trigger(this._element, "activate.bs.scrollspy", {relatedTarget: e}))
        }

        _activateParents(e) {
            if (e.classList.contains("dropdown-item")) u.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add(tn); else for (const t of u.parents(e, ".nav, .list-group")) for (const i of u.prev(t, ".nav-link, .nav-item > .nav-link, .list-group-item")) i.classList.add(tn)
        }
    ...
    const on = "ArrowRight", ln = "ArrowDown", cn = "Home", D = "active", dn = "show", un = ".dropdown-toggle";
    un;
    ...
    class hn extends t {
        constructor(e) {
            super(e), this._parent = this._element.closest('.list-group, .nav, [role="tablist"]'), this._parent && (this._setInitialAttributes(this._parent, this._getChildren()), m.on(this._element, "keydown.bs.tab", e => this._keydown(e)))
        }
        ...
        show() {
            ...
            this._elemIsActive(i) || (t = (e = this._getActiveElem()) ? m.trigger(e, "hide.bs.tab", {relatedTarget: i}) : null, m.trigger(i, "show.bs.tab", {relatedTarget: e}).defaultPrevented) || t && t.defaultPrevented || (this._deactivate(e, i), this._activate(i, e))
        }

        _activate(e, t) {
            e && (e.classList.add(D), this._activate(u.getElementFromSelector(e)), this._queueCallback(() => {
                "tab" !== e.getAttribute("role") ? e.classList.add(dn) : (e.removeAttribute("tabindex"), e.setAttribute("aria-selected", !0), this._toggleDropDown(e, !0), m.trigger(e, "shown.bs.tab", {relatedTarget: t}))
            }, e, e.classList.contains("fade")))
        }

        _deactivate(e, t) {
            e && (e.classList.remove(D), e.blur(), this._deactivate(u.getElementFromSelector(e)), this._queueCallback(() => {
                "tab" !== e.getAttribute("role") ? e.classList.remove(dn) : (e.setAttribute("aria-selected", !1), e.setAttribute("tabindex", "-1"), this._toggleDropDown(e, !1), m.trigger(e, "hidden.bs.tab", {relatedTarget: t}))
            }, e, e.classList.contains("fade")))
        }
        ...
        _keydown(t) {
            if (["ArrowLeft", on, "ArrowUp", ln, cn, "End"].includes(t.key)) {
                ...
                let e;
                (e = [cn, "End"].includes(t.key) ? n[t.key === cn ? 0 : n.length - 1] : (i = [on, ln].includes(t.key), G(n, t.target, i, !0))) && (e.focus({preventScroll: !0}), hn.getOrCreateInstance(e).show())
            }
        }
        ...
        _toggleDropDown(e, i) {
            ...
            })(un, D), e(".dropdown-menu", dn), n.setAttribute("aria-expanded", i))
        }
    ...
    const fn = "show", mn = "showing", gn = {animation: "boolean", autohide: "boolean", delay: "number"},
    ...
    class yn extends t {
        ...
        show() {
            m.trigger(this._element, "show.bs.toast").defaultPrevented || (this._clearTimeout(), this._config.animation && this._element.classList.add("fade"), this._element.classList.remove("hide"), q(this._element), this._element.classList.add(fn, mn), this._queueCallback(() => {
                this._element.classList.remove(mn), m.trigger(this._element, "shown.bs.toast"), this._maybeScheduleHide()
            }, this._element, this._config.animation))
        }

        hide() {
            this.isShown() && !m.trigger(this._element, "hide.bs.toast").defaultPrevented && (this._element.classList.add(mn), this._queueCallback(() => {
                this._element.classList.add("hide"), this._element.classList.remove(mn, fn), m.trigger(this._element, "hidden.bs.toast")
            }, this._element, this._config.animation))
        }

        dispose() {
            this._clearTimeout(), this.isShown() && this._element.classList.remove(fn), super.dispose()
        }
        ...
        _setListeners() {
            m.on(this._element, "mouseover.bs.toast", e => this._onInteraction(e, !0)), m.on(this._element, "mouseout.bs.toast", e => this._onInteraction(e, !1)), m.on(this._element, "focusin.bs.toast", e => this._onInteraction(e, !0)), m.on(this._element, "focusout.bs.toast", e => this._onInteraction(e, !1))
        }
...
!*/
    function (e, t) {
        ...
        function v(e, t, i, n) {
            Ct.length && !j && Rt(), e.render(t, i, n || j && t < 0 && (e._initted || e._startAt)), Ct.length && !j && Rt()
        }
        ...
        function _(e, t) {
            for (var i in t) "__proto__" !== i && "constructor" !== i && "prototype" !== i && (e[i] = k(t[i]) ? _(e[i] || (e[i] = {}), t[i]) : t[i]);
            return e
        }
        ...
        function te(e) {
            var n, t = e.parent || B, i = e.keyframes ? (n = I(e.keyframes), function (e, t) {
                for (var i in t) i in e || "duration" === i && n || "ease" === i || (e[i] = t[i])
            }) : D;
            if (z(e.inherit)) for (; t;) i(e, t.vars.defaults), t = t.parent || t._dp;
            return e
        }
        ...
        function re(e, t) {
            var i;
            if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (i = C(e.rawTime(), t), !t._dur || pe(0, t.totalDuration(), i) - t._tTime > H) && t.render(i, !0), jt(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
        ...
        function M(e, t, i, n) {
            return t.parent && ie(t), t._start = A((ct(i) ? i : i || e !== B ? c(e, i, t) : e._time) + t._delay), t._end = A(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), w(e, t, "_first", "_last", e._sort ? "_start" : 0), le(t) || (e._recent = t), n || re(e, t), e._ts < 0 && Ft(e, e._tTime), e
        }
        ...
        function ae(e, t, i, n, r) {
            return bi(e, t, r), e._initted ? !i && e._pt && !j && (e._dur && !1 !== e.vars.lazy || !e._dur && e.vars.lazy) && je !== m.frame ? (Ct.push(e), e._lazy = [r, n]) : void 0 : 1
        }
        ...
        function ce(e, t, i, n) {
            var r = e._repeat, t = A(t) || 0, s = e._tTime / e._tDur;
            return s && !n && (e._time *= t / e._dur), e._dur = t, e._tDur = r ? r < 0 ? 1e10 : A(t * (r + 1) + e._rDelay * r) : t, 0 < s && !n && Ft(e, e._tTime = e._tDur * s), e.parent && Bt(e), i || jt(e.parent, e), e
        }
        ...
        function ue(e, t, i) {
            ...
            if (s && (o.duration = t[1]), o.parent = i, e) {
                ...
                o.immediateRender = z(n.immediateRender), e < 2 ? o.runBackwards = 1 : o.startAt = t[a - 1]
            }
        ...
        function he(i) {
            return i = O(i)[0] || wt("Invalid scope") || {}, function (e) {
        ...
        function fe(e) {
            ...
            return u(e) ? e : (h = k(e) ? e : {each: e}, f = ri(h.ease), m = h.from || 0, g = parseFloat(h.base) || 0, v = {}, e = 0 < m && m < 1, y = isNaN(m) || e, b = h.axis, W(w = _ = m) ? _ = w = {
                center: .5,
                edges: .5,
                end: 1
            }[m] || 0 : !e && y && (_ = m[0], w = m[1]), function (e, t, i) {
                ...
                if (!p) {
                    ...
                    for (p = v[u] = [], n = y ? Math.min(d, u) * _ - .5 : m % d, r = d === N ? 0 : y ? u * w / d - .5 : m / d | 0, c = N, o = l = 0; o < u; o++) a = o % d - n, s = r - (o / d | 0), p[o] = a = b ? Math.abs("y" === b ? s : a) : at(a * a + s * s), l < a && (l = a), a < c && (c = a);
                    "random" === m && Yt(p), p.max = l - c, p.min = c, p.v = u = (parseFloat(h.amount) || parseFloat(h.each) * (u < d ? u - 1 : b ? "y" === b ? u / d : d : Math.max(d, u / d)) || 0) * ("edges" === m ? -1 : 1), p.b = u < 0 ? g - u : g, p.u = $(h.amount || h.each) || 0, f = f && u < 0 ? ni(f) : f
                }
                return u = (p[e] - p.min) / p.max || 0, A(p.b + (f ? f(u) : u) * p.v) + p.u
            })
        }
        ...
        function ge(l, e) {
            var c, d, t = I(l);
            return !t && k(l) && (c = t = l.radius || N, l.values ? (l = O(l.values), (d = !ct(l[0])) && (c *= c)) : l = me(l.increment)), Ht(e, t ? u(l) ? function (e) {
                return d = l(e), Math.abs(d - e) <= c ? d : e
            } : function (e) {
                for (var t, i, n = parseFloat(d ? e.x : e), r = parseFloat(d ? e.y : 0), s = N, a = 0, o = l.length; o--;) (t = d ? (t = l[o].x - n) * t + (i = l[o].y - r) * i : Math.abs(l[o] - n)) < s && (s = t, a = o);
                return a = !c || s <= c ? l[a] : e, d || a === e || ct(e) ? a : a + $(e)
            } : me(l))
        }
        ...
        function we(t, i, e, n) {
            ...
            if (!r) {
                ...
                if (!0 === e && (n = 1, e = null), d) t = {p: t}, i = {p: i}; else if (I(t) && !I(i)) {
                    for (o = [], l = t.length, c = l - 2, a = 1; a < l; a++) o.push(we(t[a - 1], t[a]));
                    l--, r = function (e) {
                        e *= l;
                        var t = Math.min(c, ~~e);
                        return o[t](e - t)
        ...
        function R(e, t, i) {
            var n = e.vars, r = n[t], s = l, a = e._ctx;
            if (r) return t = n[t + "Params"], n = n.callbackScope || e, i && Ct.length && Rt(), a && (l = a), e = t ? r.apply(n, t) : r.call(n), l = s, e
        }

        function Te(e) {
            return ie(e), e.scrollTrigger && e.scrollTrigger.kill(!!j), e.progress() < 1 && R(e, "onInterrupt"), e
        }
        ...
        function Se(e) {
            if (s() && e) {
                var t = (e = !e.name && e.default || e).name, i = u(e), i = t && !i && e.init ? function () {
                        this._props = []
                    } : e, n = {init: g, render: Oi, add: vi, kill: Pi, modifier: Li, rawVars: 0},
                    r = {targetTest: 0, get: 0, getSetter: Mi, aliases: {}, register: 0};
                if (Jt(), e !== i) {
                    if (q[t]) return;
                    D(i, D(ee(e, n), r)), J(i.prototype, J(n, ee(e, r))), q[i.prop = t] = i, e.targetTest && (At.push(i), Et[t] = 1), t = ("css" === t ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin"
                }
        ...
        function Ce(e, t, i) {
            ...
            }), i && (s = Qt(e), (n = i.c).join(o) !== s.c.join(o))) for (a = (r = e.replace(Kt, "1").split(ft)).length - 1; d < a; d++) o += r[d] + (~n.indexOf(d) ? l.shift() || c + "0,0,0,0)" : (s.length ? s : l.length ? l : i).shift());
            if (!r) for (a = (r = e.split(Kt)).length - 1; d < a; d++) o += r[d] + l[d];
            return o + r[a]
        }

        function Me(e) {
            var t = e.join(" ");
            if (Kt.lastIndex = 0, Kt.test(t)) return t = Zt.test(t), e[1] = Ce(e[1], t), e[0] = Ce(e[0], t, Qt(e[1])), !0
        }

        function ke(e, t) {
            for (var i, n = e._first; n;) n instanceof P ? ke(n, t) : !n.vars.yoyoEase || n._yoyo && n._repeat || n._yoyo === t || (n.timeline ? ke(n.timeline, t) : (i = n._ease, n._ease = n._yEase, n._yEase = i, n._yoyo = t)), n = n._next
        }

        function Ie(e, t, i, n) {
            var r, s = {
                easeIn: t, easeOut: i = void 0 === i ? function (e) {
                    return 1 - t(1 - e)
                } : i, easeInOut: n = void 0 === n ? function (e) {
                    return e < .5 ? t(2 * e) / 2 : 1 - t(2 * (1 - e)) / 2
                } : n
            };
            h(e, function (e) {
                for (var t in L[e] = a[e] = s, L[r = e.toLowerCase()] = i, s) L[r + ("easeIn" === t ? ".in" : "easeOut" === t ? ".out" : ".inOut")] = L[e + "." + t] = s[t]
            })
        }
        ...
        function Oe(i, e, t) {
            ...
            var r = 1 <= e ? e : 1, s = (a = (t || (i ? .3 : .45)) / (e < 1 ? e : 1)) / nt * (Math.asin(1 / r) || 0),
        ...
        var Pe, j, l, B, d, ze, De, Re, je, Be, Fe, Ne, He, We, qe, Ye, $e, Xe, Ge, Ve, Ue, Qe, Ke, Ze, Je, et, tt,
            F = {autoSleep: 120, force3D: "auto", nullTargetWarn: 1, units: {lineHeight: ""}},
            it = {duration: .5, overwrite: !1, delay: 0}, N = 1e8, H = 1 / N, nt = 2 * Math.PI, rt = nt / 4, st = 0,
            at = Math.sqrt, ot = Math.cos, lt = Math.sin, W = function (e) {
                return "string" == typeof e
            }, u = function (e) {
                return "function" == typeof e
            }, ct = function (e) {
            ...
            }, I = Array.isArray, pt = /(?:-?\.?\d|\.)+/gi, ht = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,
            ft = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, mt = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, gt = /[+-]=-?[.\d]+/,
            vt = /[^,'"\[\]\s]+/gi, yt = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, a = {}, bt = {},
            _t = function (e, t) {
                return console.warn("Invalid property", e, "set to", t, "Missing plugin? gsap.registerPlugin()")
            }, wt = function (e, t) {
                return !t && console.warn(e)
            }, xt = {suppressEvents: !0, isStart: !0, kill: !1}, Tt = {suppressEvents: !0, kill: !1},
            St = {suppressEvents: !0}, Et = {}, Ct = [], Mt = {}, q = {}, kt = {}, It = 30, At = [], Ot = "",
            Lt = function (e) {
                var t, i, n = e[0];
                ...
                for (Mt = {}, e = Ct.length = 0; e < i; e++) (t = n[e]) && t._lazy && (t.render(t._lazy[0], t._lazy[1], !0)._lazy = 0)
            }, jt = function (e, t) {
                ...
                var i = e._dp;
                return i && i.smoothChildTiming && e._ts && (e._start = A(i._time - (0 < e._ts ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)), Bt(e), i._dirty || jt(i, e)), e
            }, Nt = {_start: 0, endTime: g, totalDuration: g}, Ht = function (e, t) {
                return e || 0 === e ? t(e) : t
            }, $ = function (e, t) {
                ...
                return l && !t && l.selector ? l.selector(e) : !W(e) || i || !ze && Jt() ? I(e) ? (n = i, void 0 === r && (r = []), e.forEach(function (e) {
                ...
                for (var t, i, n, r, s = 0, a = ""; ~(t = e.indexOf("random(", s));) n = e.indexOf(")", t), r = "[" === e.charAt(t + 7), i = e.substr(t + 7, n - t - 7).match(r ? vt : pt), a += e.substr(s, t - s) + $t(r ? i : +i[0], r ? 0 : +i[1], +i[2] || 1e-5), s = n + 1;
                ...
                if (!d) {
                    if ("," === e.substr(-1) && (e = e.substr(0, e.length - 1)), Vt[e]) d = Vt[e]; else if ("#" === e.charAt(0)) {
                        if (9 === (e = e.length < 6 ? "#" + (n = e.charAt(1)) + n + (r = e.charAt(2)) + r + (s = e.charAt(3)) + s + (5 === e.length ? e.charAt(4) + e.charAt(4) : "") : e).length) return [(d = parseInt(e.substr(1, 6), 16)) >> 16, d >> 8 & p, d & p, parseInt(e.substr(7), 16) / 255];
                        d = [(e = parseInt(e.substr(1), 16)) >> 16, e >> 8 & p, e & p]
                    } else if ("hsl" === e.substr(0, 3)) if (d = c = e.match(pt), t) {
                        if (~e.indexOf("=")) return d = e.match(ht), i && d.length < 4 && (d[3] = 1), d
                    } else a = +d[0] % 360 / 360, o = +d[1] / 100, n = 2 * (l = +d[2] / 100) - (r = l <= .5 ? l * (o + 1) : l + o - l * o), 3 < d.length && (d[3] *= 1), d[0] = Ee(a + 1 / 3, n, r), d[1] = Ee(a, n, r), d[2] = Ee(a - 1 / 3, n, r); else d = e.match(pt) || Vt.transparent;
                    d = d.map(Number)
                }
                return t && !c && (n = d[0] / p, r = d[1] / p, s = d[2] / p, l = ((e = Math.max(n, r, s)) + (t = Math.min(n, r, s))) / 2, e === t ? a = o = 0 : (c = e - t, o = .5 < l ? c / (2 - e - t) : c / (e + t), a = e === n ? (r - s) / c + (r < s ? 6 : 0) : e === r ? (s - n) / c + 2 : (n - r) / c + 4, a *= 60), d[0] = ~~(a + .5), d[1] = ~~(100 * o + .5), d[2] = ~~(100 * l + .5)), i && d.length < 4 && (d[3] = 1), d
            }, Qt = function (e) {
                var t = [], i = [], n = -1;
            ...
            }(), Zt = /hsl[a]?\(/, m = ($e = Date.now, Xe = 500, Ge = 33, Ve = $e(), Ue = Ve, Ke = Qe = 1e3 / 240, Je = {
                time: 0,
                frame: 0,
                tick: function () {
                    si(!0)
                ...
                wake: function () {
                    Re && (!ze && s() && (d = ze = window, De = d.document || {}, a.gsap = f, (d.gsapVersions || (d.gsapVersions = [])).push(f.version), n(bt || d.GreenSockGlobals || !d.gsap && d || {}), We = d.requestAnimationFrame, Gt.forEach(Se)), Ne && Je.sleep(), He = We || function (e) {
                        return setTimeout(e, Ke - 1e3 * Je.time + 1 | 0)
                    }, Fe = 1, si(2))
                },
                sleep: function () {
                    (We ? d.cancelAnimationFrame : clearTimeout)(Ne), Fe = 0, He = g
                },
                ...
                return s && 1 < r.length && s.config ? s.config.apply(null, ~e.indexOf("{") ? [function (e) {
                    for (var t, i, n, r = {}, s = e.substr(1, e.length - 3).split(":"), a = s[0], o = 1, l = s.length; o < l; o++) i = s[o], t = o !== l - 1 ? i.lastIndexOf(",") : i.length, n = i.substr(0, t), r[a] = isNaN(n) ? n.replace(ti, "").trim() : +n, a = i.substr(t + 1).trim();
                    return r
                }(r[1])] : (t = (r = e).indexOf("(") + 1, i = r.indexOf(")"), n = r.indexOf("(", t), r.substring(t, ~n && n < i ? r.indexOf(")", i + 1) : i).split(",").map(y))) : L._CE && ei.test(e) ? L._CE("", e) : s
            }, ni = function (t) {
                return function (e) {
                    return 1 - t(1 - e)
                }
        ...
        function si(e) {
            ...
            if (Xe < r && (Ve += r - Ge), (0 < (r = (i = (Ue += r) - Ve) - Ke) || s) && (n = ++Je.frame, qe = i - 1e3 * Je.time, Je.time = i /= 1e3, Ke += r + (Qe <= r ? 4 : Qe - r), t = 1), s || (Ne = He(si)), t) for (Ye = 0; Ye < Ze.length; Ye++) Ze[Ye](i, qe, n, e)
        }
        ...
        }), L.Linear.easeNone = L.none = L.Linear.easeIn, Ie("Elastic", Oe("in"), Oe("out"), Oe()), et = 7.5625, tt = 1 / 2.75, Ie("Bounce", function (e) {
            return 1 - ai(1 - e)
        ...
        }), Ie("Back", Le("in"), Le("out"), Le()), L.SteppedEase = L.steps = a.SteppedEase = {
            config: function (e, t) {
                var i = 1 / (e = void 0 === e ? 1 : e), n = e + (t ? 0 : 1), r = t ? 1 : 0, s = 1 - H;
                return function (e) {
                    return ((n * pe(0, s, e) | 0) + r) * i
                }
            }
        }, it.ease = L["quad.out"], h("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt", function (e) {
            return Ot += e + "," + e + "Params,"
        });
        var oi = function (e, t) {
            this.id = st++, (e._gsap = this).target = e, this.harness = t, this.get = t ? t.get : zt, this.set = t ? t.getSetter : Mi
            ...
            return arguments.length ? (this._dirty = 0, ce(this, this._repeat < 0 ? e : (e - this._repeat * this._rDelay) / (this._repeat + 1))) : this._tDur
        }, t.totalTime = function (e, t) {
            if (Jt(), !arguments.length) return this._tTime;
            var i = this._dp;
            if (i && i.smoothChildTiming && this._ts) {
                for (Ft(this, e), i._dp && !i.parent && re(i, this); i && i.parent;) i.parent._time !== i._start + (0 <= i._ts ? i._tTime / i._ts : (i.totalDuration() - i._tTime) / -i._ts) && i.totalTime(i._tTime, !0), i = i.parent;
            ...
            return (this._tTime !== e || !this._dur && !t || this._initted && Math.abs(this._zTime) === H || !e && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = e), v(this, e, t)), this
        }, t.time = function (e, t) {
            ...
            for (var i = this.parent && this._ts ? C(this.parent._time, this) : this._tTime, e = (this._rts = +e || 0, this._ts = this._ps || e === -H ? 0 : this._rts, this.totalTime(pe(-Math.abs(this._delay), this._tDur, i), !1 !== t), Bt(this), this), n = e.parent; n && n.parent;) n._dirty = 1, n.totalDuration(), n = n.parent;
            return e
        }, t.paused = function (e) {
            return arguments.length ? (this._ps !== e && ((this._ps = e) ? (this._pTime = this._tTime || Math.max(-this._delay, this.rawTime()), this._ts = this._act = 0) : (Jt(), this._ts = this._rts, this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, 1 === this.progress() && Math.abs(this._zTime) !== H && (this._tTime -= H)))), this) : this._ps
            ...
            var t = j;
            return j = e = void 0 === e ? St : e, (this._initted || this._startAt) && (this.timeline && this.timeline.revert(e), this.totalTime(-.01, e.suppressEvents)), "nested" !== this.data && !1 !== e.kill && this.kill(), j = t, this
            ...
            return new Promise(function (t) {
                function e() {
                    var e = r.then;
                    r.then = null, u(i) && (i = i(r)) && (i.then || i === r) && (r.then = e), t(i), r.then = e
                }
        ...
        function ci(e) {
            this.vars = e, this._delay = +e.delay || 0, (this._repeat = e.repeat === 1 / 0 ? -2 : e.repeat || 0) && (this._rDelay = e.repeatDelay || 0, this._yoyo = !!e.yoyo || !!e.yoyoEase), this._ts = 1, ce(this, +e.duration, 1, 1), this.data = e.data, l && (this._ctx = l).data.push(this), Fe || m.wake()
        }
        ...
        i(ui, di = li), (t = ui.prototype).to = function (e, t, i) {
            ...
            return t.duration = 0, t.parent = this, te(t).repeatDelay || (t.repeat = 0), t.immediateRender = !!t.immediateRender, new X(e, t, c(this, i), 1), this
        }, t.call = function (e, t, i) {
            return M(this, X.delayedCall(0, e, t), i)
        }, t.staggerTo = function (e, t, i, n, r, s, a) {
            return i.duration = t, i.stagger = i.stagger || n, i.onComplete = s, i.onCompleteParams = a, i.parent = this, new X(e, i, c(this, r)), this
        }, t.staggerFrom = function (e, t, i, n, r, s, a) {
            return i.runBackwards = 1, te(i).immediateRender = z(i.immediateRender), this.staggerTo(e, t, i, n, r, s, a)
        }, t.staggerFromTo = function (e, t, i, n, r, s, a, o) {
            return n.startAt = i, te(n).immediateRender = z(n.immediateRender), this.staggerTo(e, t, n, r, s, a, o)
        }, t.render = function (e, t, i) {
            var n, r, s, a, o, l, c, d, u, p, h = this._time, f = this._dirty ? this.totalDuration() : this._tDur,
                m = this._dur, g = e <= 0 ? 0 : A(e), v = this._zTime < 0 != e < 0 && (this._initted || !m);
            if ((g = this !== B && f < g && 0 <= e ? f : g) !== this._tTime || i || v) {
                if (h !== this._time && m && (g += this._time - h, e += this._time - h), n = g, d = this._start, o = !(c = this._ts), v && (m || (h = this._zTime), !e && t || (this._zTime = e)), this._repeat) {
                    if (v = this._yoyo, a = m + this._rDelay, this._repeat < -1 && e < 0) return this.totalTime(100 * a + e, t, i);
                    if (n = A(g % a), g === f ? (s = this._repeat, n = m) : ((s = ~~(g / a)) && s === g / a && (n = m, s--), m < n && (n = m)), u = E(this._tTime, a), v && 1 & s && (n = m - n, p = 1), s !== (u = !h && this._tTime && u !== s && this._tTime - u * a - this._dur <= 0 ? s : u) && !this._lock) {
                        var y = v && 1 & u, v = y === (v && 1 & s), h = (y = s < u ? !y : y) ? 0 : g % m ? m : g;
                        if (this._lock = 1, this.render(h || (p ? 0 : A(s * a)), t, !m)._lock = 0, this._tTime = g, !t && this.parent && R(this, "onRepeat"), this.vars.repeatRefresh && !p && (this.invalidate()._lock = 1), h && h !== this._time || o != !this._ts || this.vars.onRepeat && !this.parent && !this._act) return this;
                        if (m = this._dur, f = this._tDur, v && (this._lock = 2, this.render(h = y ? m : -1e-4, !0), this.vars.repeatRefresh) && !p && this.invalidate(), this._lock = 0, !this._ts && !o) return this;
                        ke(this, p)
                    }
                }
                ...
                }(this, A(h), A(n))) && (g -= n - (n = l._start)), this._tTime = g, this._time = n, this._act = !c, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = e, h = 0), !h && n && !t && !s && (R(this, "onStart"), this._tTime !== g)) return this;
                if (h <= n && 0 <= e) for (b = this._first; b;) {
                    if (r = b._next, (b._act || n >= b._start) && b._ts && l !== b) {
                        if (b.parent !== this) return this.render(e, t, i);
                        if (b.render(0 < b._ts ? (n - b._start) * b._ts : (b._dirty ? b.totalDuration() : b._tDur) + (n - b._start) * b._ts, t, i), n !== this._time || !this._ts && !o) {
                            l = 0, r && (g += this._zTime = -H);
                            break
                        }
                    }
                    b = r
                } else for (var b = this._last, _ = e < 0 ? e : n; b;) {
                    if (r = b._prev, (b._act || _ <= b._end) && b._ts && l !== b) {
                        if (b.parent !== this) return this.render(e, t, i);
                        if (b.render(0 < b._ts ? (_ - b._start) * b._ts : (b._dirty ? b.totalDuration() : b._tDur) + (_ - b._start) * b._ts, t, i || j && (b._initted || b._startAt)), n !== this._time || !this._ts && !o) {
                ...
                if (l && !t && (this.pause(), l.render(h <= n ? 0 : -H)._zTime = h <= n ? 1 : -1, this._ts)) return this._start = d, Bt(this), this.render(e, t, i);
                this._onUpdate && !t && R(this, "onUpdate", !0), !(g === f && this._tTime >= this.totalDuration() || !g && h) || d !== this._start && Math.abs(c) === Math.abs(this._ts) || this._lock || (!e && m || !(g === f && 0 < this._ts || !g && this._ts < 0) || ie(this, 1), t) || e < 0 && !h || !g && !h && f || (R(this, g === f && 0 <= e ? "onComplete" : "onReverseComplete", !0), !this._prom) || g < f && 0 < this.timeScale() || this._prom()
            }
            return this
        }, t.add = function (e, t) {
            var i = this;
            ...
            void 0 === e && (e = !0), void 0 === t && (t = !0), void 0 === i && (i = !0), void 0 === n && (n = -N);
            for (var r = [], s = this._first; s;) s._start >= n && (s instanceof X ? t && r.push(s) : (i && r.push(s), e && r.push.apply(r, s.getChildren(!0, t, i)))), s = s._next;
            return r
        }, t.getById = function (e) {
            for (var t = this.getChildren(1, 1, 1), i = t.length; i--;) if (t[i].vars.id === e) return t[i]
        }, t.remove = function (e) {
            return W(e) ? this.removeLabel(e) : u(e) ? this.killTweensOf(e) : (x(this, e), e === this._recent && (this._recent = this._last), jt(this))
        }, t.totalTime = function (e, t) {
            return arguments.length ? (this._forcing = 1, !this._dp && this._ts && (this._start = A(m.time - (0 < this._ts ? e / this._ts : (this.totalDuration() - e) / -this._ts))), di.prototype.totalTime.call(this, e, t), this._forcing = 0, this) : this._tTime
            ...
            return t.data = "isPause", this._hasPause = 1, M(this, t, c(this, e))
        }, t.removePause = function (e) {
            var t = this._first;
            for (e = c(this, e); t;) t._start === e && "isPause" === t.data && ie(t), t = t._next
        }, t.killTweensOf = function (e, t, i) {
            for (var n = this.getTweensOf(e, i), r = n.length; r--;) fi !== n[r] && n[r].kill(e, t);
            return this
        }, t.getTweensOf = function (e, t) {
            for (var i, n = [], r = O(e), s = this._first, a = ct(t); s;) s instanceof X ? function (e, t) {
                for (var i = t.length, n = 0; e.indexOf(t[n]) < 0 && ++n < i;) ;
                return n < i
            }(s._targets, r) && (a ? (!fi || s._initted && s._ts) && s.globalTime(0) <= t && s.globalTime(s.totalDuration()) > t : !t || s.isActive()) && n.push(s) : (i = s.getTweensOf(r, t)).length && n.push.apply(n, i), s = s._next;
            return n
        }, t.tweenTo = function (e, t) {
            t = t || {};
            var i, n = this, r = c(n, e), e = t, s = e.startAt, a = e.onStart, o = e.onStartParams,
                e = e.immediateRender, l = X.to(n, D({
                    ease: t.ease || "none",
                    lazy: !1,
                    immediateRender: !1,
                    time: r,
                    ...
                    onStart: function () {
                        var e;
                        n.pause(), i || (e = t.duration || Math.abs((r - (s && "time" in s ? s.time : n._time)) / n.timeScale()), l._dur !== e && ce(l, e, 0, 1).render(l._time, !0, !0), i = 1), a && a.apply(l, o || [])
                    }
                }, t));
        ...
        function ui(e, t) {
            var i;
            return (i = di.call(this, e = void 0 === e ? {} : e) || this).labels = {}, i.smoothChildTiming = !!e.smoothChildTiming, i.autoRemoveChildren = !!e.autoRemoveChildren, i._sort = z(e.sortChildren), B && M(e.parent || B, K(i), t), e.reversed && i.reverse(), e.paused && i.paused(!0), e.scrollTrigger && se(K(i), e.scrollTrigger), i
        }
        ...
        function pi(e, t, i, n, r, s) {
            var a, o, l, c;
            if (q[e] && !1 !== (a = new q[e]).init(r, a.rawVars ? t[e] : yi(t[e], n, r, s, i), i, n, s) && (i._pt = o = new G(i._pt, r, e, 0, 1, a.render, a, 0, a.priority), i !== Be)) for (l = i._ptLookup[i._targets.indexOf(r)], c = a._props.length; c--;) l[a._props[c]] = o;
            return a
        }
        ...
        var fi, mi, gi, vi = function (e, t, i, n, r, s, a, o, l, c) {
                u(n) && (n = n(r || 0, e, s));
                var d, r = e[t],
                    s = "get" !== i ? i : u(r) ? l ? e[t.indexOf("set") || !u(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](l) : e[t]() : r,
                    i = u(r) ? l ? Ci : Ei : Si;
                if (!W(n) || "=" !== (n = ~n.indexOf("random(") ? Xt(n) : n).charAt(1) || !(d = Dt(s, n) + ($(s) || 0)) && 0 !== d || (n = d), !c || s !== n || mi) return isNaN(s * n) || "" === n ? (r || t in e || _t(t, n), function (e, t, i, n, r, s, a) {
                    var o, l, c, d, u, p = new G(this._pt, e, t, 0, 1, Ai, null, r), h = 0, f = 0;
                    for (p.b = i, p.e = n, i += "", (r = ~(n += "").indexOf("random(")) && (n = Xt(n)), s && (s(s = [i, n], e, t), i = s[0], n = s[1]), o = i.match(mt) || []; d = mt.exec(n);) c = d[0], d = n.substring(h, d.index), l ? l = (l + 1) % 5 : "rgba(" === d.substr(-5) && (l = 1), c !== o[f++] && (u = parseFloat(o[f - 1]) || 0, p._pt = {
                        _next: p._pt,
                        p: d || 1 === f ? d : ",",
                        s: u,
                    ...
                    return p.c = h < n.length ? n.substring(h, n.length) : "", p.fp = a, (gt.test(n) || r) && (p.e = 0), this._pt = p
                }.call(this, e, t, s, n, i, o || F.stringFilter, l)) : (d = new G(this._pt, e, t, +s || 0, n - (s || 0), "boolean" == typeof r ? Ii : ki, 0, i), l && (d.fp = l), a && d.modifier(a, this, e), this._pt = d)
            }, yi = function (e, t, i, n, r) {
                if (u(e) && (e = hi(e, r, t, i, n)), !k(e) || e.style && e.nodeType || I(e) || ut(e)) return W(e) ? hi(e, r, t, i, n) : e;
                var s, a = {};
                for (s in e) a[s] = hi(e[s], r, t, i, n);
                return a
            }, bi = function e(t, i, n) {
                var r, s, a, o, l, c, d, u, p, h, f, m, g, v = t.vars, y = v.ease, b = v.startAt, _ = v.immediateRender,
                    w = v.lazy, x = v.onUpdate, T = v.runBackwards, S = v.yoyoEase, E = v.keyframes, C = v.autoRevert,
                    M = t._dur, k = t._startAt, I = t._targets, A = t.parent,
                    O = A && "nested" === A.data ? A.vars.targets : I, L = "auto" === t._overwrite && !Pe, P = t.timeline;
                if (t._ease = ri(y = !P || E && y ? y : "none", it.ease), t._yEase = S ? ni(ri(!0 === S ? y : S, it.ease)) : 0, S && t._yoyo && !t._repeat && (S = t._yEase, t._yEase = t._ease, t._ease = S), t._from = !P && !!v.runBackwards, !P || E && !v.stagger) {
                    if (m = (u = I[0] ? Pt(I[0]).harness : 0) && v[u.prop], r = ee(v, Et), k && (k._zTime < 0 && k.progress(1), i < 0 && T && _ && !C ? k.render(-1, !0) : k.revert(T && M ? Tt : xt), k._lazy = 0), b) {
                        if (ie(t._startAt = X.set(I, D({
                            ...
                            stagger: 0
                        }, b))), t._startAt._dp = 0, t._startAt._sat = t, i < 0 && (j || !_ && !C) && t._startAt.revert(Tt), _ && M && i <= 0 && n <= 0) return void (i && (t._zTime = i))
                    } else if (T && M && !k) if (a = D({
                        overwrite: !1,
                        data: "isFromStart",
                        lazy: (_ = i ? !1 : _) && !k && z(w),
                        immediateRender: _,
                        stagger: 0,
                        parent: A
                    }, r), m && (a[u.prop] = m), ie(t._startAt = X.set(I, a)), t._startAt._dp = 0, t._startAt._sat = t, i < 0 && (j ? t._startAt.revert(Tt) : t._startAt.render(-1, !0)), t._zTime = i, _) {
                        if (!i) return
                    } else e(t._startAt, H, H);
                    for (t._pt = t._ptCache = 0, w = M && z(w) || w && !M, s = 0; s < I.length; s++) {
                        if (d = (l = I[s])._gsap || Lt(I)[s]._gsap, t._ptLookup[s] = h = {}, Mt[d.id] && Ct.length && Rt(), f = O === I ? s : O.indexOf(l), u && !1 !== (p = new u).init(l, m || r, t, f, O) && (t._pt = o = new G(t._pt, l, p.name, 0, 1, p.render, p, 0, p.priority), p._props.forEach(function (e) {
                            h[e] = o
                        }), p.priority) && (c = 1), !u || m) for (a in r) q[a] && (p = pi(a, r, t, f, l, O)) ? p.priority && (c = 1) : h[a] = o = vi.call(t, l, a, "get", r[a], f, O, 0, v.stringFilter);
                        t._op && t._op[s] && t.kill(l, t._op[s]), L && t._pt && (fi = t, B.killTweensOf(l, h, t.globalTime(i)), g = !t.parent, fi = 0), t._pt && w && (Mt[d.id] = 1)
                    }
                    c && zi(t), t._onInit && t._onInit(t)
                }
                t._onUpdate = x, t._initted = (!t._op || t._pt) && !g, E && i <= 0 && P.render(N, !0, !0)
            }, _i = Ot + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert", wi = {},
            X = (h(_i + ",id,stagger,delay,duration,paused,scrollTrigger", function (e) {
                return wi[e] = 1
            }), i(r, gi = li), (t = r.prototype).render = function (e, t, i) {
                var n, r, s, a = this._time, o = this._tDur, l = this._dur, c = e < 0,
                    d = o - H < e && !c ? o : e < H ? 0 : e;
                if (l) {
                    if (d !== this._tTime || !e || i || !this._initted && this._tTime || this._startAt && this._zTime < 0 != c) {
                        if (g = d, m = this.timeline, this._repeat) {
                            if (h = l + this._rDelay, this._repeat < -1 && c) return this.totalTime(100 * h + e, t, i);
                            if (g = A(d % h), d === o ? (v = this._repeat, g = l) : ((v = ~~(d / h)) && v === A(d / h) && (g = l, v--), l < g && (g = l)), (r = this._yoyo && 1 & v) && (f = this._yEase, g = l - g), b = E(this._tTime, h), g === a && !i && this._initted && v === b) return this._tTime = d, this;
                            v !== b && (m && this._yEase && ke(m, r), this.vars.repeatRefresh) && !r && !this._lock && this._time !== l && this._initted && (this._lock = i = 1, this.render(A(h * v), !0).invalidate()._lock = 0)
                        }
                        if (!this._initted) {
                            if (ae(this, c ? e : g, i, t, d)) return this._tTime = 0, this;
                            if (!(a === this._time || i && this.vars.repeatRefresh && v !== b)) return this;
                            if (l !== this._dur) return this.render(e, t, i)
                        }
                        if (this._tTime = d, this._time = g, !this._act && this._ts && (this._act = 1, this._lazy = 0), this.ratio = s = (f || this._ease)(g / l), this._from && (this.ratio = s = 1 - s), g && !a && !t && !v && (R(this, "onStart"), this._tTime !== d)) return this;
                        for (n = this._pt; n;) n.r(s, n.d), n = n._next;
                        m && m.render(e < 0 ? e : !g && r ? -H : m._dur * m._ease(g / this._dur), t, i) || this._startAt && (this._zTime = e), this._onUpdate && !t && (c && T(this, e, 0, i), R(this, "onUpdate")), this._repeat && v !== b && this.vars.onRepeat && !t && this.parent && R(this, "onRepeat"), d !== this._tDur && d || this._tTime !== d || (c && !this._onUpdate && T(this, e, 0, !0), !e && l || !(d === this._tDur && 0 < this._ts || !d && this._ts < 0) || ie(this, 1), t) || c && !a || !(d || a || r) || (R(this, d === o ? "onComplete" : "onReverseComplete", !0), !this._prom) || d < o && 0 < this.timeScale() || this._prom()
                    }
                } else {
                    var u, p, h = this, f = e, m = t, g = i, v = h.ratio,
                        y = f < 0 || !f && (!h._start && oe(h) && (h._initted || !le(h)) || (h._ts < 0 || h._dp._ts < 0) && !le(h)) ? 0 : 1,
                        b = h._rDelay, l = 0;
                    if (b && h._repeat && (l = pe(0, h._tDur, f), p = E(l, b), h._yoyo && 1 & p && (y = 1 - y), p !== E(h._tTime, b)) && (v = 1 - y, h.vars.repeatRefresh) && h._initted && h.invalidate(), y !== v || j || g || h._zTime === H || !f && h._zTime) {
                        if (h._initted || !ae(h, f, g, m, l)) {
                            for (p = h._zTime, h._zTime = f || (m ? H : 0), m = m || f && !p, h.ratio = y, h._from && (y = 1 - y), h._time = 0, h._tTime = l, u = h._pt; u;) u.r(y, u.d), u = u._next;
                            f < 0 && T(h, f, 0, !0), h._onUpdate && !m && R(h, "onUpdate"), l && h._repeat && !m && h.parent && R(h, "onRepeat"), (f >= h._tDur || f < 0) && h.ratio === y && (y && ie(h, 1), m || j || (R(h, y ? "onComplete" : "onReverseComplete", !0), h._prom && h._prom()))
                        }
                ...
                return e && this.vars.runBackwards || (this._startAt = 0), this._pt = this._op = this._onUpdate = this._lazy = this.ratio = 0, this._ptLookup = [], this.timeline && this.timeline.invalidate(e), gi.prototype.invalidate.call(this, e)
            }, t.resetTo = function (e, t, i, n, r) {
                Fe || m.wake(), this._ts || this.play();
                var s, a = Math.min(this._dur, (this._dp._time - this._start) * this._ts);
                return this._initted || bi(this, a), s = this._ease(a / this._dur), function (e, t, i, n, r, s, a, o) {
                    var l, c, d, u, p = (e._pt && e._ptCache || (e._ptCache = {}))[t];
                    if (!p) for (p = e._ptCache[t] = [], d = e._ptLookup, u = e._targets.length; u--;) {
                        if ((l = d[u][t]) && l.d && l.d._pt) for (l = l.d._pt; l && l.p !== t && l.fp !== t;) l = l._next;
                        if (!l) return mi = 1, e.vars[t] = "+=0", bi(e, a), mi = 0, o ? wt(t + " not eligible for reset") : 1;
                        p.push(l)
                    }
                    for (u = p.length; u--;) (l = (c = p[u])._pt || c).s = !n && 0 !== n || r ? l.s + (n || 0) + s * l.c : n, l.c = i - l.s, c.e && (c.e = Y(i) + $(c.e)), c.b && (c.b = l.s + $(c.b))
                }(this, e, t, i, n, s, a, r) ? this.resetTo(e, t, i, n, 1) : (Ft(this, 0), this.parent || w(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0))
            }, t.kill = function (e, t) {
                if (void 0 === t && (t = "all"), !(e || t && "all" !== t)) return this._lazy = this._pt = 0, this.parent ? Te(this) : this;
                if (this.timeline) p = this.timeline.totalDuration(), this.timeline.killTweensOf(e, t, fi && !0 !== fi.vars.overwrite)._first || Te(this), this.parent && p !== this.timeline.totalDuration() && ce(this, this._dur * this.timeline._tDur / p, 0, 1); else {
                    var i, n, r, s, a, o, l, c = this._targets, d = e ? O(e) : c, u = this._ptLookup, p = this._pt;
                    if ((!t || "all" === t) && function (e, t) {
                        for (var i = e.length, n = i === t.length; n && i-- && e[i] === t[i];) ;
                        return i < 0
                    }(c, d)) return "all" === t && (this._pt = 0), Te(this);
                    for (i = this._op = this._op || [], "all" !== t && (W(t) && (a = {}, h(t, function (e) {
                        return a[e] = 1
                    }), t = a), t = function (e, t) {
                        ...
                        return i
                    }(c, t)), l = c.length; l--;) if (~d.indexOf(c[l])) for (a in n = u[l], "all" === t ? (i[l] = t, s = n, r = {}) : (r = i[l] = i[l] || {}, s = t), s) (o = n && n[a]) && ("kill" in o.d && !0 !== o.d.kill(a) || x(this, o, "_pt"), delete n[a]), "all" !== r && (r[a] = 1);
        ...
        function r(e, t, i, n) {
            ...
            var r, s, a, o, l, c, d, u, p, n = (r = gi.call(this, n ? t : te(t)) || this).vars, h = n.duration,
                f = n.delay, m = n.immediateRender, g = n.stagger, v = n.overwrite, y = n.keyframes, b = n.defaults,
                _ = n.scrollTrigger, w = n.yoyoEase, n = t.parent || B,
                x = (I(e) || ut(e) ? ct(e[0]) : "length" in t) ? [e] : O(e);
            if (r._targets = x.length ? Lt(x) : wt("GSAP target " + e + " not found. https://gsap.com", !F.nullTargetWarn) || [], r._ptLookup = [], r._overwrite = v, y || g || Z(h) || Z(f)) {
                if (t = r.vars, (s = r.timeline = new P({
                    data: "nested",
                    defaults: b || {},
                    targets: n && "nested" === n.data ? n.vars.targets : x
                })).kill(), s.parent = s._dp = K(r), s._start = 0, g || Z(h) || Z(f)) {
                    if (l = x.length, u = g && fe(g), k(g)) for (c in g) ~_i.indexOf(c) && ((p = p || {})[c] = g[c]);
                    for (a = 0; a < l; a++) (o = ee(t, wi)).stagger = 0, w && (o.yoyoEase = w), p && J(o, p), d = x[a], o.duration = +hi(h, K(r), a, d, x), o.delay = (+hi(f, K(r), a, d, x) || 0) - r._delay, !g && 1 === l && o.delay && (r._delay = f = o.delay, r._start += f, o.delay = 0), s.to(d, o, u ? u(a, d, x) : 0), s._ease = L.none;
                    s.duration() ? h = f = 0 : r.timeline = 0
                } else if (y) {
                    te(D(s.vars.defaults, {ease: "none"})), s._ease = ri(y.ease || t.ease || "none");
                    var T, S, E, C = 0;
                    if (I(y)) y.forEach(function (e) {
                        return s.to(x, e, ">")
                    }), s.duration(); else {
                        for (c in o = {}, y) "ease" !== c && "easeEach" !== c && function (e, i, t, n) {
                            var r, s, a = i.ease || n || "power1.inOut";
                            if (I(i)) s = t[e] || (t[e] = []), i.forEach(function (e, t) {
                                return s.push({t: t / (i.length - 1) * 100, v: e, e: a})
                            }); else for (r in i) s = t[r] || (t[r] = []), "ease" !== r && s.push({
                                t: parseFloat(e),
                                v: i[r],
                                e: a
                            })
                        }(c, y[c], o, y.easeEach);
                        for (c in o) for (T = o[c].sort(function (e, t) {
                            return e.t - t.t
                        }), a = C = 0; a < T.length; a++) (E = {
                            ease: (S = T[a]).e,
                            duration: (S.t - (a ? T[a - 1].t : 0)) / 100 * h
                        })[c] = S.v, s.to(x, E, C), C += E.duration;
                        s.duration() < h && s.to({}, {duration: h - s.duration()})
                    }
                }
                h || r.duration(h = s.duration())
            } else r.timeline = 0;
            return !0 !== v || Pe || (fi = K(r), B.killTweensOf(x), fi = 0), M(n, K(r), i), t.reversed && r.reverse(), t.paused && r.paused(!0), (m || !h && !y && r._start === A(n._time) && z(m) && ne(K(r)) && "nested" !== n.data) && (r._tTime = -H, r.render(Math.max(0, -f) || 0)), _ && se(K(r), _), r
        }
        ...
        D(X.prototype, {
            ...
            X[i] = function () {
                var e = new P, t = Wt.call(arguments, 0);
        ...
        var Si = function (e, t, i) {
            ...
            for (var t, i, n = this._pt; n;) i = n._next, n.p === e && !n.op || n.op === e ? x(this, n, "_pt") : n.dep || (t = 1), n = i;
            return !t
        }, zi = function (e) {
        ...
        function Di(e, t, i, n, r, s, a, o, l) {
            this.t = t, this.s = n, this.c = r, this.p = i, this.r = s || ki, this.d = a || this, this.set = o || Si, this.pr = l || 0, (this._next = e) && (e._prev = this)
        }
        ...
        h(Ot + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger", function (e) {
            return Et[e] = 1
        }), a.TweenMax = a.TweenLite = X, a.TimelineLite = a.TimelineMax = P, B = new P({
            sortChildren: !1,
            defaults: it,
        ...
        function ji() {
            var e = Date.now(), o = [];
            2 < e - Hi && (Ri("matchMediaInit"), Bi.forEach(function (e) {
                var t, i, n, r, s = e.queries, a = e.conditions;
                for (i in s) (t = d.matchMedia(s[i]).matches) && (n = 1), t !== a[i] && (a[i] = t, r = 1);
                r && (e.revert(), n) && o.push(e)
            }), Ri("matchMediaRevert"), o.forEach(function (t) {
        ...
        var Bi = [], Fi = {}, Ni = [], Hi = 0, Wi = 0, qi = ((t = Yi.prototype).add = function (e, n, r) {
            u(e) && (r = n, n = e, e = u);

            function t() {
                var e, t = l, i = s.selector;
                return t && t !== s && t.data.push(s), r && (s.selector = he(r)), l = s, e = n.apply(s, arguments), u(e) && s._r.push(e), l = t, s.selector = i, s.isReverted = !1, e
            }

            var s = this;
            return s.last = t, e === u ? t(s, function (e) {
                return s.add(null, e)
            }) : e ? s[e] = t : t
        }, t.ignore = function (e) {
            var t = l;
            ...
            var i = this;
            if (t) {
                for (var n, r = i.getTweens(), s = i.data.length; s--;) "isFlip" === (n = i.data[s]).data && (n.revert(), n.getChildren(!0, !0, !1).forEach(function (e) {
                ...
                for (r.map(function (e) {
                    ...
                    return e.t.revert(t)
                }), s = i.data.length; s--;) (n = i.data[s]) instanceof P ? "nested" !== n.data && (n.scrollTrigger && n.scrollTrigger.revert(), n.kill()) : n instanceof X || !n.revert || n.revert(t);
            ...
            if (this.clear(), e) for (var a = Bi.length; a--;) Bi[a].id === this.id && Bi.splice(a, 1)
        }, t.revert = function (e) {
            this.kill(e || {})
        }, Yi);

        function Yi(e, t) {
            this.selector = t && he(t), this.data = [], this._r = [], this.isReverted = !1, this.id = Wi++, e && this.add(e)
        }

        (t = Xi.prototype).add = function (e, t, i) {
            k(e) || (e = {matches: e});
            var n, r, s, a = new qi(0, i || this.scope), o = a.conditions = {};
            for (r in l && !a.selector && (a.selector = l.selector), this.contexts.push(a), t = a.add("onMatch", t), a.queries = e) "all" === r ? s = 1 : (n = d.matchMedia(e[r])) && (Bi.indexOf(a) < 0 && Bi.push(a), (o[r] = n.matches) && (s = 1), n.addListener ? n.addListener(ji) : n.addEventListener("change", ji));
        ...
        function Gi(e, d) {
            return {
                name: e, rawVars: 1, init: function (e, c, t) {
                    t._onInit = function (e) {
                        var t, i;
                        if (W(c) && (t = {}, h(c, function (e) {
                            return t[e] = 1
                        }), c = t), d) {
                        ...
                        for (n in o) for (r = l.length; r--;) (s = (s = (s = a._ptLookup[r][n]) && s.d) && (s._pt ? In(s, n) : s)) && s.modifier && s.modifier(o[n], a, l[r], n)
                    }
                }
            }
        }
        ...
        function on(e, t) {
            ...
            if (e in Vn && r) {
                ...
                }) : this.tfm[e] = s.x ? s[e] : hr(n, e), e === Q && (this.tfm.zOrigin = s.zOrigin), 0 <= this.props.indexOf(U)) return;
                s.svg && (this.svgo = n.getAttribute("data-svg-origin"), this.props.push(Q, t, "")), e = U
            }
            (r || t) && this.props.push(e, t, r[e])
        }

        function ln() {
            for (var e, t = this.props, i = this.target, n = i.style, r = i._gsap, s = 0; s < t.length; s += 3) t[s + 1] ? i[t[s]] = t[s + 2] : t[s + 2] ? n[t[s]] = t[s + 2] : n.removeProperty("--" === t[s].substr(0, 2) ? t[s] : t[s].replace(Zn, "-$1").toLowerCase());
            if (this.tfm) {
                for (e in this.tfm) r[e] = this.tfm[e];
                r.svg && (r.renderTransform(), i.setAttribute("data-svg-origin", this.svgo || "")), (s = En()) && s.isStart || n[U] || (tr(n), r.zOrigin && n[Q] && (n[Q] += " " + r.zOrigin + "px", r.zOrigin = 0, r.renderTransform()), r.uncache = 1)
            }
        }

        function cn(e, t) {
            var i = {target: e, props: [], revert: ln, save: on};
            return e._gsap || f.core.getCache(e), t && t.split(",").forEach(function (e) {
                return i.save(e)
            }), i
        }

        function dn() {
            Gn() && window.document && (bn = window, _n = bn.document, wn = _n.documentElement, Tn = ir("div") || {style: {}}, ir("div"), U = sr(U), Q = U + "Origin", Tn.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", Cn = !!sr("perspective"), En = f.core.reverting, xn = 1)
        }

        function un(e) {
            var t,
                i = ir("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg"),
            ...
            if (wn.appendChild(i), i.appendChild(this), this.style.display = "block", e) try {
                t = this.getBBox(), this._gsapBBox = this.getBBox, this.getBBox = un
            } catch (e) {
            } else this._gsapBBox && (t = this._gsapBBox());
            return n && (r ? n.insertBefore(this, r) : n.appendChild(this)), wn.removeChild(i), this.style.cssText = s, t
        }
        ...
        function hn(e, t, i, n) {
            i && "none" !== i || ((r = (s = sr(t, e, 1)) && nr(e, s, 1)) && r !== i ? (t = s, i = r) : "borderColor" === t && (i = nr(e, "borderTopColor")));
            var r, s, a, o, l, c, d, u, p, h, f = new G(this._pt, e.style, t, 0, 1, Ai), m = 0, g = 0;
            if (f.b = i, f.e = n, i += "", "auto" === (n += "") && (c = e.style[t], e.style[t] = n, n = nr(e, t) || n, c ? e.style[t] = c : lr(e, t)), Me(s = [i, n]), n = s[1], a = (i = s[0]).match(ft) || [], (n.match(ft) || []).length) {
                for (; u = ft.exec(n);) p = u[0], u = n.substring(m, u.index), l ? l = (l + 1) % 5 : "rgba(" !== u.substr(-5) && "hsla(" !== u.substr(-5) || (l = 1), p !== (c = a[g++] || "") && (o = parseFloat(c) || 0, h = c.substr((o + "").length), "=" === p.charAt(1) && (p = Dt(o, p) + h), d = parseFloat(p), p = p.substr((d + "").length), m = ft.lastIndex - p.length, p || (p = p || F.units[t] || h, m === n.length && (n += p, f.e += p)), h !== p && (o = pr(e, t, c, p) || 0), f._pt = {
                    _next: f._pt,
                    p: u || 1 === g ? u : ",",
                    s: o,
                    c: d - o,
        ...
        function fn(e, t) {
            if (t.tween && t.tween._time === t.tween._dur) {
                ...
                if ("all" === o || !0 === o) a.cssText = "", n = 1; else for (r = (o = o.split(",")).length; -1 < --r;) i = o[r], Vn[i] && (n = 1, i = "transformOrigin" === i ? Q : U), lr(s, i);
                n && (lr(s, U), t) && (t.svg && s.removeAttribute("transform"), _r(s, 1), t.uncache = 1, tr(a))
            }
        }
        ...
        function gn(e, t, i, n, r, s) {
            var a, o = e._gsap, r = r || br(e, !0), l = o.xOrigin || 0, c = o.yOrigin || 0, d = o.xOffset || 0,
                u = o.yOffset || 0, p = r[0], h = r[1], f = r[2], m = r[3], g = r[4], v = r[5], y = t.split(" "),
                b = parseFloat(y[0]) || 0, _ = parseFloat(y[1]) || 0;
            i ? r !== gr && (r = p * m - h * f) && (a = b * (-h / r) + _ * (p / r) - (p * v - h * g) / r, b = b * (m / r) + _ * (-f / r) + (f * v - m * g) / r, _ = a) : (b = (r = ar(e)).x + (~y[0].indexOf("%") ? b / 100 * r.width : b), _ = r.y + (~(y[1] || y[0]).indexOf("%") ? _ / 100 * r.height : _)), n || !1 !== n && o.smooth ? (o.xOffset = d + ((g = b - l) * p + (v = _ - c) * f) - g, o.yOffset = u + (g * h + v * m) - v) : o.xOffset = o.yOffset = 0, o.xOrigin = b, o.yOrigin = _, o.smooth = !!n, o.origin = t, o.originIsAbsolute = !!i, e.style[Q] = "0px 0px", s && (cr(s, o, "xOrigin", l, b), cr(s, o, "yOrigin", c, _), cr(s, o, "xOffset", d, o.xOffset), cr(s, o, "yOffset", u, o.yOffset)), e.setAttribute("data-svg-origin", b + " " + _)
        }
        ...
        var bn, _n, wn, xn, Tn, Sn, En, Cn, Mn, kn = {
                ...
                getProperty: function (n, e, t, i) {
                    W(n) && (n = O(n)[0]);
                    var r = Pt(n || {}).get, s = t ? b : y;
                    return "native" === t && (t = ""), n && (e ? s((q[e] && q[e].get || r)(n, e, t, i)) : function (e, t, i) {
                        return s((q[e] && q[e].get || r)(n, e, t, i))
                    })
                },
                quickSetter: function (i, t, n) {
                    var r, s;
                    if (1 < (i = O(i)).length) return r = i.map(function (e) {
                        return f.quickSetter(e, t, n)
                    }), s = r.length, function (e) {
                        for (var t = s; t--;) r[t](e)
                    };
                    i = i[0] || {};
                    var a = q[t], o = Pt(i), l = o.harness && (o.harness.aliases || {})[t] || t, c = a ? function (e) {
                        var t = new a;
                        Be._pt = 0, t.init(i, n ? e + n : e, Be, 0, [i]), t.render(1, t), Be._pt && Oi(1, Be)
                    } : o.set(i, l);
                ...
                quickTo: function (e, n, t) {
                    ...
                    var r = f.to(e, J(((e = {})[n] = "+=0.1", e.paused = !0, e), t || {}));
                    return i.tween = r, i
                },
                ...
                registerEffect: function (e) {
                    var n = e.name, r = e.effect, t = e.plugins, s = e.defaults, e = e.extendTimeline;
                ...
                exportRoot: function (e, t) {
                    ...
                    for (r.smoothChildTiming = z(e.smoothChildTiming), B.remove(r), r._dp = 0, r._time = r._tTime = B._time, i = B._first; i;) n = i._next, !t && !i._dur && i instanceof X && i.vars.onComplete === i._targets[0] || M(r, i, i._start - i._delay), i = n;
                    return M(B, r, 0), r
                },
                ...
                utils: {
                    wrap: ye, wrapYoyo: be, distribute: fe, random: $t, snap: ge, normalize: function (e, t, i) {
                        return _e(e, t, 0, 1, i)
                    }, getUnit: $, clamp: function (t, i, e) {
                        return Ht(e, function (e) {
                            return pe(t, i, e)
                        })
                    }, splitColor: Ut, toArray: O, selector: he, mapRange: _e, pipe: function () {
                        for (var e = arguments.length, t = new Array(e), i = 0; i < e; i++) t[i] = arguments[i];
                        return function (e) {
                ...
                return kn[e] = X[e]
            }), m.add(P.updateRoot), Be = kn.to({}, {duration: 0}), function (e, t) {
                ...
                name: "attr", init: function (e, t, i, n, r) {
                    ...
                    for (var i = t._pt; i;) j ? i.set(i.t, i.p, i.b, i) : i.r(e, i.d), i = i._next
                }
            }, {
                name: "endArray", init: function (e, t) {
                    for (var i = t.length; i--;) this.add(e, i, e[i] || 0, t[i], 0, 0, 0, 0, 0, 1)
                }
            }, Gi("roundProps", me), Gi("modifiers"), Gi("snap", ge)) || kn,
            t = (X.version = P.version = f.version = "3.12.4", Re = 1, s() && Jt(), L.Power0), An = L.Power1,
            On = L.Power2, Ln = L.Power3, Pn = L.Power4, zn = L.Linear, Dn = L.Quad, Rn = L.Cubic, jn = L.Quart,
            Bn = L.Quint, Fn = L.Strong, Nn = L.Elastic, Hn = L.Back, Wn = L.SteppedEase, qn = L.Bounce, Yn = L.Sine,
            $n = L.Expo, Xn = L.Circ, Gn = function () {
                return "undefined" != typeof window
            }, Vn = {}, Un = 180 / Math.PI, Qn = Math.PI / 180, Kn = Math.atan2, Zn = /([A-Z])/g,
            Jn = /(left|right|width|margin|padding|x)/i, er = /[\s,\(]\S/,
            V = {autoAlpha: "opacity,visibility", scale: "scaleX,scaleY", alpha: "opacity"}, U = "transform",
            Q = U + "Origin", tr = function (e) {
                ...
                var i;
                t && (e = e.style, t in Vn && t !== Q && (t = U), e.removeProperty ? ("ms" !== (i = t.substr(0, 2)) && "webkit" !== t.substr(0, 6) || (t = "-" + t), e.removeProperty("--" === i ? t : t.replace(Zn, "-$1").toLowerCase())) : e.removeAttribute(t))
            }, cr = function (e, t, i, n, r, s) {
                t = new G(e._pt, t, i, 0, 1, s ? Ji : Zi);
                return (e._pt = t).b = n, t.e = r, e._props.push(i), t
            }, dr = {deg: 1, rad: 1, turn: 1}, ur = {grid: 1, flex: 1}, pr = function e(t, i, n, r) {
                var s, a, o = parseFloat(n) || 0, l = (n + "").trim().substr((o + "").length) || "px", c = Tn.style,
                    d = Jn.test(i), u = "svg" === t.tagName.toLowerCase(),
                    p = (u ? "client" : "offset") + (d ? "Width" : "Height"), h = "px" === r, f = "%" === r;
                return r === l || !o || dr[r] || dr[l] ? o : ("px" === l || h || (o = e(t, i, n, "px")), n = t.getCTM && or(t), !f && "%" !== l || !Vn[i] && !~i.indexOf("adius") ? (c[d ? "width" : "height"] = 100 + (h ? l : r), u = ~i.indexOf("adius") || "em" === r && t.appendChild && !u ? t : t.parentNode, (a = (u = (u = n ? (t.ownerSVGElement || {}).parentNode : u) && u !== _n && u.appendChild ? u : _n.body)._gsap) && f && a.width && d && a.time === m.time && !a.uncache ? Y(o / a.width * 100) : (!f || "height" !== i && "width" !== i ? (!f && "%" !== l || ur[nr(u, "display")] || (c.position = nr(t, "position")), u === t && (c.position = "static"), u.appendChild(Tn), s = Tn[p], u.removeChild(Tn), c.position = "absolute") : (l = t.style[i], t.style[i] = 100 + r, s = t[p], l ? t.style[i] = l : lr(t, i)), d && f && ((a = Pt(u)).time = m.time, a.width = u[p]), Y(h ? s * o / 100 : s && o ? 100 / s * o : 0))) : (s = n ? t.getBBox()[d ? "width" : "height"] : t[p], Y(f ? o / s * 100 : o / 100 * s)))
            }, hr = function (e, t, i, n) {
                var r;
                return xn || dn(), t in V && "transform" !== t && ~(t = V[t]).indexOf(",") && (t = t.split(",")[0]), Vn[t] && "transform" !== t ? (r = _r(e, n), r = "transformOrigin" !== t ? r[t] : r.svg ? r.origin : wr(nr(e, Q)) + " " + r.zOrigin + "px") : (r = e.style[t]) && "auto" !== r && !n && !~(r + "").indexOf("calc(") || (r = mr[t] && mr[t](e, t, i) || nr(e, t) || zt(e, t) || ("opacity" === t ? 1 : 0)), i && !~(r + "").trim().indexOf(" ") ? pr(e, t, r, i) + i : r
            }, fr = {top: "0%", bottom: "100%", left: "0%", right: "100%", center: "50%"}, mr = {
                clearProps: function (e, t, i, n, r) {
                    if ("isFromStart" !== r.data) return (t = e._pt = new G(e._pt, t, i, 0, 0, fn)).u = n, t.pr = -10, t.tween = r, e._props.push(i), 1
                }
                ...
                var i, n, r, s, a, t = t || this, o = t.xPercent, l = t.yPercent, c = t.x, d = t.y, u = t.rotation,
                    p = t.skewX, h = t.skewY, f = t.scaleX, m = t.scaleY, g = t.target, v = t.xOrigin, y = t.yOrigin,
                    b = t.xOffset, _ = t.yOffset, t = t.forceCSS, w = parseFloat(c), x = parseFloat(d), u = parseFloat(u),
                    p = parseFloat(p);
                (h = parseFloat(h)) && (p += h = parseFloat(h), u += h), u || p ? (u *= Qn, p *= Qn, i = Math.cos(u) * f, n = Math.sin(u) * f, r = Math.sin(u - p) * -m, s = Math.cos(u - p) * m, p && (h *= Qn, a = Math.tan(p - h), r *= a = Math.sqrt(1 + a * a), s *= a, h) && (a = Math.tan(h), i *= a = Math.sqrt(1 + a * a), n *= a), i = Y(i), n = Y(n), r = Y(r), s = Y(s)) : (i = f, s = m, n = r = 0), (w && !~(c + "").indexOf("px") || x && !~(d + "").indexOf("px")) && (w = pr(g, "x", c, "px"), x = pr(g, "y", d, "px")), (v || y || b || _) && (w = Y(w + v - (v * i + y * r) + b), x = Y(x + y - (v * n + y * s) + _)), (o || l) && (a = g.getBBox(), w = Y(w + o / 100 * a.width), x = Y(x + l / 100 * a.height)), g.setAttribute("transform", a = "matrix(" + i + "," + n + "," + r + "," + s + "," + w + "," + x + ")"), t && (g.style[U] = a)
                ...
                name: "css", register: dn, targetTest: function (e) {
                    return e.style && e.nodeType
                }, init: function (e, t, i, n, r) {
                    var s, a, o, l, c, d, u, p, h, R, f, m, j, g, v, y, b, _, w, x, B = this._props, T = e.style,
                        S = i.vars.startAt;
                    for (c in xn || dn(), this.styles = this.styles || cn(e), g = this.styles.props, this.tween = i, t) if ("autoRound" !== c && (a = t[c], !q[c] || !pi(c, t, i, n, e, r))) if (p = typeof a, l = mr[c], "string" === (p = "function" === p ? typeof (a = a.call(i, n, e, r)) : p) && ~a.indexOf("random(") && (a = Xt(a)), l) l(this, e, c, a, i) && (j = 1); else if ("--" === c.substr(0, 2)) s = (getComputedStyle(e).getPropertyValue(c) + "").trim(), a += "", Kt.lastIndex = 0, Kt.test(s) || (d = $(s), u = $(a)), u ? d !== u && (s = pr(e, c, s, u) + u) : d && (a += d), this.add(T, "setProperty", s, a, n, r, 0, 0, c), B.push(c), g.push(c, 0, T[c]); else if ("undefined" !== p) {
                        if ((!(S && c in S) || (s = "function" == typeof S[c] ? S[c].call(i, n, e, r) : S[c], W(s) && ~s.indexOf("random(") && (s = Xt(s)), $(s + "") || "auto" === s || (s += F.units[c] || $(hr(e, c)) || ""), "=" === (s + "").charAt(1))) && (s = hr(e, c)), l = parseFloat(s), (p = "string" === p && "=" === a.charAt(1) && a.substr(0, 2)) && (a = a.substr(2)), o = parseFloat(a), h = (c = c in V && ("autoAlpha" === c && (1 === l && "hidden" === hr(e, "visibility") && o && (l = 0), g.push("visibility", 0, T.visibility), cr(this, T, "visibility", l ? "inherit" : "hidden", o ? "inherit" : "hidden", !o)), "scale" !== c) && "transform" !== c && ~(c = V[c]).indexOf(",") ? c.split(",")[0] : c) in Vn) if (this.styles.save(c), R || ((f = e._gsap).renderTransform && !t.parseTransform || _r(e, t.parseTransform), m = !1 !== t.smoothOrigin && f.smooth, (R = this._pt = new G(this._pt, T, U, 0, 1, f.renderTransform, f, 0, -1)).dep = 1), "scale" === c) this._pt = new G(this._pt, f, "scaleY", f.scaleY, (p ? Dt(f.scaleY, p + o) : o) - f.scaleY || 0, Vi), this._pt.u = 0, B.push("scaleY", c), c += "X"; else {
                            if ("transformOrigin" === c) {
                                g.push(Q, 0, T[Q]), x = w = _ = void 0, _ = (b = a).split(" "), w = _[0], x = _[1] || "50%", "top" !== w && "bottom" !== w && "left" !== x && "right" !== x || (b = w, w = x, x = b), _[0] = fr[w] || w, _[1] = fr[x] || x, a = _.join(" "), f.svg ? gn(e, a, 0, m, 0, this) : ((u = parseFloat(a.split(" ")[2]) || 0) !== f.zOrigin && cr(this, f, "zOrigin", f.zOrigin, u), cr(this, T, c, wr(s), wr(a)));
                                continue
                            }
                            if ("svgOrigin" === c) {
                                gn(e, a, 1, m, 0, this);
                            ...
                            if (c in vr) {
                                b = this, w = f, x = c, _ = l, v = p ? Dt(l, p + a) : a, y = L = D = void 0, D = W(v), L = parseFloat(v) * (D && ~v.indexOf("rad") ? Un : 1) - _, y = _ + L + "deg", D && ("short" === (D = v.split("_")[1]) && (L %= 360) !== L % 180 && (L += L < 0 ? 360 : -360), "cw" === D && L < 0 ? L = (L + 36e9) % 360 - 360 * ~~(L / 360) : "ccw" === D && 0 < L && (L = (L - 36e9) % 360 - 360 * ~~(L / 360))), b._pt = v = new G(b._pt, w, x, _, L, Ui), v.e = y, v.u = "deg", b._props.push(x);
                                continue
                            }
                            if ("smoothOrigin" === c) {
                            ...
                            if ("transform" === c) {
                                ...
                                for (C in z.svg ? (M = P.getAttribute("transform"), P.setAttribute("transform", ""), D[U] = L, E = _r(P, 1), lr(P, U), P.setAttribute("transform", M)) : (M = getComputedStyle(P)[U], D[U] = L, E = _r(P, 1), D[U] = M), Vn) (M = z[C]) !== (I = E[C]) && "perspective,force3D,transformOrigin,svgOrigin".indexOf(C) < 0 && (k = $(M) !== (A = $(I)) ? pr(P, C, M, A) : parseFloat(M), I = parseFloat(I), O._pt = new G(O._pt, E, C, k, I - k, Vi), O._pt.u = A || 0, O._props.push(C));
                                yn(E, z);
                                continue
                            }
                        } else c in T || (c = sr(c) || c);
                        if (h || (o || 0 === o) && (l || 0 === l) && !er.test(a) && c in T) o = o || 0, (d = (s + "").substr((l + "").length)) !== (u = $(a) || (c in F.units ? F.units[c] : d)) && (l = pr(e, c, s, u)), this._pt = new G(this._pt, h ? f : T, c, l, (p ? Dt(l, p + o) : o) - l, h || "px" !== u && "zIndex" !== c || !1 === t.autoRound ? Vi : Ki), this._pt.u = u || 0, d !== u && "%" !== u && (this._pt.b = s, this._pt.r = Qi); else if (c in T) hn.call(this, e, c, s, p ? p + a : a); else if (c in e) this.add(e, c, s || e[c], p ? p + a : a, n, r); else if ("parseTransform" !== c) {
                            _t(c, a);
                            continue
                        }
                        h || (c in T ? g.push(c, 0, T[c]) : g.push(c, 1, s || e[c])), B.push(c)
                    }
                    j && zi(this)
                }, render: function (e, t) {
                    if (t.tween._time || !En()) for (var i = t._pt; i;) i.r(e, i.d), i = i._next; else t.styles.revert()
                }, get: hr, aliases: V, getSetter: function (e, t, i) {
                    var n = V[t];
            ...
            Ir = (f.utils.checkPrefix = sr, f.core.getStyleSaver = cn, Mn = h((Ir = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent") + "," + (Ar = "rotation,rotationX,rotationY,skewX,skewY") + ",transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", function (e) {
                Vn[e] = 1
            }), h(Ar, function (e) {
                F.units[e] = "deg", vr[e] = 1
            }), V[Mn[13]] = Ir + "," + Ar, h("0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY", function (e) {
                e = e.split(":");
                V[e[1]] = Mn[e[0]]
            }), h("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective", function (e) {
                F.units[e] = "px"
            }), f.registerPlugin(kr), f.registerPlugin(kr) || f), Ar = Ir.core.Tween;
        e.Back = Hn, e.Bounce = qn, e.CSSPlugin = kr, e.Circ = Xn, e.Cubic = Rn, e.Elastic = Nn, e.Expo = $n, e.Linear = zn, e.Power0 = t, e.Power1 = An, e.Power2 = On, e.Power3 = Ln, e.Power4 = Pn, e.Quad = Dn, e.Quart = jn, e.Quint = Bn, e.Sine = Yn, e.SteppedEase = Wn, e.Strong = Fn, e.TimelineLite = P, e.TimelineMax = P, e.TweenLite = X, e.TweenMax = Ar, e.default = Ir, e.gsap = Ir, "undefined" == typeof window || window !== e ? Object.defineProperty(e, "__esModule", {value: !0}) : delete window.default
    }),
    /*!
    ...
    function (e, t) {
        ...
        return t.on = function (e, t) {
            ...
            if (i && i.length) {
                ...
                for (n of i) r && r[n] && (this.off(e, n), delete r[n]), n.apply(this, t)
            }
            return this
        }, t.allOff = function () {
 ...
 */
    function (e, t) {
        ...
        let s = t.jQuery, a = t.console;

        function o(e, t, i) {
            if (!(this instanceof o)) return new o(e, t, i);
            let n = e;
            var r;
            (n = "string" == typeof e ? document.querySelectorAll(e) : n) ? (this.elements = (r = n, Array.isArray(r) ? r : "object" == typeof r && "number" == typeof r.length ? [...r] : [r]), this.options = {}, "function" == typeof t ? i = t : Object.assign(this.options, t), i && this.on("always", i), this.getImages(), s && (this.jqDeferred = new s.Deferred), setTimeout(this.check.bind(this))) : a.error("Bad element for imagesLoaded " + (n || e))
        }

        (o.prototype = Object.create(e.prototype)).getImages = function () {
            this.images = [], this.elements.forEach(this.addElementImages, this)
        };
        const r = [1, 9, 11], l = (o.prototype.addElementImages = function (e) {
    ...
    $(function () {
        ...
        if (void 0 !== s && null != s) {
            ...
            class n {
                ...
                appear() {
                    this.container.classList.add("scrolling"), s.classList.add("scrolling"), this.slides[this.currentIdx].classList.remove("show-meta")
                }

                disperse(t) {
                    this.currentIdx = t, this.slides[this.currentIdx].classList.add("show-meta"), this.container.classList.remove("scrolling"), s.classList.remove("scrolling");
                    for (let e = 0; e < this.data.length; e++) e > t ? (this.slides[e].classList.add("next"), this.slides[e].classList.remove("prev")) : e < t ? (this.slides[e].classList.remove("next"), this.slides[e].classList.add("prev")) : (this.slides[e].classList.remove("next"), this.slides[e].classList.remove("prev"))
                }
            }

            class r {
                constructor({onGrabStart: e, onGrabMove: t, onGrabEnd: i}) {
                    this.onGrabEnd = i, this.onGrabStart = e, this.onGrabMove = t, this.scroll = {
                        start: 0,
                        current: 0,
                        initial: 0
                ...
                listen(t, i, e) {
                    const n = this;
                    let r = e ? function (e) {
                        i({y: e.targetTouches[0] ? e.targetTouches[0].clientY : null})
                    } : function (e) {
                        "mouseout" === e.type && null != e.relatedTarget || i({y: e.clientY})
                    };
                    if (Array.isArray(t)) for (let e = 0; e < t.length; e++) window.addEventListener(t[e], r, !1); else window.addEventListener(t, function (e) {
                        e.target.closest(".stickyImageContainer") === s ? r(e) : n.onMouseUp()
                    }, !1)
                }

                onMouseDown(e) {
                    this.scroll.inital = this.scroll.current, this.scroll.start = e.y, this.scroll.current = e.y, this.scroll.delta = this.scroll.current - this.scroll.start, this.onGrabStart({
                ...
                onMouseMove(e) {
                    this.scroll.start && (this.scroll.current = e.y, this.scroll.delta = this.scroll.current - this.scroll.start, this.onGrabMove({
                        delta: this.scroll.delta,
                        direction: Math.abs(this.scroll.delta),
                        current: this.scroll.current,
                        start: this.scroll.start
            ...
            const a = function ({from: e, to: s, restDelta: a = .01}) {
                let o = Object.assign({}, e), l = Object.keys(e), c = {current: null}, d = function (e, t) {
                    if (0 === l.length) cancelAnimationFrame(c.current), c.current = null, t(o); else {
                        l.slice();
                        for (var i, n, r = l.length; 0 <= r; r--) n = l[r], i = o[n] + .1 * (s[n] - o[n]), Math.abs(s[n] - i) < a ? (o[n] = s[n], l.splice(r, 1), r--) : o[n] = i;
                        e(o), c.current = requestAnimationFrame(d)
                    }
                };
                return {
                    start: function ({update: e, complete: t}) {
                        return d = d.bind(null, e, t), c.current = requestAnimationFrame(d), {
                            stop: function () {
            ...
            function t(e, t = {}) {
                this.data = e, this.progress = 0, this.direction = 1, this.waveIntensity = 0, this.options = t, this.index = {
                    target: 0,
                    current: 0,
                    initial: 0,
                    ...
                    x: 0,
                    y: 0
                }, this.followerSpring = null, this.slidesSpring = null, this.grab = new r({
            ...
            t.prototype.onGrabMove = function (e) {
                ...
                this.index.active !== e && (this.index.active = e, this.options.onActiveIndexChange) && this.options.onActiveIndexChange(this.index.active), this.slidesPop && this.slidesPop.stop(), this.slidesPop = a({
                    from: {index: this.index.current},
                    to: {index: this.index.target},
                    restDelta: .001
                }).start({
                    update: e => {
                        this.options.onIndexChange && this.options.onIndexChange(e.index), this.index.current = e.index
                    }, complete: e => {
                        this.options.onIndexChange && this.options.onIndexChange(e.index), this.index.current = e.index
                    }
                })
            }, t.prototype.onGrabStart = function () {
                this.options.onZoomOutStart && this.options.onZoomOutStart({activeIndex: this.index.active}), this.index.initial = this.index.current
            }, t.prototype.snapCurrentToActiveIndex = function () {
                this.slidesPop && this.slidesPop.stop(), this.slidesPop = a({
                    from: {index: this.index.current},
                ...
                this.options.onFullscreenStart && (this.options.onFullscreenStart({activeIndex: this.index.active}), this.snapCurrentToActiveIndex())
    ...
    function (t, i) {
        ...
        function r(l, c, d) {
            (d = d || t || e.jQuery) && (c.prototype.option || (c.prototype.option = function (e) {
                ...
                var t, n, r, s, a, o;
                return "string" == typeof e ? (t = i.call(arguments, 1), r = t, a = "$()." + l + '("' + (n = e) + '")', (t = this).each(function (e, t) {
                    var i, t = d.data(t, l);
                    t ? (i = t[n]) && "_" != n.charAt(0) ? (i = i.apply(t, r), s = void 0 === s ? i : s) : u(a + " is not a valid method") : u(l + " not initialized. Cannot call methods, i.e. " + a)
                }), void 0 !== s ? s : t) : (o = e, this.each(function (e, t) {
                    var i = d.data(t, l);
 ...
 */
    function (e, t) {
        ...
        function x(e) {
            if (w || (w = !0, (d = document.createElement("div")).style.width = "200px", d.style.padding = "1px 2px 3px 4px", d.style.borderStyle = "solid", d.style.borderWidth = "1px 2px 3px 4px", d.style.boxSizing = "border-box", (c = document.body || document.documentElement).appendChild(d), s = b(d), _ = 200 == Math.round(g(s.width)), x.isBoxSizeOuter = _, c.removeChild(d)), (e = "string" == typeof e ? document.querySelector(e) : e) && "object" == typeof e && e.nodeType) {
                ...
                for (var r = {}, s = (r.width = e.offsetWidth, r.height = e.offsetHeight, r.isBorderBox = "border-box" == t.boxSizing), a = 0; a < y; a++) {
                    var o = v[a], l = t[o], l = parseFloat(l);
                    r[o] = isNaN(l) ? 0 : l
                }
                var c = r.paddingLeft + r.paddingRight, d = r.paddingTop + r.paddingBottom,
                    e = r.marginLeft + r.marginRight, u = r.marginTop + r.marginBottom,
                    p = r.borderLeftWidth + r.borderRightWidth, h = r.borderTopWidth + r.borderBottomWidth, f = s && _,
                    m = g(t.width), m = (!1 !== m && (r.width = m + (f ? 0 : c + p)), g(t.height));
                return !1 !== m && (r.height = m + (f ? 0 : d + h)), r.innerWidth = r.width - (c + p), r.innerHeight = r.height - (d + h), r.outerWidth = r.width + e, r.outerHeight = r.height + u, r
            }
        }
    ...
    var l = {
        ...
        n = n || 100;
        var r = e.prototype[t], s = t + "Timeout";
        e.prototype[t] = function () {
            var e = this[s], t = (clearTimeout(e), arguments), i = this;
    ...
    e.constructor = a, e._create = function () {
        ...
        var e = getComputedStyle(this.element), t = this.layout._getOption("originLeft"),
            ...
            r = parseFloat(n), s = parseFloat(e), a = this.layout.size;
        -1 != n.indexOf("%") && (r = r / 100 * a.width), -1 != e.indexOf("%") && (s = s / 100 * a.height), r = isNaN(r) ? 0 : r, s = isNaN(s) ? 0 : s, r -= t ? a.paddingLeft : a.paddingRight, s -= i ? a.paddingTop : a.paddingBottom, this.position.x = r, this.position.y = s
    }, e.layoutPosition = function () {
        var e = this.layout.size, t = {}, i = this.layout._getOption("originLeft"),
            n = this.layout._getOption("originTop"), r = i ? "right" : "left",
            s = this.position.x + e[i ? "paddingLeft" : "paddingRight"],
            i = (t[i ? "left" : "right"] = this.getXValue(s), t[r] = "", n ? "paddingTop" : "paddingBottom"),
            s = n ? "bottom" : "top", r = this.position.y + e[i];
        t[n ? "top" : "bottom"] = this.getYValue(r), t[s] = "", this.css(t), this.emitEvent("layout", [this])
        ...
        this.getPosition();
        var i = this.position.x, n = this.position.y, r = e == this.position.x && t == this.position.y;
        this.setPosition(e, t), r && !this.isTransitioning ? this.layoutPosition() : ((r = {}).transform = this.getTranslate(e - i, t - n), this.transition({
            to: r,
 ...
 */
    function (r, s) {
        ...
        var a = e.console, o = e.jQuery, l = 0, c = {};

        function d(e, t) {
            var i = n.getQueryElement(e);
            i ? (this.element = i, o && (this.$element = o(this.element)), this.options = n.extend({}, this.constructor.defaults), this.option(t), t = ++l, this.element.outlayerGUID = t, (c[t] = this)._create(), this._getOption("initLayout") && this.layout()) : a && a.error("Bad element for " + this.constructor.namespace + ": " + (i || e))
        }
        ...
        n.extend(u, t.prototype), u.option = function (e) {
            ...
            var t = e.getBoundingClientRect(), i = this._boundingRect, e = r(e);
            return {
            ...
            var i = p(d);
            return i.defaults = n.extend({}, d.defaults), n.extend(i.defaults, t), i.compatOptions = n.extend({}, d.compatOptions), i.namespace = e, i.data = d.data, i.Item = p(s), n.htmlInit(i, e), o && o.bridget && o.bridget(e, i), i
        };
        var h = {ms: 1, s: 1e3};
        return d.Item = s, d
    }), function (e, t) {
    ...
    var i = t.prototype = Object.create(e.Item.prototype), n = i._create, r = (i._create = function () {
    ...
    return ["_resetLayout", "_getItemLayoutPosition", "_manageStamp", "_getContainerSize", "_getElementOffset", "needsResizeLayout", "_getOption"].forEach(function (e) {
        ...
        return (i.prototype = Object.create(r)).constructor = i, t && (i.options = t), n.modes[i.prototype.namespace = e] = i
    }, n
}),
    /*!
 * Masonry v4.2.1
    ...
    function (e, t) {
        ...
        return t._resetLayout = function () {
            ...
            for (var t = e.size.outerWidth % this.columnWidth, t = Math[t && t < 1 ? "round" : "ceil"](e.size.outerWidth / this.columnWidth), t = Math.min(t, this.cols), i = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](t, e), n = {
                ...
                y: i.y
            }, r = i.y + e.size.outerHeight, s = t + i.col, a = i.col; a < s; a++) this.colYs[a] = r;
            return n
            ...
            for (var r = Math.min(this.cols - 1, r), s = (this._getOption("originTop") ? e.top : e.bottom) + t.outerHeight, a = i; a <= r; a++) this.colYs[a] = Math.max(s, this.colYs[a])
 ...
 */
    function (e, t) {
        ...
        "use strict";
        var i, e = e.create("masonry"), n = e.prototype, r = {_getElementOffset: !0, layout: !0, _getMeasurement: !0};
        for (i in t.prototype) r[i] || (n[i] = t.prototype[i]);
        var s = n.measureColumns, a = (n.measureColumns = function () {
 ...
 */
    function (a, o) {
        ...
        var o = e.jQuery, l = String.prototype.trim ? function (e) {
            ...
            e = (c.Item = r, c.LayoutMode = a, c.prototype), d = (e._create = function () {
                ...
                for (var t = this.options.filter, i = [], n = [], r = [], s = this._getFilterTest(t || "*"), a = 0; a < e.length; a++) {
                    var o, l = e[a];
                    l.isIgnored || ((o = s(l)) && i.push(l), o && l.isHidden ? n.push(l) : o || l.isHidden || r.push(l))
                }
                ...
                var t, i, n, r, s;
                return "string" == typeof e && (n = (i = (t = l(e).split(" "))[0]).match(/^\[(.+)\]$/), r = function (t, i) {
                ...
                }(n && n[1], i), e = (s = c.sortDataParsers[t[1]]) ? function (e) {
                    return e && s(r(e))
                } : function (e) {
                    return e && r(e)
                }), e
        ...
        c.sortDataParsers = {
            ...
            var e, a, o;
            this.options.sortBy && (e = s.makeArray(this.options.sortBy), this._getIsSameSortBy(e) || (this.sortHistory = e.concat(this.sortHistory)), a = this.sortHistory, o = this.options.sortAscending, this.filteredItems.sort(function (e, t) {
                for (var i = 0; i < a.length; i++) {
                    var n = a[i], r = e.sortData[n], s = t.sortData[n];
                    if (s < r || r < s) return (s < r ? 1 : -1) * ((void 0 !== o[n] ? o[n] : o) ? 1 : -1)
                }
                return 0
            }))
            ...
            if (t.length) {
                for (var i, n = t.length, r = 0; r < n; r++) i = t[r], this.element.appendChild(i.element);
...
!*/
    function (s) {
        var r = [], n = !1, a = !1, o = {interval: 250, force_process: !1}, l = s(window), c = [];
        ...
        function d() {
            ...
            for (var e = 0, t = r.length; e < t; e++) {
                ...
                n.trigger("appear", [n]), c[e] && (i = c[e].not(n)).trigger("disappear", [i]), c[e] = n
            }
        }
        ...
        s.expr.pseudos.appeared = s.expr.createPseudo(function (e) {
            ...
            appear: function (e, t) {
                ...
                }, s(window).scroll(t).resize(t), n = !0), i.force_process && setTimeout(d, i.interval), r.push(e), c.push()
...
!*/
    function (e) {
        ...
        function a(e, t) {
            this.$element = s(e), this.options = s.extend({}, a.DEFAULTS, this.dataOptions(), t), this.init()
        }
        ...
        a.DEFAULTS = {
            ...
            return this.each(function () {
                var e = s(this), t = e.data("countTo"), i = "object" == typeof r ? r : {},
                    n = "string" == typeof r ? r : "start";
                t && "object" != typeof r || (t && t.stop(), e.data("countTo", t = new a(this, i))), t[n].call(t)
            })
        }
    }),
    /*!
...
!*/
    function (e) {
        ...
        "use strict";
        var r = [], s = {precision: 100, elapse: !1, defer: !1};
        (t = []).push(/^[0-9]*$/.source), t.push(/([0-9]{1,2}\/){2}[0-9]{4}( [0-9]{1,2}(:[0-9]{2}){2})?/.source), t.push(/[0-9]{4}([\/\-][0-9]{1,2}){2}( [0-9]{1,2}(:[0-9]{2}){2})?/.source);
        var t = new RegExp(t.join("|")), d = {
            Y: "years",
            m: "months",
            n: "daysToMonth",
            d: "daysToWeek",
            ...
            return function (e) {
                ...
                if (t) for (var i = 0, n = t.length; i < n; ++i) {
                    var r = t[i].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/),
                        s = (s = (s = r[0]).toString().replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1"), new RegExp(s)),
                        a = r[1] || "", o = r[3] || "", l = null, r = r[2];
                    d.hasOwnProperty(r) && (l = d[r], l = Number(c[l])), null !== l && ("!" === a && (l = function (e, t) {
                        var i = "s", n = "";
                        e && (e = e.replace(/(:|;|\s)/gi, "").split(/\,/), i = 1 === e.length ? e[0] : (n = e[0], e[1]));
                        return 1 < Math.abs(t) ? i : n
                    }(o, l)), "" === a && l < 10 && (l = "0" + l.toString()), e = e.replace(s, l.toString()))
                }
                return e = e.replace(/%%/, "%")
            }
        }
        ...
        n.extend(a.prototype, {
            start: function () {
                ...
                var e, t, i;
                0 === this.$el.closest("html").length ? this.remove() : (e = void 0 !== n._data(this.el, "events"), t = new Date, i = this.finalDate.getTime() - t.getTime(), i = Math.ceil(i / 1e3), i = !this.options.elapse && i < 0 ? 0 : Math.abs(i), this.totalSecsLeft !== i && e && (this.totalSecsLeft = i, this.elapsed = t >= this.finalDate, this.offset = {
            ...
            return this.each(function () {
                ...
                void 0 !== t ? (t = r[t], e = i[0], a.prototype.hasOwnProperty(e) ? t[e].apply(t, i.slice(1)) : null === String(e).match(/^[$A-Z_][0-9A-Z_$]*$/i) ? (t.setFinalDate.call(t, e), t.start()) : n.error("Method %s does not exist on jQuery.countdown".replace(/\%s/gi, e))) : new a(this, i[0], i[1])
            })
        }
    }),
    /*!
...
!*/
    function (e) {
        ...
        function a(e, a) {
            function i() {
                a.scaleColor && c(), a.trackColor && l(a.trackColor, a.trackWidth || a.lineWidth, 1)
            }

            var n, t = document.createElement("canvas"),
                r = (e.appendChild(t), "object" == typeof G_vmlCanvasManager && G_vmlCanvasManager.initElement(t), t.getContext("2d")),
                s = (t.width = t.height = a.size, 1),
                o = (1 < window.devicePixelRatio && (s = window.devicePixelRatio, t.style.width = t.style.height = [a.size, "px"].join(""), t.width = t.height = a.size * s, r.scale(s, s)), r.translate(a.size / 2, a.size / 2), r.rotate((a.rotate / 180 - .5) * Math.PI), (a.size - a.lineWidth) / 2),
                l = (a.scaleColor && a.scaleLength && (o -= a.scaleLength + 2), Date.now = Date.now || function () {
                    return +new Date
                }, function (e, t, i) {
                    var n = (i = Math.min(Math.max(-1, i || 0), 1)) <= 0;
                    r.beginPath(), r.arc(0, 0, o, 0, 2 * Math.PI * i, n), r.strokeStyle = e, r.lineWidth = t, r.stroke()
                }), c = function () {
                    var e, t;
                    r.lineWidth = 1, r.fillStyle = a.scaleColor, r.save();
                    for (var i = 24; 0 < i; --i) e = i % 6 == 0 ? (t = a.scaleLength, 0) : (t = .6 * a.scaleLength, a.scaleLength - t), r.fillRect(-a.size / 2 + e, 0, t, 1), r.rotate(Math.PI / 12);
                    r.restore()
                },
            ...
            this.getCanvas = function () {
                ...
                var t;
                a.scaleColor || a.trackColor ? r.getImageData && r.putImageData ? n ? r.putImageData(n, 0, 0) : (i(), n = r.getImageData(0, 0, a.size * s, a.size * s)) : (this.clear(), i()) : this.clear(), r.lineCap = a.lineCap, t = "function" == typeof a.barColor ? a.barColor(e) : a.barColor, l(t, a.lineWidth, e / 100)
            }.bind(this), this.animate = function (i, n) {
                var r = Date.now(), s = (a.onStart(i, n), function () {
                    var e = Math.min(Date.now() - r, a.animate.duration),
                        t = a.easing(this, e, i, n - i, a.animate.duration);
                    this.draw(t), a.onStep(i, n, t), e >= a.animate.duration ? a.onStop(i, n) : d(s)
                }.bind(this));
                d(s)
            }.bind(this)
        }
        ...
        function n(t, i) {
            var n = {
            ...
            }, r = (n.renderer = a, {}), s = 0, e = function () {
                for (var e in this.el = t, this.options = r, n) n.hasOwnProperty(e) && (r[e] = (i && void 0 !== i[e] ? i : n)[e], "function" == typeof r[e]) && (r[e] = r[e].bind(this));
                "string" == typeof r.easing && "undefined" != typeof jQuery && jQuery.isFunction(jQuery.easing[r.easing]) ? r.easing = jQuery.easing[r.easing] : r.easing = n.easing, "number" == typeof r.animate && (r.animate = {
                    ...
                    duration: 1e3,
                    enabled: r.animate
                }), this.renderer = new r.renderer(t, r), this.renderer.draw(s), t.dataset && t.dataset.percent ? this.update(parseFloat(t.dataset.percent)) : t.getAttribute && t.getAttribute("data-percent") && this.update(parseFloat(t.getAttribute("data-percent")))
            }.bind(this);
...
!*/
    function (s) {
        ...
        s.fn.fitVids = function (e) {
            var t, i, r = {customSelector: null, ignore: null};
            return document.getElementById("fit-vids-style") || (t = document.head || document.getElementsByTagName("head")[0], (i = document.createElement("div")).innerHTML = '<p>x</p><style id="fit-vids-style">.fluid-width-video-wrapper{width:100%;position:relative;padding:0;}.fluid-width-video-wrapper iframe,.fluid-width-video-wrapper object,.fluid-width-video-wrapper embed {position:absolute;top:0;left:0;width:100%;height:100%;}</style>', t.appendChild(i.childNodes[1])), e && s.extend(r, e), this.each(function () {
                var e = ['iframe[src*="player.vimeo.com"]', 'iframe[src*="youtube.com"]', 'iframe[src*="youtube-nocookie.com"]', 'iframe[src*="kickstarter.com"][src*="video.html"]', "object", "embed"],
                    n = (r.customSelector && e.push(r.customSelector), ".fitvidsignore"),
                    e = (r.ignore && (n = n + ", " + r.ignore), s(this).find(e.join(",")));
 ...
 !*/
    function (e) {
        ...
        function h(e) {
            return e === i && f.currTemplate.closeBtn || (f.currTemplate.closeBtn = c(f.st.closeMarkup.replace("%title%", f.st.tClose)), i = e), f.currTemplate.closeBtn
        }
        ...
        var f, n, m, o, g, i, l, v, y, b, _ = "Close", w = "BeforeClose", x = "MarkupParse", T = ".mfp",
            S = "mfp-ready", R = "mfp-removing", E = "mfp-prevent-close", C = !!window.jQuery, M = c(window),
            k = (c.magnificPopup = {
                instance: null,
                proto: e.prototype = {
                    constructor: e, init: function () {
                        ...
                        if (!1 === e.isObj) {
                            ...
                            for (var t, i = e.items, n = 0; n < i.length; n++) if ((t = (t = i[n]).parsed ? t.el[0] : t) === e.el[0]) {
                                f.index = n;
                                break
                            }
                        ...
                        if (!f.isOpen) {
                            ...
                            p("BeforeOpen"), f.st.showCloseBtn && (f.st.closeBtnInside ? (d(x, function (e, t, i, n) {
                            ...
                            var a = f.wH = M.height(), o = {},
                                l = (f.fixedContentPos && f._hasScrollBar(a) && (l = f._getScrollbarSize()) && (o.marginRight = l), f.fixedContentPos && (f.isIE7 ? c("body, html").css("overflow", "hidden") : o.overflow = "hidden"), f.st.mainClass);
                            return f.isIE7 && (l += " mfp-ie7"), l && f._addClassToMFP(l), f.updateItemHTML(), p("BuildControls"), c("html").css(o), f.bgOverlay.add(f.wrap).prependTo(f.st.prependTo || c(document.body)), f._lastFocusedEl = document.activeElement, setTimeout(function () {
                                f.content ? (f._addClassToMFP(S), f._setFocus()) : f.bgOverlay.addClass(S), m.on("focusin.mfp", f._onFocusIn)
                            }, 16), f.isOpen = !0, f.updateSize(a), p("Open"), e
                        }
                        f.updateItemHTML()
                    }, close: function () {
                        f.isOpen && (p(w), f.isOpen = !1, f.st.removalDelay && !f.isLowIE && f.supportsTransition ? (f._addClassToMFP(R), setTimeout(function () {
                            f._close()
                        ...
                        var t;
                        f.isIOS ? (t = document.documentElement.clientWidth / window.innerWidth, t = window.innerHeight * t, f.wrap.css("height", t), f.wH = t) : f.wH = e || M.height(), f.fixedContentPos || f.wrap.css("height", f.wH), p("Resize")
                        ...
                        if ((i = i.tagName ? {el: c(i)} : (t = i.type, {data: i, src: i.src})).el) {
                            for (var n = f.types, r = 0; r < n.length; r++) if (i.el.hasClass("mfp-" + n[r])) {
                                t = n[r];
                                break
                            }
                        ...
                        if (!c(e).hasClass(E)) {
                            var t = f.st.closeOnContentClick, i = f.st.closeOnBgClick;
                            if (t && i) return !0;
                        ...
                        var s;
                        t.data && (e = c.extend(t.data, e)), p(x, [r, e, t]), c.each(e, function (e, t) {
                ...
                s();
                var t, i, n, r = c(this);
                return "string" == typeof e ? "open" === e ? (t = C ? r.data("magnificPopup") : r[0].magnificPopup, i = parseInt(arguments[1], 10) || 0, n = t.items ? t.items[i] : (n = r, (n = t.delegate ? n.find(t.delegate) : n).eq(i)), f._openClick({mfpEl: n}, r, t)) : f.isOpen && f[e].apply(f, Array.prototype.slice.call(arguments, 1)) : (e = c.extend(!0, {}, e), C ? r.data("magnificPopup", e) : r[0].magnificPopup = e, f.addGroup(r, e)), r
                ...
                options: {
                    ...
                    initInline: function () {
                        f.types.push(k), d(_ + "." + k, function () {
                            a()
                        })
                    }, getInline: function (e, t) {
                        var i, n, r;
                        return a(), e.src ? (i = f.st.inline, (n = c(e.src)).length ? ((r = n[0].parentNode) && r.tagName && (v || (l = i.hiddenClass, v = u(l), l = "mfp-" + l), y = n.after(v).detach().removeClass(l)), f.updateStatus("ready")) : (f.updateStatus("error", i.tNotFound), n = c("<div>")), e.inlineElement = n) : (f.updateStatus("ready"), f._parseMarkup(t, {}, e), t)
                    }
                }
            }), "ajax");
        c.magnificPopup.registerModule(I, {
            options: {
                ...
                initAjax: function () {
                    f.types.push(I), b = f.st.ajax.cursor, d(_ + "." + I, t), d("BeforeChange.ajax", t)
                }, getAjax: function (n) {
                    b && c(document.body).addClass(b), f.updateStatus("loading");
                    var e = c.extend({
                        url: n.src, success: function (e, t, i) {
                            e = {data: e, xhr: i};
                            p("ParseAjax", e), f.appendContent(c(e.data), I), n.finished = !0, r(), f._setFocus(), setTimeout(function () {
                                f.wrap.addClass(S)
                            }, 16), f.updateStatus("ready"), p("AjaxContentAdded")
                        }, error: function () {
                            r(), n.finished = n.loadError = !0, f.updateStatus("error", f.st.ajax.tError.replace("%url%", n.src))
                        }
                    }, f.st.ajax.settings);
        ...
        c.magnificPopup.registerModule("image", {
            options: {
                ...
                initImage: function () {
                    ...
                    f.types.push("image"), d("Open" + t, function () {
                        "image" === f.currItem.type && e.cursor && c(document.body).addClass(e.cursor)
                    }), d(_ + t, function () {
                        e.cursor && c(document.body).removeClass(e.cursor), M.off("resize.mfp")
                    ...
                    e.img && (e.hasSize = !0, A && clearInterval(A), e.isCheckingImgSize = !1, p("ImageHasSize", e), e.imgHidden) && (f.content && f.content.removeClass("mfp-loading"), e.imgHidden = !1)
                }, findImageSize: function (t) {
                    function i(e) {
                        A && clearInterval(A), A = setInterval(function () {
                            0 < r.naturalWidth ? f._onImageHasSize(t) : (200 < n && clearInterval(A), 3 === ++n ? i(10) : 40 === n ? i(50) : 100 === n && i(500))
                        }, e)
                    }
                    ...
                    function i() {
                        e && (e.img[0].complete ? (e.img.off(".mfploader"), e === f.currItem && (f._onImageHasSize(e), f.updateStatus("ready")), e.hasSize = !0, e.loaded = !0, p("ImageLoadComplete")) : ++s < 200 ? setTimeout(i, 100) : n())
                    }
                    ...
                    return o.length && ((r = document.createElement("img")).className = "mfp-img", e.el && e.el.find("img").length && (r.alt = e.el.find("img").attr("alt")), e.img = c(r).on("load.mfploader", i).on("error.mfploader", n), r.src = e.src, o.is("img") && (e.img = e.img.clone()), 0 < (r = e.img[0]).naturalWidth ? e.hasSize = !0 : r.width || (e.hasSize = !1)), f._parseMarkup(t, {
                        title: function (e) {
                    ...
                    }, e), f.resizeImage(), e.hasSize ? (A && clearInterval(A), e.loadError ? (t.addClass("mfp-loading"), f.updateStatus("error", a.tError.replace("%url%", e.src))) : (t.removeClass("mfp-loading"), f.updateStatus("ready"))) : (f.updateStatus("loading"), e.loading = !0, e.hasSize || (e.imgHidden = !0, t.addClass("mfp-loading"), f.findImageSize(e))), t
                }
            }
        });
        ...
        function O(e) {
            var t;
            f.currTemplate[z] && (t = f.currTemplate[z].find("iframe")).length && (e || (t[0].src = "//about:blank"), f.isIE8) && t.css("display", e ? "block" : "none")
        }
        ...
        c.magnificPopup.registerModule("zoom", {
            options: {
                ...
                initZoom: function () {
                    ...
                    a.enabled && f.supportsTransition && (t = a.duration, i = function (e) {
                        var e = e.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image"),
                            t = "all " + a.duration / 1e3 + "s " + a.easing, i = {
                                position: "fixed",
                                zIndex: 9999,
                                left: 0,
                                top: 0,
                        ...
                        f._allowZoom() && (clearTimeout(r), f.content.css("visibility", "hidden"), (e = f._getItemToZoom()) ? ((s = i(e)).css(f._getOffset()), f.wrap.append(s), r = setTimeout(function () {
                            s.css(f._getOffset(!0)), r = setTimeout(function () {
                        ...
                        if (f._allowZoom()) {
                            ...
                            s.css(f._getOffset(!0)), f.wrap.append(s), f.content.css("visibility", "hidden"), setTimeout(function () {
                                s.css(f._getOffset())
                            }, 16)
                        }
                    }), d(_ + ".zoom", function () {
                    ...
                    var e = e ? f.currItem.img : f.st.zoom.opener(f.currItem.el || f.currItem), t = e.offset(),
                        i = parseInt(e.css("padding-top"), 10), n = parseInt(e.css("padding-bottom"), 10),
                        e = (t.top -= c(window).scrollTop() - i, {
                            width: e.width(),
                            height: (C ? e.innerHeight() : e[0].offsetHeight) - n - i
                        });
                    return (P = void 0 === P ? void 0 !== document.createElement("p").style.MozTransform : P) ? e["-moz-transform"] = e.transform = "translate(" + t.left + "px," + t.top + "px)" : (e.left = t.left, e.top = t.top), e
                }
            }
        });
        var P, z = "iframe", D = (c.magnificPopup.registerModule(z, {
            options: {
                ...
                initIframe: function () {
                    f.types.push(z), d("BeforeChange", function (e, t, i) {
                        t !== i && (t === z ? O() : i === z && O(!0))
                    }), d(_ + "." + z, function () {
                        O()
                    })
                }, getIframe: function (e, t) {
                    var i = e.src, n = f.st.iframe, r = (c.each(n.patterns, function () {
                    ...
                    return n.srcAction && (r[n.srcAction] = i), f._parseMarkup(t, r, e), f.updateStatus("ready"), t
                }
            }
            ...
            options: {
                ...
                initGallery: function () {
                    var s = f.st.gallery, e = ".mfp-gallery";
                    if (f.direction = !0, !s || !s.enabled) return !1;
                    g += " mfp-gallery", d("Open" + e, function () {
                        ...
                        var e, t;
                        1 < f.items.length && s.arrows && !f.arrowLeft && (t = s.arrowMarkup, e = f.arrowLeft = c(t.replace(/%title%/gi, s.tPrev).replace(/%dir%/gi, "left")).addClass(E), t = f.arrowRight = c(t.replace(/%title%/gi, s.tNext).replace(/%dir%/gi, "right")).addClass(E), e.click(function () {
                            f.prev()
                        }), t.click(function () {
                            f.next()
                    ...
                    var t;
                    e = L(e), f.items[e].preloaded || ((t = f.items[e]).parsed || (t = f.parseEl(e)), p("LazyLoad", t), "image" === t.type && (t.img = c('<img class="mfp-img" />').on("load.mfploader", function () {
                        t.hasSize = !0
        ...
        c.magnificPopup.registerModule(D, {
            options: {
                ...
                initRetina: function () {
                    var i, n;
                    1 < window.devicePixelRatio && (i = f.st.retina, n = i.ratio, 1 < (n = isNaN(n) ? n() : n)) && (d("ImageHasSize." + D, function (e, t) {
    ...
    var g = d.event.special.mousewheel = {
        version: "3.1.12", setup: function () {
            ...
            var e = d(e), t = e["offsetParent" in d.fn ? "offsetParent" : "parent"]();
    ...
    e = "function" == typeof define && define.amd, i = "undefined" != typeof module && module.exports, ae = "https:" == document.location.protocol ? "https:" : "http:", e || (i ? require("jquery-mousewheel")(P) : P.event.special.mousewheel || P("head").append(decodeURI("%3Cscript src=" + ae + "//cdnjs.cloudflare.com/ajax/libs/jquery-mousewheel/3.1.13/jquery.mousewheel.min.js%3E%3C/script%3E"))), l = "mCustomScrollbar", D = "mCS", n = ".mCustomScrollbar", r = {
    ...
    }, I = 0, s = {}, m = window.attachEvent && !window.addEventListener ? 1 : 0, R = !1, g = ["mCSB_dragger_onDrag", "mCSB_scrollTools_onDrag", "mCS_img_loaded", "mCS_disabled", "mCS_destroyed", "mCS_no_scrollbar", "mCS-autoHide", "mCS-dir-rtl", "mCS_no_scrollbar_y", "mCS_no_scrollbar_x", "mCS_y_hidden", "mCS_x_hidden", "mCSB_draggerContainer", "mCSB_buttonUp", "mCSB_buttonDown", "mCSB_buttonLeft", "mCSB_buttonRight"], p = {
        init: function (a) {
            var a = P.extend(!0, {}, r, a), e = c.call(this);
            if (a.live) {
                var t = a.liveSelector || this.selector || n, i = P(t);
                if ("off" === a.live) return void d(t);
                s[t] = setTimeout(function () {
                    i.mCustomScrollbar(a), "once" === a.live && i.length && d(t)
                }, 500)
            } else d(t);
            return a.setWidth = a.set_width || a.setWidth, a.setHeight = a.set_height || a.setHeight, a.axis = a.horizontalScroll ? "x" : A(a.axis), a.scrollInertia = 0 < a.scrollInertia && a.scrollInertia < 17 ? 17 : a.scrollInertia, "object" != typeof a.mouseWheel && 1 == a.mouseWheel && (a.mouseWheel = {
                enable: !0,
                scrollAmount: "auto",
                axis: "y",
                preventDefault: !1,
                ...
                normalizeDelta: !1,
                invert: !1
            }), a.mouseWheel.scrollAmount = a.mouseWheelPixels || a.mouseWheel.scrollAmount, a.mouseWheel.normalizeDelta = a.advanced.normalizeMouseWheelDelta || a.mouseWheel.normalizeDelta, a.scrollButtons.scrollType = O(a.scrollButtons.scrollType), o(a), P(e).each(function () {
                ...
                }), t = (e = s.data(D)).opt, i = s.data("mcs-axis"), n = s.data("mcs-scrollbar-position"), r = s.data("mcs-theme"), i && (t.axis = i), n && (t.scrollbarPosition = n), r && (t.theme = r, o(t)), L.call(this), e && t.callbacks.onCreate && "function" == typeof t.callbacks.onCreate && t.callbacks.onCreate.call(this), P("#mCSB_" + e.idx + "_container img:not(." + g[2] + ")").addClass(g[2]), p.update.call(null, s))
            })
        }, update: function (e, a) {
            e = e || c.call(this);
            return P(e).each(function () {
                var e, t, i, n, r, s = P(this);
                s.data(D) && (t = (e = s.data(D)).opt, i = P("#mCSB_" + e.idx + "_container"), r = P("#mCSB_" + e.idx), n = [P("#mCSB_" + e.idx + "_dragger_vertical"), P("#mCSB_" + e.idx + "_dragger_horizontal")], i.length) && (e.tweenRunning && F(s), a && e && t.callbacks.onBeforeUpdate && "function" == typeof t.callbacks.onBeforeUpdate && t.callbacks.onBeforeUpdate.call(this), s.hasClass(g[3]) && s.removeClass(g[3]), s.hasClass(g[4]) && s.removeClass(g[4]), r.css("max-height", "none"), r.height() !== s.height() && r.css("max-height", s.height()), q.call(this), "y" === t.axis || t.advanced.autoExpandHorizontalScroll || i.css("width", u(i)), e.overflowed = G.call(this), v.call(this), t.autoDraggerLength && $.call(this), X.call(this), V.call(this), r = [Math.abs(i[0].offsetTop), Math.abs(i[0].offsetLeft)], "x" !== t.axis && (e.overflowed[0] ? n[0].height() > n[0].parent().height() ? h.call(this) : (N(s, r[0].toString(), {
                    dir: "y",
                    dur: 0,
                    overwrite: "none"
                }), e.contentReset.y = null) : (h.call(this), "y" === t.axis ? f.call(this) : "yx" === t.axis && e.overflowed[1] && N(s, r[1].toString(), {
                    dir: "x",
                    dur: 0,
                    overwrite: "none"
                    ...
                    dur: 0,
                    overwrite: "none"
                }), e.contentReset.x = null) : (h.call(this), "x" === t.axis ? f.call(this) : "yx" === t.axis && e.overflowed[0] && N(s, r[0].toString(), {
                    dir: "y",
                    dur: 0,
                    overwrite: "none"
                }))), a && e && (2 === a && t.callbacks.onImageLoad && "function" == typeof t.callbacks.onImageLoad ? t.callbacks.onImageLoad.call(this) : 3 === a && t.callbacks.onSelectorChange && "function" == typeof t.callbacks.onSelectorChange ? t.callbacks.onSelectorChange.call(this) : t.callbacks.onUpdate && "function" == typeof t.callbacks.onUpdate && t.callbacks.onUpdate.call(this)), w.call(this))
            })
        }, scrollTo: function (a, o) {
            var e;
            if (void 0 !== a && null != a) return e = c.call(this), P(e).each(function () {
                var e, t, i, n, r, s = P(this);
                s.data(D) && (e = s.data(D), r = {
                    trigger: "external",
                    ...
                    onUpdate: !0,
                    onComplete: !0
                }, i = P.extend(!0, {}, r, o), n = E.call(this, a), r = 0 < i.scrollInertia && i.scrollInertia < 17 ? 17 : i.scrollInertia, n[0] = _.call(this, n[0], "y"), n[1] = _.call(this, n[1], "x"), i.moveDragger && (n[0] *= e.scrollRatio.y, n[1] *= e.scrollRatio.x), i.dur = se() ? 0 : r, setTimeout(function () {
                    null !== n[0] && void 0 !== n[0] && "x" !== t.axis && e.overflowed[0] && (i.dir = "y", i.overwrite = "all", N(s, n[0].toString(), i)), null !== n[1] && void 0 !== n[1] && "y" !== t.axis && e.overflowed[1] && (i.dir = "x", i.overwrite = "none", N(s, n[1].toString(), i))
                }, i.timeout))
            })
        }, stop: function () {
            var e = c.call(this);
            ...
            return P(e).each(function () {
                var e = P(this);
                e.data(D) && (e.data(D), w.call(this, "remove"), f.call(this), t && h.call(this), v.call(this, !0), e.addClass(g[3]))
            })
        }, destroy: function () {
            var a = c.call(this);
            return P(a).each(function () {
                var e, t, i, n, r, s = P(this);
                s.data(D) && (t = (e = s.data(D)).opt, i = P("#mCSB_" + e.idx), n = P("#mCSB_" + e.idx + "_container"), r = P(".mCSB_" + e.idx + "_scrollbar"), t.live && d(t.liveSelector || P(a).selector), w.call(this, "remove"), f.call(this), h.call(this), s.removeData(D), x(this, "mcs"), r.remove(), n.find("img." + g[2]).removeClass(g[2]), i.replaceWith(n.contents()), s.removeClass(l + " _" + D + "_" + e.idx + " " + g[6] + " " + g[7] + " " + g[5] + " " + g[3]).addClass(g[4]))
            })
        }
    }, c = function () {
        ...
        var e = P(this), t = e.data(D), i = t.opt, n = i.autoExpandScrollbar ? " " + g[1] + "_expand" : "",
            ...
            a = i.autoHideScrollbar ? " " + g[6] : "", o = "x" !== i.axis && "rtl" === t.langDir ? " " + g[7] : "",
            a = (i.setWidth && e.css("width", i.setWidth), i.setHeight && e.css("height", i.setHeight), i.setLeft = "y" !== i.axis && "rtl" === t.langDir ? "989999px" : i.setLeft, e.addClass(l + " _" + D + "_" + t.idx + a + o).wrapInner("<div id='mCSB_" + t.idx + "' class='mCustomScrollBox mCS-" + i.theme + " " + r + "'><div id='mCSB_" + t.idx + "_container' class='mCSB_container' style='position:relative; top:" + i.setTop + "; left:" + i.setLeft + ";' dir='" + t.langDir + "' /></div>"), P("#mCSB_" + t.idx)),
            o = P("#mCSB_" + t.idx + "_container"),
            r = ("y" === i.axis || i.advanced.autoExpandHorizontalScroll || o.css("width", u(o)), "outside" === i.scrollbarPosition ? ("static" === e.css("position") && e.css("position", "relative"), e.css("overflow", "visible"), a.addClass("mCSB_outside").after(n)) : (a.addClass("mCSB_inside").append(n), o.wrap(s)), Y.call(this), [P("#mCSB_" + t.idx + "_dragger_vertical"), P("#mCSB_" + t.idx + "_dragger_horizontal")]);
        r[0].css("min-height", r[0].height()), r[1].css("min-width", r[1].width())
    }, u = function (e) {
        var t = [e[0].scrollWidth, Math.max.apply(Math, e.children().map(function () {
            return P(this).outerWidth(!0)
        }).get())], e = e.parent().width();
        ...
        i.advanced.autoExpandHorizontalScroll && "y" !== i.axis && (t.css({
            ...
            "min-width": 0,
            "overflow-x": "scroll"
        }), e = Math.ceil(t[0].scrollWidth), 3 === i.advanced.autoExpandHorizontalScroll || 2 !== i.advanced.autoExpandHorizontalScroll && e > t.parent().width() ? t.css({
            width: e,
            "min-width": "100%",
            "overflow-x": "inherit"
        }) : t.css({
        ...
        var e = P(this).data(D), t = e.opt, e = P(".mCSB_" + e.idx + "_scrollbar:first"),
        ...
        var e = P(this).data(D), t = P("#mCSB_" + e.idx), i = P("#mCSB_" + e.idx + "_container"),
        ...
        }).find(".mCSB_dragger_bar").css({"line-height": i[0] + "px"}), e[1].css({
            width: t,
        ...
        var i = i ? g[0] + "_expanded" : "", n = e.closest(".mCSB_scrollTools");
        "active" === t ? (e.toggleClass(g[0] + " " + i), n.toggleClass(g[1]), e[0]._draggable = e[0]._draggable ? 0 : 1) : e[0]._draggable || ("hide" === t ? (e.removeClass(g[0]), n.removeClass(g[1])) : (e.addClass(g[0]), n.addClass(g[1])))
    }, G = function () {
        var e = P(this).data(D), t = P("#mCSB_" + e.idx), i = P("#mCSB_" + e.idx + "_container"),
            n = null == e.overflowed ? i.height() : i.outerHeight(!1),
            e = null == e.overflowed ? i.width() : i.outerWidth(!1), r = i[0].scrollHeight, i = i[0].scrollWidth;
        return e < i && (e = i), [(n = n < r ? r : n) > t.height(), e > t.width()]
    }, h = function () {
        var e = P(this), t = e.data(D), i = t.opt, n = P("#mCSB_" + t.idx), r = P("#mCSB_" + t.idx + "_container"),
            s = [P("#mCSB_" + t.idx + "_dragger_vertical"), P("#mCSB_" + t.idx + "_dragger_horizontal")];
        F(e), ("x" !== i.axis && !t.overflowed[0] || "y" === i.axis && t.overflowed[0]) && (s[0].add(r).css("top", 0), N(e, "_resetY")), ("y" !== i.axis && !t.overflowed[1] || "x" === i.axis && t.overflowed[1]) && (i = dx = 0, "rtl" === t.langDir && (i = n.width() - r.outerWidth(!1), dx = Math.abs(i / t.scrollRatio.x)), r.css("left", i), s[1].css("left", dx), N(e, "_resetX"))
    }, V = function () {
        var t, i = P(this), e = i.data(D), n = e.opt;
        e.bindEvents || (U.call(this), n.contentTouchScroll && Q.call(this), K.call(this), n.mouseWheel.enable && function e() {
            t = setTimeout(function () {
                P.event.special.mousewheel ? (clearTimeout(t), Z.call(i[0])) : e()
            }, 100)
        }(), ee.call(this), ie.call(this), n.advanced.autoScrollOnFocus && te.call(this), n.scrollButtons.enable && ne.call(this), n.keyboard.enable && re.call(this), e.bindEvents = !0)
    }, f = function () {
        var e = P(this), t = e.data(D), i = t.opt, n = "mCS_" + t.idx, r = ".mCSB_" + t.idx + "_scrollbar",
        ...
        i.advanced.releaseDraggableSelectors && r.add(P(i.advanced.releaseDraggableSelectors)), i.advanced.extraDraggableSelectors && r.add(P(i.advanced.extraDraggableSelectors)), t.bindEvents && (P(document).add(P(!B() || top.document)).unbind("." + n), r.each(function () {
            P(this).unbind("." + n)
        }), clearTimeout(e[0]._focusTimeout), x(e[0], "_focusTimeout"), clearTimeout(t.sequential.step), x(t.sequential, "step"), clearTimeout(s[0].onCompleteTimeout), x(s[0], "onCompleteTimeout"), t.bindEvents = !1)
    }, v = function (e) {
        var t = P(this), i = t.data(D), n = i.opt, r = P("#mCSB_" + i.idx + "_container_wrapper"),
        ...
        function n(e, t, i, n) {
            var r;
            u[0].idleTimer = c.scrollInertia < 233 ? 250 : 0, t = s.attr("id") === d[1] ? (r = "x", (s[0].offsetLeft - t + n) * l.scrollRatio.x) : (r = "y", (s[0].offsetTop - e + i) * l.scrollRatio.y), N(o, t.toString(), {
                dir: r,
                drag: !0
            })
        }

        var s, r, a, o = P(this), l = o.data(D), c = l.opt, e = "mCS_" + l.idx,
            d = ["mCSB_" + l.idx + "_dragger_vertical", "mCSB_" + l.idx + "_dragger_horizontal"],
            u = P("#mCSB_" + l.idx + "_container"), t = P("#" + d[0] + ",#" + d[1]),
            i = c.advanced.releaseDraggableSelectors ? t.add(P(c.advanced.releaseDraggableSelectors)) : t,
            p = c.advanced.extraDraggableSelectors ? P(!B() || top.document).add(P(c.advanced.extraDraggableSelectors)) : P(!B() || top.document);
        t.bind("contextmenu." + e, function (e) {
            e.preventDefault()
        }).bind("mousedown." + e + " touchstart." + e + " pointerdown." + e + " MSPointerDown." + e, function (e) {
            var t, i, n;
            e.stopImmediatePropagation(), e.preventDefault(), T(e) && (R = !0, m && (document.onselectstart = function () {
                return !1
            }), y.call(u, !1), F(o), n = (s = P(this)).offset(), t = j(e)[0] - n.top, e = j(e)[1] - n.left, i = s.height() + n.top, n = s.width() + n.left, t < i && 0 < t && e < n && 0 < e && (r = t, a = e), S(s, "active", c.autoExpandScrollbar))
        }).bind("touchmove." + e, function (e) {
            e.stopImmediatePropagation(), e.preventDefault();
            var t = s.offset(), i = j(e)[0] - t.top, e = j(e)[1] - t.left;
            n(r, a, i, e)
        }), P(document).add(p).bind("mousemove." + e + " pointermove." + e + " MSPointerMove." + e, function (e) {
            var t, i;
            s && (t = s.offset(), i = j(e)[0] - t.top, e = j(e)[1] - t.left, r === i && a === e || n(r, a, i, e))
        }).add(i).bind("mouseup." + e + " touchend." + e + " pointerup." + e + " MSPointerUp." + e, function () {
            s && (S(s, "active", c.autoExpandScrollbar), s = null), R = !1, m && (document.onselectstart = null), y.call(u, !0)
        })
    }, Q = function () {
        function t(e) {
            ...
            var t = T.offset();
            l = j(e)[0] - t.top, c = j(e)[1] - t.left, I = [j(e)[0], j(e)[1]]
        }

        function i(e) {
            var t, i, n, r, s;
            W(e) && !R && !j(e)[2] && (w.documentTouchScroll || e.preventDefault(), e.stopImmediatePropagation(), !y || v) && o && (h = H(), i = x.offset(), t = j(e)[0] - i.top, i = j(e)[1] - i.left, n = "mcsLinearOut", E.push(t), C.push(i), I[2] = Math.abs(j(e)[0] - I[0]), I[3] = Math.abs(j(e)[1] - I[1]), _.overflowed[0] && (r = S[0].parent().height() - S[0].height(), r = 0 < l - t && t - l > -(r * _.scrollRatio.y) && (2 * I[3] < I[2] || "yx" === w.axis)), _.overflowed[1] && (s = S[1].parent().width() - S[1].width(), s = 0 < c - i && i - c > -(s * _.scrollRatio.x) && (2 * I[2] < I[3] || "yx" === w.axis)), r || s ? (L || e.preventDefault(), v = 1) : (y = 1, b.addClass("mCS_touch_action")), L && e.preventDefault(), m = "yx" === w.axis ? [l - t, c - i] : "x" === w.axis ? [null, c - i] : [l - t, null], T[0].idleTimer = 250, _.overflowed[0] && a(m[0], M, n, "y", "all", !0), _.overflowed[1]) && a(m[1], M, n, "x", k, !0)
        }
        ...
        function r(e) {
            var t, i, n, r;
            !W(e) || R || j(e)[2] || (o = 0, e.stopImmediatePropagation(), y = v = 0, f = H(), t = x.offset(), r = j(e)[0] - t.top, e = j(e)[1] - t.left, 30 < f - h) || (t = "mcsEaseOut", n = (i = (f = 1e3 / (f - p)) < 2.5) ? [E[E.length - 2], C[C.length - 2]] : [0, 0], g = i ? [r - n[0], e - n[1]] : [r - d, e - u], n = [Math.abs(g[0]), Math.abs(g[1])], f = i ? [Math.abs(g[0] / 4), Math.abs(g[1] / 4)] : [f, f], r = [Math.abs(T[0].offsetTop) - g[0] * s(n[0] / f[0], f[0]), Math.abs(T[0].offsetLeft) - g[1] * s(n[1] / f[1], f[1])], m = "yx" === w.axis ? [r[0], r[1]] : "x" === w.axis ? [null, r[1]] : [r[0], null], g = [4 * n[0] + w.scrollInertia, 4 * n[1] + w.scrollInertia], e = parseInt(w.contentTouchScroll) || 0, m[0] = e < n[0] ? m[0] : 0, m[1] = e < n[1] ? m[1] : 0, _.overflowed[0] && a(m[0], g[0], t, "y", k, !1), _.overflowed[1] && a(m[1], g[1], t, "x", k, !1))
        }
        ...
        function a(e, t, i, n, r, s) {
            e && N(b, e.toString(), {dur: t, scrollEasing: i, dir: n, overwrite: r, drag: s})
        }

        var o, l, c, d, u, p, h, f, m, g, v, y, b = P(this), _ = b.data(D), w = _.opt, e = "mCS_" + _.idx,
            x = P("#mCSB_" + _.idx), T = P("#mCSB_" + _.idx + "_container"),
            S = [P("#mCSB_" + _.idx + "_dragger_vertical"), P("#mCSB_" + _.idx + "_dragger_horizontal")], E = [],
            C = [], M = 0, k = "yx" === w.axis ? "none" : "all", I = [], A = T.find("iframe"),
        ...
        function i(e, t) {
            var i, n, r, s, a, o, l, c;
            F(d), J(d, e.target) || (c = "auto" !== p.mouseWheel.deltaFactor ? parseInt(p.mouseWheel.deltaFactor) : !(m && e.deltaFactor < 100) && e.deltaFactor || 100, i = p.scrollInertia, c = "x" === p.axis || "x" === p.mouseWheel.axis ? (n = "x", r = [Math.round(c * u.scrollRatio.x), parseInt(p.mouseWheel.scrollAmount)], s = "auto" !== p.mouseWheel.scrollAmount ? r[1] : r[0] >= h.width() ? .9 * h.width() : r[0], a = Math.abs(P("#mCSB_" + u.idx + "_container")[0].offsetLeft), o = f[1][0].offsetLeft, l = f[1].parent().width() - f[1].width(), "y" === p.mouseWheel.axis ? e.deltaY || t : e.deltaX) : (n = "y", r = [Math.round(c * u.scrollRatio.y), parseInt(p.mouseWheel.scrollAmount)], s = "auto" !== p.mouseWheel.scrollAmount ? r[1] : r[0] >= h.height() ? .9 * h.height() : r[0], a = Math.abs(P("#mCSB_" + u.idx + "_container")[0].offsetTop), o = f[0][0].offsetTop, l = f[0].parent().height() - f[0].height(), e.deltaY || t), "y" === n && !u.overflowed[0]) || "x" === n && !u.overflowed[1] || ((p.mouseWheel.invert || e.webkitDirectionInvertedFromDevice) && (c = -c), (0 < (c = p.mouseWheel.normalizeDelta ? c < 0 ? -1 : 1 : c) && 0 !== o || c < 0 && o !== l || p.mouseWheel.preventDefault) && (e.stopImmediatePropagation(), e.preventDefault()), e.deltaFactor < 5 && !p.mouseWheel.normalizeDelta && (s = e.deltaFactor, i = 17), N(d, (a - c * s).toString(), {
                dir: n,
                dur: i
            }))
        }
        ...
        var d, u, p, e, h, f, t;
        P(this).data(D) && (d = P(this), u = d.data(D), p = u.opt, e = "mCS_" + u.idx, h = P("#mCSB_" + u.idx), f = [P("#mCSB_" + u.idx + "_dragger_vertical"), P("#mCSB_" + u.idx + "_dragger_horizontal")], (t = P("#mCSB_" + u.idx + "_container").find("iframe")).length && t.each(function () {
            P(this).bind("load", function () {
    ...
    }, a = new Object, B = function (e) {
        var t = !1, i = !1, n = null;
        if (void 0 === e ? i = "#empty" : void 0 !== P(e).attr("id") && (i = P(e).attr("id")), !1 !== i && void 0 !== a[i]) return a[i];
        if (e) try {
        ...
        var i = t.nodeName.toLowerCase(), e = e.data(D).opt.mouseWheel.disableOver;
        ...
        P(".mCSB_" + l.idx + "_scrollbar ." + g[12]).bind("mousedown." + e + " touchstart." + e + " pointerdown." + e + " MSPointerDown." + e, function (e) {
            ...
            if (a && (a = 0, P(e.target).hasClass(g[12]) || P(e.target).hasClass("mCSB_draggerRail"))) {
                F(o);
                var t = P(this), i = t.find(".mCSB_dragger");
                if (0 < t.parent(".mCSB_scrollTools_horizontal").length) {
                    if (!l.overflowed[1]) return;
                    var n = "x", r = e.pageX > i.offset().left ? -1 : 1,
                        s = Math.abs(c[0].offsetLeft) - r * (.9 * d.width())
                } else {
                    if (!l.overflowed[0]) return;
                    n = "y", r = e.pageY > i.offset().top ? -1 : 1, s = Math.abs(c[0].offsetTop) - r * (.9 * d.height())
                }
                N(o, s.toString(), {dir: n, scrollEasing: "mcsEaseInOut"})
            }
        })
    }, te = function () {
        var r = P(this), e = r.data(D), s = e.opt, t = "mCS_" + e.idx, a = P("#mCSB_" + e.idx + "_container"),
            o = a.parent();
        a.bind("focusin." + t, function () {
            var n = P(document.activeElement), e = a.find(".mCustomScrollBox").length;
            n.is(s.advanced.autoScrollOnFocus) && (F(r), clearTimeout(r[0]._focusTimeout), r[0]._focusTimer = e ? 17 * e : 0, r[0]._focusTimeout = setTimeout(function () {
                var e = [k(n)[0], k(n)[1]], t = [a[0].offsetTop, a[0].offsetLeft],
        ...
        var n = P(this), r = n.data(D), s = r.opt, a = r.sequential, e = "mCS_" + r.idx,
        ...
        P(t + ">a").bind("contextmenu." + e, function (e) {
            ...
            if (e.preventDefault(), T(e)) {
                ...
                switch (a.type = s.scrollButtons.scrollType, e.type) {
                    ...
                    case"pointerdown":
                    case"MSPointerDown":
                        "stepped" !== a.type && (R = !0, r.tweenRunning = !1, t("on", i));
                        break;
                    case"mouseup":
                    case"touchend":
                    case"pointerup":
        ...
        function t(e) {
            function t(e, t) {
                c.type = l.keyboard.scrollType, c.scrollAmount = l.keyboard.scrollAmount, "stepped" === c.type && o.tweenRunning || b(a, e, t)
            }
            ...
            switch (e.type) {
                ...
                case"keyup":
                    ...
                    "x" !== l.axis && (38 === r || 40 === r) || "y" !== l.axis && (37 === r || 39 === r) ? (38 !== r && 40 !== r || o.overflowed[0]) && (37 !== r && 39 !== r || o.overflowed[1]) && ("keyup" === e.type && (s = "off"), P(document.activeElement).is(p) || (e.preventDefault(), e.stopImmediatePropagation(), t(s, r))) : 33 === r || 34 === r ? ((o.overflowed[0] || o.overflowed[1]) && (e.preventDefault(), e.stopImmediatePropagation()), "keyup" === e.type && (F(a), s = 34 === r ? -1 : 1, n = "x" === l.axis || "yx" === l.axis && o.overflowed[1] && !o.overflowed[0] ? (i = "x", Math.abs(d[0].offsetLeft) - s * (.9 * u.width())) : (i = "y", Math.abs(d[0].offsetTop) - s * (.9 * u.height())), N(a, n.toString(), {
                        dir: i,
                        scrollEasing: "mcsEaseInOut"
                    }))) : 35 !== r && 36 !== r || P(document.activeElement).is(p) || ((o.overflowed[0] || o.overflowed[1]) && (e.preventDefault(), e.stopImmediatePropagation()), "keyup" !== e.type) || (n = "x" === l.axis || "yx" === l.axis && o.overflowed[1] && !o.overflowed[0] ? (i = "x", 35 === r ? Math.abs(u.width() - d.outerWidth(!1)) : 0) : (i = "y", 35 === r ? Math.abs(u.height() - d.outerHeight(!1)) : 0), N(a, n.toString(), {
                        dir: i,
                        scrollEasing: "mcsEaseInOut"
                    }))
            }
        ...
        var a = P(this), o = a.data(D), l = o.opt, c = o.sequential, e = "mCS_" + o.idx, i = P("#mCSB_" + o.idx),
            d = P("#mCSB_" + o.idx + "_container"), u = d.parent(),
            p = "input,textarea,select,datalist,keygen,[contenteditable='true']", n = d.find("iframe"),
        ...
        function c(e) {
            ...
            var t = "stepped" !== p.type, i = l || (e ? t ? f / 1.5 : m : 1e3 / 60), n = e ? t ? 7.5 : 40 : 2.5,
                ...
                n = "auto" !== p.scrollAmount ? n : s, s = o || (e ? t ? "mcsLinearOut" : "mcsEaseInOut" : "mcsLinear"),
                t = !!e;
            e && i < 17 && (n = "x" === p.dir[0] ? r[1] : r[0]), N(a, n.toString(), {
                dir: p.dir[0],
                scrollEasing: s,
                dur: i,
                onComplete: t
        ...
        var d = a.data(D), u = d.opt, p = d.sequential, h = P("#mCSB_" + d.idx + "_container"),
            i = "stepped" === p.type, f = u.scrollInertia < 26 ? 26 : u.scrollInertia,
            m = u.scrollInertia < 1 ? 17 : u.scrollInertia;
        switch (e) {
            case"on":
                p.dir = [t === g[16] || t === g[15] || 39 === t || 37 === t ? "x" : "y", t === g[13] || t === g[15] || 38 === t || 37 === t ? -1 : 1], F(a), M(t) && "stepped" === p.type || c(i);
                break;
            case"off":
                clearTimeout(p.step), x(p, "step"), F(a), (i || d.tweenRunning && p.dir) && c(!0)
        }
    }, E = function (e) {
        var t = P(this).data(D).opt, i = [];
        return (e = "function" == typeof e ? e() : e) instanceof Array ? i = 1 < e.length ? [e[0], e[1]] : "x" === t.axis ? [null, e[0]] : [e[0], null] : (i[0] = e.y || (e.x || "x" === t.axis ? null : e), i[1] = e.x || (e.y || "y" === t.axis ? null : e)), "function" == typeof i[0] && (i[0] = i[0]()), "function" == typeof i[1] && (i[1] = i[1]()), i
    }, _ = function (e, t) {
        if (null != e && void 0 !== e) {
            var i, n, r = P(this), s = r.data(D), a = s.opt, o = P("#mCSB_" + s.idx + "_container"), l = o.parent(),
                s = typeof e,
                c = "x" === (t = t || ("x" === a.axis ? "x" : "y")) ? o.outerWidth(!1) - l.width() : o.outerHeight(!1) - l.height(),
                d = "x" === t ? o[0].offsetLeft : o[0].offsetTop, u = "x" === t ? "left" : "top";
            switch (s) {
                case"function":
                    return e();
                case"object":
        ...
        var r = P(this), s = r.data(D), a = s.opt, o = P("#mCSB_" + s.idx + "_container");
        return e ? (clearTimeout(o[0].autoUpdate), void x(o[0], "autoUpdate")) : void function i() {
            return clearTimeout(o[0].autoUpdate), 0 === r.parents("html").length ? void (r = null) : void (o[0].autoUpdate = setTimeout(function () {
                return a.advanced.updateOnSelectorChange && (s.poll.change.n = (!0 === a.advanced.updateOnSelectorChange && (a.advanced.updateOnSelectorChange = "*"), e = 0, t = o.find(a.advanced.updateOnSelectorChange), a.advanced.updateOnSelectorChange && 0 < t.length && t.each(function () {
                    e += this.offsetHeight + this.offsetWidth
                }), e), s.poll.change.n !== s.poll.change.o) ? (s.poll.change.o = s.poll.change.n, void n(3)) : a.advanced.updateOnContentResize && (s.poll.size.n = r[0].scrollHeight + r[0].scrollWidth + o[0].offsetHeight + r[0].offsetHeight + r[0].offsetWidth, s.poll.size.n !== s.poll.size.o) ? (s.poll.size.o = s.poll.size.n, void n(1)) : !a.advanced.updateOnImageLoad || "auto" === a.advanced.updateOnImageLoad && "y" === a.axis || (s.poll.img.n = o.find("img").length, s.poll.img.n === s.poll.img.o) ? void ((a.advanced.updateOnSelectorChange || a.advanced.updateOnContentResize || a.advanced.updateOnImageLoad) && i()) : (s.poll.img.o = s.poll.img.n, void o.find("img").each(function () {
                    var e, t;
                    P(e = this).hasClass(g[2]) ? n() : ((t = new Image).onload = function (e, t) {
                        ...
                        this.onload = null, P(e).addClass(g[2]), n(2)
                    }), t.src = e.src)
                }));
                var e, t
        ...
        function i() {
            var e = [u[0].offsetTop, u[0].offsetLeft], t = [m[0].offsetTop, m[0].offsetLeft],
                i = [u.outerHeight(!1), u.outerWidth(!1)], n = [d.height(), d.width()];
            r[0].mcs = {
                content: u,
                top: e[0],
                left: e[1],
        ...
        var n, a, o = r.data(D), l = o.opt, c = {
                ...
                onUpdate: !0,
                onComplete: !0
            }, c = [(s = P.extend(c, s)).dur, s.drag ? 0 : s.dur], d = P("#mCSB_" + o.idx),
            u = P("#mCSB_" + o.idx + "_container"), p = u.parent(),
            h = l.callbacks.onTotalScrollOffset ? E.call(r, l.callbacks.onTotalScrollOffset) : [0, 0],
            f = l.callbacks.onTotalScrollBackOffset ? E.call(r, l.callbacks.onTotalScrollBackOffset) : [0, 0];
        if (o.trigger = s.trigger, 0 === p.scrollTop() && 0 === p.scrollLeft() || (P(".mCSB_" + o.idx + "_scrollbar").css("visibility", "visible"), p.scrollTop(0).scrollLeft(0)), "_resetY" !== e || o.contentReset.y || (t("onOverflowYNone") && l.callbacks.onOverflowYNone.call(r[0]), o.contentReset.y = 1), "_resetX" !== e || o.contentReset.x || (t("onOverflowXNone") && l.callbacks.onOverflowXNone.call(r[0]), o.contentReset.x = 1), "_resetY" !== e && "_resetX" !== e) {
            switch (!o.contentReset.y && r[0].mcs || !o.overflowed[0] || (t("onOverflowY") && l.callbacks.onOverflowY.call(r[0]), o.contentReset.x = null), !o.contentReset.x && r[0].mcs || !o.overflowed[1] || (t("onOverflowX") && l.callbacks.onOverflowX.call(r[0]), o.contentReset.x = null), l.snapAmount && (p = l.snapAmount instanceof Array ? "x" === s.dir ? l.snapAmount[1] : l.snapAmount[0] : l.snapAmount, n = e, p = p, a = l.snapOffset, e = Math.round(n / p) * p - a), s.dir) {
                case"x":
                    var m = P("#mCSB_" + o.idx + "_dragger_horizontal"), g = "left", v = u[0].offsetLeft,
                        y = [d.width() - u.outerWidth(!1), m.parent().width() - m.width()],
                        b = [e, 0 === e ? 0 : e / o.scrollRatio.x], _ = h[1], w = f[1],
                        x = 0 < _ ? _ / o.scrollRatio.x : 0, T = 0 < w ? w / o.scrollRatio.x : 0;
                    break;
                case"y":
                    m = P("#mCSB_" + o.idx + "_dragger_vertical"), g = "top", v = u[0].offsetTop, y = [d.height() - u.outerHeight(!1), m.parent().height() - m.height()], b = [e, 0 === e ? 0 : e / o.scrollRatio.y], _ = h[0], w = f[0], x = 0 < _ ? _ / o.scrollRatio.y : 0, T = 0 < w ? w / o.scrollRatio.y : 0
            }
            b[1] < 0 || 0 === b[0] && 0 === b[1] ? b = [0, 0] : b[1] >= y[1] ? b = [y[0], y[1]] : b[0] = -b[0], r[0].mcs || (i(), t("onInit") && l.callbacks.onInit.call(r[0])), clearTimeout(u[0].onCompleteTimeout), C(m[0], g, Math.round(b[1]), c[1], s.scrollEasing), !o.tweenRunning && (0 === v && 0 <= b[0] || v === y[0] && b[0] <= y[0]) || C(u[0], g, Math.round(b[0]), c[0], s.scrollEasing, s.overwrite, {
                onStart: function () {
                    s.callbacks && s.onStart && !o.tweenRunning && (t("onScrollStart") && (i(), l.callbacks.onScrollStart.call(r[0])), o.tweenRunning = !0, S(m), o.cbOffsets = [l.callbacks.alwaysTriggerOffsets || v >= y[0] + _, l.callbacks.alwaysTriggerOffsets || v <= -w])
                }, onUpdate: function () {
                    s.callbacks && s.onUpdate && t("whileScrolling") && (i(), l.callbacks.whileScrolling.call(r[0]))
                }, onComplete: function () {
                    var e;
                    s.callbacks && s.onComplete && ("yx" === l.axis && clearTimeout(u[0].onCompleteTimeout), e = u[0].idleTimer || 0, u[0].onCompleteTimeout = setTimeout(function () {
                        t("onScroll") && (i(), l.callbacks.onScroll.call(r[0])), t("onTotalScroll") && b[1] >= y[1] - x && o.cbOffsets[0] && (i(), l.callbacks.onTotalScroll.call(r[0])), t("onTotalScrollBack") && b[1] <= T && o.cbOffsets[1] && (i(), l.callbacks.onTotalScrollBack.call(r[0])), o.tweenRunning = !1, u[0].idleTimer = 0, S(m, "hide")
                    }, e))
                }
            })
        }
        ...
        function o() {
            y.stop || (m || u.call(), m = H() - f, l(), m >= y.time && (y.time = m > y.time ? m + c - (m - y.time) : m + c - 1, y.time < m + 1) && (y.time = m + 1), y.time < n ? y.id = d(o) : h.call())
        }
        ...
        function l() {
            ...
            }(y.time, g, b, n, r), v[t] = Math.round(y.currVal) + "px") : v[t] = i + "px", p.call()
        }
        ...
        var c, d, u = (a = a || {}).onStart || function () {
            ...
            }, f = H(), m = 0, g = e.offsetTop, v = e.style, y = e._mTween[t],
            b = ("left" === t && (g = e.offsetLeft), i - g);
        y.stop = 0, "none" !== s && null != y.id && (window.requestAnimationFrame ? window.cancelAnimationFrame(y.id) : clearTimeout(y.id), y.id = null), c = 1e3 / 60, y.time = m + c, d = window.requestAnimationFrame || function (e) {
        ...
        return p[e] ? p[e].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof e && e ? void P.error("Method " + e + " does not exist") : p.init.apply(this, arguments)
    }, P[l].defaults = r, window[l] = !0, P(window).bind("load", function () {
        P(n)[l](), P.extend(P.expr[":"], {
            mcsInView: P.expr[":"].mcsInView || function (e) {
                var t, e = P(e), i = e.parents(".mCSB_container");
                if (i.length) return t = i.parent(), 0 <= (i = [i[0].offsetTop, i[0].offsetLeft])[0] + k(e)[0] && i[0] + k(e)[0] < t.height() - e.outerHeight(!1) && 0 <= i[1] + k(e)[1] && i[1] + k(e)[1] < t.width() - e.outerWidth(!1)
            }, mcsInSight: P.expr[":"].mcsInSight || function (e, t, i) {
                var n, e = P(e), r = e.parents(".mCSB_container"),
                    i = "exact" === i[3] ? [[1, 0], [1, 0]] : [[.9, .1], [.6, .4]];
                if (r.length) return n = [e.outerHeight(!1), e.outerWidth(!1)], e = [r[0].offsetTop + k(e)[0], r[0].offsetLeft + k(e)[1]], r = [r.parent()[0].offsetHeight, r.parent()[0].offsetWidth], e[0] - r[0] * (i = [n[0] < r[0] ? i[0] : i[1], n[1] < r[1] ? i[0] : i[1]])[0][0] < 0 && 0 <= e[0] + n[0] - r[0] * i[0][1] && e[1] - r[1] * i[1][0] < 0 && 0 <= e[1] + n[1] - r[1] * i[1][1]
...
!*/
    function (i) {
        ...
        r.prototype.getSuffix = function (e, t) {
            for (var i = t < e ? e : t, n = 0; n < this.suffixRanges.length; n++) if (i <= this.suffixRanges[n]) return this.settings.sizeRangeSuffixes[this.suffixRanges[n]];
            ...
            for (var t in this.settings.sizeRangeSuffixes) if (this.settings.sizeRangeSuffixes.hasOwnProperty(t) && 0 !== this.settings.sizeRangeSuffixes[t].length && this.endsWith(e, this.settings.sizeRangeSuffixes[t])) return this.settings.sizeRangeSuffixes[t];
            return ""
        }, r.prototype.newSrc = function (e, t, i, n) {
            var r;
            return this.settings.thumbnailPath ? r = this.settings.thumbnailPath(e, t, i, n) : (n = null !== (n = e.match(this.settings.extension)) ? n[0] : "", r = e.replace(this.settings.extension, ""), r = this.removeSuffix(r, this.getUsedSuffix(r)), r += this.getSuffix(t, i) + n), r
        }, r.prototype.showImg = function (e, t) {
            this.settings.cssAnimation ? (e.addClass("jg-entry-visible"), t && t()) : (e.stop().fadeTo(this.settings.imagesAnimationDuration, 1, t), e.find(this.settings.imgSelector).stop().fadeTo(this.settings.imagesAnimationDuration, 1, t))
        }, r.prototype.extractImgSrcFromImage = function (e) {
            var t = e.data("safe-src"), i = "data-safe-src";
            return void 0 === t && (t = e.attr("src"), i = "src"), e.data("jg.originalSrc", t), e.data("jg.src", t), e.data("jg.originalSrcLoc", i), t
            ...
            var i, n, r, s, a = !0, o = 0,
                ...
                c = l / this.buildingRow.aspectRatio, d = this.settings.rowHeight,
            ...
            for (e && !u && "justify" !== this.settings.lastRow && "hide" !== this.settings.lastRow && (a = !1, 0 < this.rows) && (a = (d = (this.offY - this.border - this.settings.margins * this.rows) / this.rows) * this.buildingRow.aspectRatio / l > this.settings.justifyThreshold), i = 0; i < this.buildingRow.entriesBuff.length; i++) s = (n = this.buildingRow.entriesBuff[i]).data("jg.width") / n.data("jg.height"), s = a ? (r = i === this.buildingRow.entriesBuff.length - 1 ? l : c * s, c) : (r = d * s, d), l -= Math.round(r), n.data("jg.jwidth", Math.round(r)), n.data("jg.jheight", Math.ceil(s)), (0 === i || s < o) && (o = s);
            ...
            if (t || e && "hide" === n.lastRow && -1 === s) this.clearBuildingRow(); else {
                if (this.maxRowHeight && this.maxRowHeight < this.buildingRow.height && (this.buildingRow.height = this.maxRowHeight), e && ("center" === n.lastRow || "right" === n.lastRow)) {
                    for (var a = this.galleryWidth - 2 * this.border - (this.buildingRow.entriesBuff.length - 1) * n.margins, o = 0; o < this.buildingRow.entriesBuff.length; o++) a -= (i = this.buildingRow.entriesBuff[o]).data("jg.jwidth");
                    "center" === n.lastRow ? r += Math.round(a / 2) : "right" === n.lastRow && (r += a)
                }
                var l = this.buildingRow.entriesBuff.length - 1;
                for (o = 0; o <= l; o++) i = this.buildingRow.entriesBuff[this.settings.rtl ? l - o : o], this.displayEntry(i, r, this.offY, i.data("jg.jwidth"), i.data("jg.jheight"), this.buildingRow.height), r += i.data("jg.jwidth") + n.margins;
                this.galleryHeightToSet = this.offY + this.buildingRow.height + this.border, this.setGalleryTempHeight(this.galleryHeightToSet + this.getSpinnerHeight()), (!e || this.buildingRow.height <= n.rowHeight && s) && (this.offY += this.buildingRow.height + n.margins, this.rows += 1, this.clearBuildingRow(), this.settings.triggerEvent.call(this, "jg.rowflush"))
            }
        };
        var t = 0;
        r.prototype.rememberGalleryHeight = function () {
            ...
            this.checkWidthIntervalId = setInterval(c.proxy(function () {
                var e;
                this.$gallery.is(":visible") && (e = parseFloat(this.$gallery.width()), Math.abs(e - this.galleryWidth) > this.settings.refreshSensitivity) && (this.galleryWidth = e, this.rewind(), this.rememberGalleryHeight(), this.startImgAnalyzer(!0))
            ...
            return 0 < (e = e && null != this.lastFetchedEntry ? (e = this.getSelectorWithoutSpinner(), c(this.lastFetchedEntry).nextAll(e).toArray()) : (this.entries = [], this.getAllEntries())).length && (c.isFunction(this.settings.sort) ? e = this.sortArray(e) : this.settings.randomize && (e = this.shuffleArray(e)), this.lastFetchedEntry = e[e.length - 1], this.settings.filter ? e = this.filterArray(e) : this.resetFilters(e)), this.entries = this.entries.concat(e), !0
            ...
            for (var t, i, n = e.length - 1; 0 < n; n--) t = Math.floor(Math.random() * (n + 1)), i = e[n], e[n] = e[t], e[t] = i;
            ...
            var t = this.settings;
            if ("string" === c.type(t.filter)) return e.filter(function (e) {
                e = c(e);
                return e.is(t.filter) ? (e.removeClass("jg-filtered"), !0) : (e.addClass("jg-filtered").removeClass("jg-visible"), !1)
            });
            if (c.isFunction(t.filter)) {
                for (var i = e.filter(t.filter), n = 0; n < e.length; n++) -1 === i.indexOf(e[n]) ? c(e[n]).addClass("jg-filtered").removeClass("jg-visible") : c(e[n]).removeClass("jg-filtered");
                return i
            }
        }, r.prototype.resetImgSrc = function (e) {
            "src" === e.data("jg.originalSrcLoc") ? e.attr("src", e.data("jg.originalSrc")) : e.attr("src", "")
        }, r.prototype.destroy = function () {
            clearInterval(this.checkWidthIntervalId), this.stopImgAnalyzerStarter(), c.each(this.getAllEntries(), c.proxy(function (e, t) {
                var t = c(t),
                    i = (t.css("width", ""), t.css("height", ""), t.css("top", ""), t.css("left", ""), t.data("jg.loaded", void 0), t.removeClass("jg-entry jg-filtered jg-entry-visible"), this.imgFromEntry(t)),
                    i = (i && (i.css("width", ""), i.css("height", ""), i.css("margin-left", ""), i.css("margin-top", ""), this.resetImgSrc(i), i.data("jg.originalSrc", void 0), i.data("jg.originalSrcLoc", void 0), i.data("jg.src", void 0)), this.removeCaptionEventsHandlers(t), this.captionFromEntry(t));
                t.data("jg.createdCaption") ? (t.data("jg.createdCaption", void 0), null !== i && i.remove()) : null !== i && i.fadeTo(0, 1)
            ...
            for (var t = this.lastAnalyzedIndex + 1; t < this.entries.length; t++) {
                ...
                if (!0 === i.data("jg.loaded") || "skipped" === i.data("jg.loaded")) {
                    ...
                    if (this.buildingRow.entriesBuff.push(i), this.buildingRow.aspectRatio += r, this.buildingRow.width += r * this.settings.rowHeight, this.lastAnalyzedIndex = t, n / (this.buildingRow.aspectRatio + r) < this.settings.rowHeight && (this.flushRow(!1, 0 < this.settings.maxRowsCount && this.rows === this.settings.maxRowsCount), ++this.yield.flushed >= this.yield.every)) return void this.startImgAnalyzer(e)
            ...
            var n, r;
            (t || i) && (n = new Image, r = c(n), t && r.one("load", function () {
            ...
            c.each(this.entries, function (e, t) {
                var i = c(t), t = l.imgFromEntry(i);
                if (i.addClass("jg-entry"), !0 !== i.data("jg.loaded") && "skipped" !== i.data("jg.loaded")) if (null !== l.settings.rel && i.attr("rel", l.settings.rel), null !== l.settings.target && i.attr("target", l.settings.target), null !== t) {
                    var n = l.extractImgSrcFromImage(t);
                    if (!1 === l.settings.waitThumbnailsLoad || !n) {
                        var r = parseFloat(t.attr("width")), s = parseFloat(t.attr("height"));
                        if ("svg" === t.prop("tagName") && (r = parseFloat(t[0].getBBox().width), s = parseFloat(t[0].getBBox().height)), !isNaN(r) && !isNaN(s)) return i.data("jg.width", r), i.data("jg.height", s), i.data("jg.loaded", "skipped"), o = !0, l.startImgAnalyzer(!1), !0
                    }
                    i.data("jg.loaded", !1), a = !0, l.isSpinnerActive() || l.startLoadingSpinnerAnimation(), l.onImageEvent(n, function (e) {
                        i.data("jg.width", e.width), i.data("jg.height", e.height), i.data("jg.loaded", !0), l.startImgAnalyzer(!1)
                    }, function () {
            ...
            }), a || o || this.startImgAnalyzer(!1), this.checkWidth()
            ...
            var e, t = [];
            for (e in this.settings.sizeRangeSuffixes) this.settings.sizeRangeSuffixes.hasOwnProperty(e) && t.push(e);
            for (var i = {0: ""}, n = 0; n < t.length; n++) if ("string" === c.type(t[n])) try {
            ...
            var e = null, t = this.settings.rowHeight;
            if ("string" === c.type(this.settings.maxRowHeight)) e = this.settings.maxRowHeight.match(/^[0-9]+%$/) ? t * parseFloat(this.settings.maxRowHeight.match(/^([0-9]+)%$/)[1]) / 100 : parseFloat(this.settings.maxRowHeight); else {
            ...
            var e, t = [];
            for (e in this.settings.sizeRangeSuffixes) this.settings.sizeRangeSuffixes.hasOwnProperty(e) && t.push(parseInt(e, 10));
            ...
            return this.each(function (e, t) {
                var t = c(t), i = (t.addClass("justified-gallery"), t.data("jg.controller"));
                if (void 0 === i) {
                    if (null != n && "object" !== c.type(n)) {
                        if ("destroy" === n) return;
                        throw "The argument must be an object"
                    }
                    i = new r(t, c.extend({}, r.prototype.defaults, n)), t.data("jg.controller", i)
                } else if ("norewind" !== n) {
...
/*!
    Google Map Style
!*/
const Retro = [{elementType: "geometry", stylers: [{color: "#ebe3cd"}]}, {
    ...
    }, {featureType: "water", elementType: "labels.text.fill", stylers: [{color: "#92998d"}]}], Standard = [],
    Silver = [{elementType: "geometry", stylers: [{color: "#f5f5f5"}]}, {
        elementType: "labels.icon",
        stylers: [{visibility: "off"}]
    ...
    Dark = [{elementType: "geometry", stylers: [{color: "#212121"}]}, {
        elementType: "labels.icon",
        stylers: [{visibility: "off"}]
    ...
    Aubergine = [{elementType: "geometry", stylers: [{color: "#1d2c4d"}]}, {
        elementType: "labels.text.fill",
...
!function (o) {
    ...
    l.resize(function () {
        ...
        a.each(function (e) {
            a.offset().top
        }), (arguments.length < 1 || null === n) && (n = "50%"), (arguments.length < 2 || null === r) && (r = .5), (arguments.length < 3 || null === e) && (e = !0), (arguments.length < 4 || null === pos) && (pos = 0), s = e ? function (e) {
            return e.outerHeight(!0)
        } : function (e) {
            return e.height()
        }, l.bind("scroll", t).resize(t), t()
        ...
        (arguments.length < 1 || null === n) && (n = 1), r = (e = arguments.length < 2 || null === e ? !0 : e) ? function (e) {
            return e.outerHeight(!0)
        } : function (e) {
            return e.height()
        }, l.bind("scroll", t).resize(t), t()
    ...
    i.resize(function () {
        ...
        function t() {
            var n = i.scrollTop();
            c.each(function () {
                var e = h(this), t = e.offset().top, i = t + e.outerHeight();
                p = u < n ? "forward" : "reverse", u = n, t < h(window).height() + n && n < i && ("forward" == p ? s += a : s -= a), o ? e.attr("data-parallax-scale") ? t + l(e) < n || n + f < t || (1050 < h(window).width() ? anime({
                    targets: c[0],
        ...
        (arguments.length < 1 || null === r) && (r = 1), l = (e = arguments.length < 2 || null === e ? !0 : e) ? function (e) {
            return e.outerHeight(!0)
        } : function (e) {
            return e.height()
        }, i.bind("scroll", t).resize(t), t()
    }
}(jQuery);
/*!
    Particles
...
var pJS = function (e, t) {
    var i = document.querySelector("#" + e + " > .particles-js-canvas-el"), u = (this.pJS = {
    ...
    t && Object.deepExtend(u, t), u.tmp.obj = {
        ...
        this.radius = (u.particles.size.random ? Math.random() : 1) * u.particles.size.value, u.particles.size.anim.enable && (this.size_status = !1, this.vs = u.particles.size.anim.speed / 100, u.particles.size.anim.sync || (this.vs = this.vs * Math.random())), this.x = i ? i.x : Math.random() * u.canvas.w, this.y = i ? i.y : Math.random() * u.canvas.h, this.x > u.canvas.w - 2 * this.radius ? this.x = this.x - this.radius : this.x < 2 * this.radius && (this.x = this.x + this.radius), this.y > u.canvas.h - 2 * this.radius ? this.y = this.y - this.radius : this.y < 2 * this.radius && (this.y = this.y + this.radius), u.particles.move.bounce && u.fn.vendors.checkOverlap(this, i), this.color = {}, "object" == typeof e.value ? e.value instanceof Array ? (i = e.value[Math.floor(Math.random() * u.particles.color.value.length)], this.color.rgb = hexToRgb(i)) : (null != e.value.r && null != e.value.g && null != e.value.b && (this.color.rgb = {
            r: e.value.r,
            g: e.value.g,
            b: e.value.b
        ...
        } : "string" == typeof e.value && (this.color = e, this.color.rgb = hexToRgb(this.color.value)), this.opacity = (u.particles.opacity.random ? Math.random() : 1) * u.particles.opacity.value, u.particles.opacity.anim.enable && (this.opacity_status = !1, this.vo = u.particles.opacity.anim.speed / 100, u.particles.opacity.anim.sync || (this.vo = this.vo * Math.random()));
        var n = {};
        ...
        "object" == typeof i ? i instanceof Array && (e = i[Math.floor(Math.random() * i.length)], this.shape = e) : this.shape = i, "image" == this.shape && (e = u.particles.shape, this.img = {
            src: e.image.src,
        ...
        var e, t, i, n = this;
        switch (e = null != n.radius_bubble ? n.radius_bubble : n.radius, t = null != n.opacity_bubble ? n.opacity_bubble : n.opacity, t = n.color.rgb ? "rgba(" + n.color.rgb.r + "," + n.color.rgb.g + "," + n.color.rgb.b + "," + t + ")" : "hsla(" + n.color.hsl.h + "," + n.color.hsl.s + "%," + n.color.hsl.l + "%," + t + ")", u.canvas.ctx.fillStyle = t, u.canvas.ctx.beginPath(), n.shape) {
            case"circle":
        ...
        var i = e.x - t.x, n = e.y - t.y, i = Math.sqrt(i * i + n * n);
        ...
        "window" == u.interactivity.detect_on ? u.interactivity.el = window : u.interactivity.el = u.canvas.el, (u.interactivity.events.onhover.enable || u.interactivity.events.onclick.enable) && (u.interactivity.el.addEventListener("mousemove", function (e) {
            var t;
            e = u.interactivity.el == window ? (t = e.clientX, e.clientY) : (t = e.offsetX || e.clientX, e.offsetY || e.clientY), u.interactivity.mouse.pos_x = t, u.interactivity.mouse.pos_y = e, u.tmp.retina && (u.interactivity.mouse.pos_x *= u.canvas.pxratio, u.interactivity.mouse.pos_y *= u.canvas.pxratio), u.interactivity.status = "mousemove"
        ...
        for (var i = 0; i < u.particles.array.length; i++) {
            var n = u.particles.array[i], r = e.x - n.x, s = e.y - n.y;
            Math.sqrt(r * r + s * s) <= e.radius + n.radius && (e.x = t ? t.x : Math.random() * u.canvas.w, e.y = t ? t.y : Math.random() * u.canvas.h, u.fn.vendors.checkOverlap(e))
        }
        ...
        var e = u.tmp.source_svg.replace(/#([0-9A-F]{3,6})/gi, function (e, t, i, n) {
            ...
            }), e = new Blob([e], {type: "image/svg+xml;charset=utf-8"}), t = window.URL || window.webkitURL || window,
            i = t.createObjectURL(e), n = new Image;
        ...
        var a = r * s, r = r / s, o = Math.PI - Math.PI * (180 * (r - 2) / r) / 180;
        e.save(), e.beginPath(), e.translate(t, i), e.moveTo(0, 0);
        for (var l = 0; l < a; l++) e.lineTo(n, 0), e.translate(n, 0), e.rotate(o);
        e.fill(), e.restore()
...
Object.deepExtend = function (e, t) {
    ...
    s.className = n, s.style.width = "100%", s.style.height = "100%", null != document.getElementById(e).appendChild(s) && pJSDom.push(new pJS(e, t))
    ...
    function r(e, t) {
        this.path = e || "", null != t ? (this.at_2x_path = t, this.perform_check = !1) : (void 0 !== document.createElement ? ((e = document.createElement("a")).href = this.path, e.pathname = e.pathname.replace(n, i), this.at_2x_path = e.href) : ((t = this.path.split("?"))[0] = t[0].replace(n, i), this.at_2x_path = t.join("?")), this.perform_check = !0)
    }
    ...
    var t = "undefined" == typeof exports ? window : exports,
        ...
        n = ((t.Retina = e).configure = function (e) {
            for (var t in e = null === e ? {} : e) e.hasOwnProperty(t) && (a[t] = e[t])
        }, e.init = function (e) {
            var r = (e = null === e ? t : e).onload || function () {
            };
            e.onload = function () {
                for (var e, t = document.getElementsByTagName("img"), i = [], n = 0; n < t.length; n += 1) (e = t[n]).getAttributeNode("data-no-retina") || i.push(new s(e));
                r()
            }
        }, e.isRetina = function () {
    ...
    (t.RetinaImagePath = r).confirmed_paths = [], r.prototype.is_external = function () {
        return !(!this.path.match(/^https?\:/i) || this.path.match("//" + document.domain))
    }, r.prototype.check_2x_variant = function (t) {
        var i, n = this;
        return this.is_external() ? t(!1) : !this.perform_check && void 0 !== this.at_2x_path && null !== this.at_2x_path || this.at_2x_path in r.confirmed_paths ? t(!0) : ((i = new XMLHttpRequest).open("HEAD", this.at_2x_path), i.onreadystatechange = function () {
        ...
        var i = this;
        !function e() {
            i.el.complete ? (a.force_original_dimensions && (i.el.setAttribute("width", i.el.offsetWidth), i.el.setAttribute("height", i.el.offsetHeight)), i.el.setAttribute("src", t)) : setTimeout(e, 5)
        }()
    }, e.isRetina() && e.init(t)
}(),
    /*!
...
!*/
    function (v, b, k) {
        ...
        var y, _, I = {
            ...
            }, Q = Object.prototype.hasOwnProperty, w = v.Math, o = v.getComputedStyle, E = "touchstart", C = "touchcancel",
            A = "skrollable", K = A + "-before", Z = A + "-between", J = A + "-after", n = "skrollr", l = "no-" + n,
            d = n + "-desktop", u = n + "-mobile", p = .004, h = "skrollr-body", m = 200, x = "___skrollable_id",
            M = /^(?:input|textarea|button|select)$/i, i = /^\s+|\s+$/g,
            ee = /^data(?:-(_\w+))?(?:-?(-?\d*\.?\d+p?))?(?:-?(start|end|top|center|bottom))?(?:-?(top|center|bottom))?$/,
            g = /\s*(@?[\w\-\[\]]+)\s*:\s*(.+?)\s*(?:;|$)/gi, te = /^(@?[a-z\-]+)\[(\w+)\]$/, ie = /-([a-z0-9_])/g,
            ne = /[\-+]?[\d]*\.?[\d]+/g, re = /\{\?\}/g, se = /rgba?\(\s*-?\d+\s*,\s*-?\d+\s*,\s*-?\d+/g,
            ae = /[a-z\-]+-gradient/g, r = "", s = "", oe = function () {
                var e = /^(?:O|Moz|webkit|ms)|(?:-(?:o|moz|webkit|ms)-)/;
                if (o) {
                    var t, i = o(_, null);
                    for (t in i) if (r = t.match(e) || +t == t && i[t].match(e)) break;
                    r ? "-" === (r = r[0]).slice(0, 1) ? r = {
                        "-webkit-": "webkit",
                        "-moz-": "Moz",
                        "-ms-": "ms",
                ...
                var e = v.requestAnimationFrame || v[r.toLowerCase() + "RequestAnimationFrame"], i = q();
                return e = !V && e ? e : function (e) {
                    var t = q() - i, t = w.max(0, 1e3 / 60 - t);
        ...
        function t(e) {
            if (y = b.documentElement, _ = b.body, oe(), L = this, a = (e = e || {}).constants || {}, e.easing) for (var t in e.easing) O[t] = e.easing[t];
            de = e.edgeStrategy || "set", D = {
                beforerender: e.beforerender,
                render: e.render,
                keyframe: e.keyframe
            }, (f = !1 !== e.forceHeight) && (Oe = e.scale || 1), T = e.mobileDeceleration || p, ce = !1 !== e.smoothScrolling, j = e.smoothScrollingDuration || m, B = {targetTop: L.getScrollTop()}, (V = (e.mobileCheck || function () {
                return /Android|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent || navigator.vendor || v.opera)
            })()) ? ((z = b.getElementById(e.skrollrBody || h)) && _e(), pe(), W(y, [n, u], [l])) : W(y, [n, d], [l]), L.refresh(), we(v, "resize orientationchange", function () {
                var e = y.clientWidth, t = y.clientHeight;
        ...
        t.prototype.refresh = function (e) {
            var t, i, n = !1;
            for (e === k ? (n = !0, P = [], De = 0, e = b.getElementsByTagName("*")) : e.length === k && (e = [e]), t = 0, i = e.length; t < i; t++) {
                var r = e[t], s = r, a = [], o = ce, l = de, c = !1;
                if (n && x in r && delete r[x], r.attributes) {
                    for (var d, u, p, h = 0, f = r.attributes.length; h < f; h++) {
                        ...
                        if ("data-anchor-target" === v.name) {
                            if (null === (s = b.querySelector(v.value))) throw 'Unable to find anchor target "' + v.value + '"'
                        } else "data-smooth-scrolling" === v.name ? o = "off" !== v.value : "data-edge-strategy" === v.name ? l = v.value : "data-emit-events" === v.name ? c = !0 : null !== (g = v.name.match(ee)) && (v = {
                            props: v.value,
                            element: r,
                            eventType: v.name.replace(ie, S)
                        }, a.push(v), (m = g[1]) && (v.constant = m.substr(1)), m = g[2], /p$/.test(m) ? (v.isPercentage = !0, v.offset = (0 | m.slice(0, -1)) / 100) : v.offset = 0 | m, m = g[3], g = g[4] || m, m && "start" !== m && "end" !== m ? (v.mode = "relative", v.anchors = [m, g]) : (v.mode = "absolute", "end" === m ? v.isEnd = !0 : v.isPercentage || (v.offset = v.offset * Oe)))
                    }
                    a.length && (p = !n && x in r ? (u = r[x], d = P[u].styleAttr, P[u].classAttr) : (u = r[x] = De++, d = r.style.cssText, ke(r)), P[u] = {
                        element: r,
                        styleAttr: d,
                        classAttr: p,
                        anchorTarget: s,
            ...
            var n = y.clientHeight, e = e.getBoundingClientRect(), r = e.top, e = e.bottom - e.top;
            return "bottom" === t ? r -= n : "center" === t && (r -= n / 2), "bottom" === i ? r += e : "center" === i && (r += e / 2), (r += L.getScrollTop()) + .5 | 0
        }, t.prototype.animateTo = function (e, t) {
            t = t || {};
            var i = q(), n = L.getScrollTop(), r = t.duration === k ? 1e3 : t.duration;
            return (R = {
                startTop: n,
                topDiff: e - n,
                targetTop: e,
            ...
            }).topDiff || (R.done && R.done.call(L, !1), R = k), L
            ...
            return F = !0 === t, V ? U = w.min(w.max(e, 0), Y) : v.scrollTo(0, e), L
            ...
            e = v.cancelAnimationFrame || v[r.toLowerCase() + "CancelAnimationFrame"], e = !V && e ? e : function (e) {
                return v.clearTimeout(e)
            };
            e(ue), Te(), W(y, [l], [n, d, u]);
            for (var e, t = 0, i = P.length; t < i; t++) H(P[t].element);
            y.style.overflow = _.style.overflow = "", y.style.height = _.style.height = "", z && I.setStyle(z, "transform", "none"), $ = "down", V = G = !(X = -(Oe = 1)), U = De = ze = Pe = Y = 0, N = de = F = B = j = ce = R = T = a = f = D = z = L = k
        };
        var L, P, z, D, f, a, T, R, ce, j, B, F, de, N, ue, pe = function () {
            ...
            we(y, [E, "touchmove", C, "touchend"].join(" "), function (e) {
                ...
                switch (d = t.clientY, u = t.clientX, f = e.timeStamp, M.test(c.tagName) || e.preventDefault(), e.type) {
                    case E:
                        a && a.blur(), L.stopAnimateTo(), a = c, o = p = d, l = u, 0;
                        break;
                    case"touchmove":
                        M.test(c.tagName) && b.activeElement !== c && e.preventDefault(), h = d - p, g = f - m, L.setScrollTop(U - h, !0), p = d, m = f;
                        break;
                    default:
                    case C:
                    case"touchend":
                        var i, n, r = o - d, s = l - u;
                        s * s + r * r < 49 ? M.test(a.tagName) || (a.focus(), (s = b.createEvent("MouseEvents")).initMouseEvent("click", !0, !0, e.view, 1, t.screenX, t.screenY, t.clientX, t.clientY, e.ctrlKey, e.altKey, e.shiftKey, e.metaKey, 0, null), a.dispatchEvent(s)) : (a = k, r = h / g, r = (r = w.max(w.min(r, 3), -3)) * (s = w.abs(r / T)) + .5 * T * s * s, i = L.getScrollTop() - r, n = 0, Y < i ? (n = (Y - i) / r, i = Y) : i < 0 && (n = -i / r, i = 0), L.animateTo(i + .5 | 0, {
                            easing: "outCubic",
                            duration: s *= 1 - n
                        }))
                }
            }), v.scrollTo(0, 0), y.style.overflow = _.style.overflow = "hidden"
        }, he = function () {
            G && (G = !1, Ee());
            var e, t, i = L.getScrollTop(), n = q();
            if (R ? (n >= R.endTime ? (i = R.targetTop, e = R.done, R = k) : (t = R.easing((n - R.startTime) / R.duration), i = R.startTop + t * R.topDiff | 0), L.setScrollTop(i, !0)) : F || (r = B.targetTop - i, n <= (B = r ? {
                startTop: X,
                topDiff: i - X,
                targetTop: i,
                startTime: Le,
                endTime: Le + j
            } : B).endTime && (t = O.sqrt((n - B.startTime) / j), i = B.startTop + t * B.topDiff | 0)), F || X !== i) {
                var r = {curTop: i, lastTop: X, maxTop: Y, direction: $ = X < i ? "down" : i < X ? "up" : $};
                if ((F = !1) !== (D.beforerender && D.beforerender.call(L, r))) {
                    for (var s = i, a = L.getScrollTop(), o = 0, l = P.length; o < l; o++) {
                        var c, d = P[o], u = d.element, p = d.smoothScrolling ? s : a, h = d.keyFrames, f = h.length,
                            m = h[0], g = h[h.length - 1], v = p < m.frame, y = p > g.frame, b = v ? m : g,
                            _ = d.emitEvents, w = d.lastFrameIndex;
                        if (v || y) {
                            if (v && -1 === d.edge || y && 1 === d.edge) continue;
                            switch (v ? (W(u, [K], [J, Z]), _ && -1 < w && (Se(u, m.eventType, $), d.lastFrameIndex = -1)) : (W(u, [J], [K, Z]), _ && w < f && (Se(u, g.eventType, $), d.lastFrameIndex = f)), d.edge = v ? -1 : 1, d.edgeStrategy) {
                                case"reset":
                                    H(u);
                                    continue;
                                case"ease":
                                ...
                                default:
                                    var x = b.props;
                                    for (c in x) Q.call(x, c) && (E = be(x[c].value), 0 === c.indexOf("@") ? u.setAttribute(c.substr(1), E) : I.setStyle(u, c, E));
                                    continue
                            }
                        } else 0 !== d.edge && (W(u, [A, Z], [K, J]), d.edge = 0);
                        for (var T = 0; T < f - 1; T++) if (p >= h[T].frame && p <= h[T + 1].frame) {
                            var S, E, C = h[T], M = h[T + 1];
                            for (c in C.props) Q.call(C.props, c) && (S = (p - C.frame) / (M.frame - C.frame), S = C.props[c].easing(S), E = ye(C.props[c].value, M.props[c].value, S), E = be(E), 0 === c.indexOf("@") ? u.setAttribute(c.substr(1), E) : I.setStyle(u, c, E));
                            _ && w !== T && (Se(u, ("down" === $ ? C : M).eventType, $), d.lastFrameIndex = T);
                            break
                        }
                    }
                    V && z && I.setStyle(z, "transform", "translate(0, " + -U + "px) " + N), X = i, D.render && D.render.call(L, r)
                }
                e && e.call(L, !1)
            }
            Le = n
            ...
            for (var t = 0, i = e.keyFrames.length; t < i; t++) {
                for (var n, r, s, a = e.keyFrames[t], o = {}; null !== (s = g.exec(a.props));) r = s[1], s = s[2], n = null !== (n = r.match(te)) ? (r = n[1], n[2]) : "linear", s = s.indexOf("!") ? me(s) : [s.slice(1)], o[r] = {
                    value: s,
                    easing: O[n]
                };
                a.props = o
            ...
            var t = [];
            return se.lastIndex = 0, e = e.replace(se, function (e) {
                return e.replace(ne, function (e) {
                    return e / 255 * 100 + "%"
                })
            }), s && (ae.lastIndex = 0, e = e.replace(ae, function (e) {
                return s + e
            })), e = e.replace(ne, function (e) {
                return t.push(+e), "{?}"
            }), t.unshift(e), t
        }, ge = function (e) {
            for (var t = {}, i = 0, n = e.keyFrames.length; i < n; i++) ve(e.keyFrames[i], t);
            for (t = {}, i = e.keyFrames.length - 1; 0 <= i; i--) ve(e.keyFrames[i], t)
        }, ve = function (e, t) {
            for (var i in t) Q.call(e.props, i) || (e.props[i] = t[i]);
            for (i in e.props) t[i] = e.props[i]
        }, ye = function (e, t, i) {
            var n = e.length;
            if (n !== t.length) throw "Can't interpolate between \"" + e[0] + '" and "' + t[0] + '"';
            for (var r = [e[0]], s = 1; s < n; s++) r[s] = e[s] + (t[s] - e[s]) * i;
            return r
        }, be = function (e) {
            var t = 1;
            return re.lastIndex = 0, e[0].replace(re, function () {
                return e[t++]
            })
        }, H = function (e, t) {
            for (var i, n, r = 0, s = (e = [].concat(e)).length; r < s; r++) n = e[r], (i = P[n[x]]) && (t ? (n.style.cssText = i.dirtyStyleAttr, W(n, i.dirtyClassAttr)) : (i.dirtyStyleAttr = n.style.cssText, i.dirtyClassAttr = ke(n), n.style.cssText = i.styleAttr, W(n, i.classAttr)))
        }, _e = function () {
            N = "translateZ(0)", I.setStyle(z, "transform", N);
            var e = o(z), t = e.getPropertyValue("transform"), e = e.getPropertyValue(s + "transform");
            t && "none" !== t || e && "none" !== e || (N = "")
        }, we = (I.setStyle = function (e, t, i) {
            e = e.style;
            if ("zIndex" === (t = t.replace(ie, S).replace("-", ""))) isNaN(i) ? e[t] = i : e[t] = "" + (0 | i); else if ("float" === t) e.styleFloat = e.cssFloat = i; else try {
                r && (e[r + t.slice(0, 1).toUpperCase() + t.slice(1)] = i), e[t] = i
            } catch (e) {
            }
        }, I.addEvent = function (e, t, i) {
            for (var n, r = function (e) {
                return (e = e || v.event).target || (e.target = e.srcElement), e.preventDefault || (e.preventDefault = function () {
                    e.returnValue = !1, e.defaultPrevented = !0
                }), i.call(this, e)
            }, s = 0, a = (t = t.split(" ")).length; s < a; s++) n = t[s], e.addEventListener ? e.addEventListener(n, i, !1) : e.attachEvent("on" + n, r), Re.push({
                element: e,
                name: n,
                listener: i
            })
        }), xe = I.removeEvent = function (e, t, i) {
            for (var n = 0, r = (t = t.split(" ")).length; n < r; n++) e.removeEventListener ? e.removeEventListener(t[n], i, !1) : e.detachEvent("on" + t[n], i)
        }, Te = function () {
            for (var e, t = 0, i = Re.length; t < i; t++) e = Re[t], xe(e.element, e.name, e.listener);
            Re = []
        }, Se = function (e, t, i) {
            ...
            for (var t, i, n, r, s, a, o, l, c, d = y.clientHeight, u = Ce(), p = 0, h = P.length; p < h; p++) for (i = (t = P[p]).element, n = t.anchorTarget, s = 0, a = (r = t.keyFrames).length; s < a; s++) l = (o = r[s]).offset, c = u[o.constant] || 0, o.frame = l, o.isPercentage && (o.frame = l *= d), "relative" === o.mode && (H(i), o.frame = L.relativeToAbsolute(n, o.anchors[0], o.anchors[1]) - l, H(i, !0)), o.frame += c, f && !o.isEnd && o.frame > Y && (Y = o.frame);
            for (Y = w.max(Y, Me()), p = 0, h = P.length; p < h; p++) {
                for (s = 0, a = (r = (t = P[p]).keyFrames).length; s < a; s++) c = u[(o = r[s]).constant] || 0, o.isEnd && (o.frame = Y - o.offset + c);
                t.keyFrames.sort(Ae)
            }
            f && !V && (_.style.height = Y + y.clientHeight + "px"), V ? L.setScrollTop(w.min(L.getScrollTop(), Y)) : L.setScrollTop(e, !0), F = !0
        }, Ce = function () {
            var e, t, i = y.clientHeight, n = {};
            for (e in a) "function" == typeof (t = a[e]) ? t = t.call(L) : /p$/.test(t) && (t = t.slice(0, -1) / 100 * i), n[e] = t;
            return n
        }, Me = function () {
            var e = 0;
            return z && (e = w.max(z.offsetHeight, z.scrollHeight)), w.max(e, _.scrollHeight, _.offsetHeight, y.scrollHeight, y.offsetHeight, y.clientHeight) - y.clientHeight
        }, ke = function (e) {
            var t = "className";
            return v.SVGElement && e instanceof v.SVGElement && (e = e[t], t = "baseVal"), e[t]
        }, W = function (e, t, i) {
            var n = "className";
            if (v.SVGElement && e instanceof v.SVGElement && (e = e[n], n = "baseVal"), i === k) e[n] = t; else {
                for (var r = e[n], s = 0, a = i.length; s < a; s++) r = c(r).replace(c(i[s]), " ");
                for (var r = Ie(r), o = 0, l = t.length; o < l; o++) -1 === c(r).indexOf(c(t[o])) && (r += " " + t[o]);
                e[n] = Ie(r)
            }
        }, Ie = function (e) {
            return e.replace(i, "")
...
!*/
    function (e) {
        ...
        function t(e) {
            var t = [], i = e.dir && "left" === e.dir ? "scrollLeft" : "scrollTop";
            return this.each(function () {
                var e = f(this);
                if (this !== document && this !== window) return !document.scrollingElement || this !== document.documentElement && this !== document.body ? void (0 < e[i]() ? t.push(this) : (e[i](1), 0 < e[i]() && t.push(this), e[i](0))) : (t.push(document.scrollingElement), !1)
        ...
        function c(e) {
            var t = {relative: ""}, i = "string" == typeof e && n.exec(e);
            return "number" == typeof e ? t.px = e : i && (t.relative = i[1], t.px = parseFloat(i[2]) || 0), t
        }

        function d(e) {
            var t = f(e.scrollTarget);
            e.autoFocus && t.length && (t[0].focus(), t.is(document.activeElement) || (t.prop({tabIndex: -1}), t[0].focus())), e.afterScroll.call(e.link, e)
        }
        ...
        f.fn.extend({
            scrollable: function (e) {
                ...
                return "options" === (e = e || {}) ? t ? this.each(function () {
                    var e = f(this), e = f.extend(e.data("ssOpts") || {}, t);
                    f(this).data("ssOpts", e)
                }) : this.first().data("ssOpts") : (h = f.extend({}, f.fn.smoothScroll.defaults, e), i = function (e) {
                    function t(e) {
                        return e.replace(/(:|\.|\/)/g, "\\$1")
                    }

                    var i = f(this), n = f.extend({}, h, i.data("ssOpts") || {}), r = h.exclude, s = n.excludeWithin,
                        a = 0, o = 0, l = !0, c = {}, d = f.smoothScroll.filterPath(location.pathname),
                        u = f.smoothScroll.filterPath(this.pathname),
                        p = location.hostname === this.hostname || !this.hostname, u = n.scrollTarget || u === d,
                        d = t(this.hash);
                    if (d && !f(d).length && (l = !1), n.scrollTarget || p && u && d) {
                        for (; l && a < r.length;) i.is(t(r[a++])) && (l = !1);
                        for (; l && o < s.length;) i.closest(s[o++]).length && (l = !1)
                    } else l = !1;
                    l && (n.preventDefault && e.preventDefault(), f.extend(c, n, {
                        scrollTarget: n.scrollTarget || d,
                        link: this
                    }), f.smoothScroll(c))
                }, null !== e.delegateSelector ? this.off("click.smoothscroll", e.delegateSelector).on("click.smoothscroll", e.delegateSelector, i) : this.off("click.smoothscroll").on("click.smoothscroll", i), this)
            }
        });
        f.smoothScroll = function (e, t) {
            if ("options" === e && "object" == typeof t) return f.extend(u, t);
            var i, n, r = c(e), s = 0, a = "offset", o = {}, l = {};
            r.px ? i = f.extend({link: null}, f.fn.smoothScroll.defaults, u) : ((i = f.extend({link: null}, f.fn.smoothScroll.defaults, e || {}, u)).scrollElement && "static" === i.scrollElement.css(a = "position") && i.scrollElement.css("position", "relative"), t && (r = c(t))), e = "left" === i.direction ? "scrollLeft" : "scrollTop", i.scrollElement ? (n = i.scrollElement, r.px || /^(?:HTML|BODY)$/.test(n[0].nodeName) || (s = n[e]())) : n = f("html, body").firstScrollable(i.direction), i.beforeScroll.call(n, i), t = r.px ? r : {
                relative: "",
                px: f(i.scrollTarget)[a]() && f(i.scrollTarget)[a]()[i.direction] || 0
            }, o[e] = t.relative + (t.px + s + i.offset), l = {
                duration: r = "auto" === (r = i.speed) ? Math.abs(o[e] - n[e]()) / i.autoCoefficient : r,
                easing: i.easing,
                complete: function () {
                    d(i)
                }
            }, i.step && (l.step = i.step), n.length ? n.stop().animate(o, l) : d(i)
        }, f.smoothScroll.version = "2.2.0", f.smoothScroll.filterPath = function (e) {
...
!*/
    function (e, t) {
        ...
        "use strict";
        var s = document, c = s.createTextNode.bind(s);
        ...
        function p(e, t, i, n) {
            ...
            return t && (r.className = t), i && (n || r.setAttribute("data-" + t, i), r.textContent = i), e && u(e, r) || r
        }
        ...
        function g(e, i, n, r, s) {
            e.normalize();
            var a = [], o = document.createDocumentFragment(), l = (r && a.push(e.previousSibling), []);
            return f(e.childNodes).some(function (e) {
                var t;
                e.tagName && !e.hasChildNodes() ? l.push(e) : e.childNodes && e.childNodes.length ? (l.push(e), a.push.apply(a, g(e, i, n, r, s))) : (t = (e = e.wholeText || "").trim()).length && (" " === e[0] && l.push(c("      ")), m(t.split(n), function (e, t) {
        ...
        var l = "words", n = e(l, 0, "word", function (e) {
        ...
        function y(t) {
            ...
            return f(t.target || "[data-splitting]").map(function (a) {
                var e, o, l = a["🍌"];
                return !t.force && l || (l = a["🍌"] = {el: a}, e = i(e = (e = t.by || h(a, "splitting")) && "true" != e ? e : "chars"), o = function (e, t) {
                    for (var i in t) e[i] = t[i];
                    return e
                }({}, t), m(e, function (e) {
                    var t, i, n, r, s;
                    e.split && (t = e.by, n = (c ? "-" + c : "") + e.key, e = e.split(a, o, l), n && (i = a, s = (n = "--" + (n = n)) + "-index", m(r = e, function (e, t) {
                        Array.isArray(e) ? m(e, function (e) {
                            d(e, s, t)
                        }) : d(e, s, t)
                    }), d(i, n + "-total", r.length)), l[t] = e, a.classList.add(t))
                }), a.classList.add("splitting")), l
            })
        }

        function b(e, t, i) {
            var t = f(t.matching || e.children, e), n = {};
        ...
        }), E = e("grid", ["rows", "cols"]), C = "layout", M = e(C, 0, 0, function (e, t) {
            for (var i, n = t.rows = +(t.rows || h(e, "rows") || 1), r = t.columns = +(t.columns || h(e, "columns") || 1), s = (t.image = t.image || h(e, "image") || e.currentSrc || e.src, t.image && (i = f("img", e)[0], t.image = i && (i.currentSrc || i.src)), t.image && d(e, "background-image", "url(" + t.image + ")"), n * r), a = [], o = p(0, "cell-grid"); s--;) {
                var l = p(o, "cell");
        ...
        return (y.add = t)(n), t(v), t(w), t(x), t(T), t(S), t(E), t(M), t(k), t(I), t(A), y
    }),
    /*!
    Sticky-kit
    Version: 1.1.3
...
!*/
    function () {
        var O = window.jQuery, L = O(window);
        O.fn.stick_in_parent = function (e) {
            var x, t, i, n, r, T, S = (e = null == e ? {} : e).sticky_class, E = e.inner_scrolling, C = e.recalc_every,
                M = e.parent, k = e.offset_top, I = e.spacer, A = e.bottoming;
            for (null == k && (k = 0), null == M && (M = void 0), null == E && (E = !0), null == S && (S = "is_stuck"), x = O(document), null == A && (A = !0), T = function (e) {
                var t, i;
                ...
                if (!s.data("sticky_kit")) {
                    if (s.data("sticky_kit", !0), g = x.height(), y = s.parent(), !(y = null != M ? y.closest(M) : y).length) throw "failed to find stick parent";
                    if (h = f = !1, (w = null != I ? I && s.closest(I) : O("<div />")) && w.css("position", s.css("position")), (b = function () {
                        var e, t, i;
                        if (!p) return g = x.height(), e = parseInt(y.css("border-top-width"), 10), t = parseInt(y.css("padding-top"), 10), a = parseInt(y.css("padding-bottom"), 10), o = y.offset().top + e + t, l = y.height(), f && (h = f = !1, null == I && (s.insertAfter(w), w.detach()), s.css({
                            position: "",
                            top: "",
                            width: "",
                            bottom: ""
                        }).removeClass(S), i = !0), c = s.offset().top - (parseInt(s.css("margin-top"), 10) || 0) - k, d = s.outerHeight(!0), u = s.css("float"), w && w.css({
                            width: T(s),
                            height: d,
                    ...
                    })(), d !== l) return m = void 0, v = k, _ = C, n = function () {
                        var e, t, i, n, r;
                        if (!p) return i = !1, null != _ && --_ <= 0 && (_ = C, b(), i = !0), i || x.height() === g || (b(), i = !0), i = L.scrollTop(), null != m && (t = i - m), m = i, f ? (A && (n = l + o < i + d + v, h) && !n && (h = !1, s.css({
                            position: "fixed",
                            bottom: "",
                            top: v
                        }).trigger("sticky_kit:unbottom")), i < c && (f = !1, v = k, null == I && ("left" !== u && "right" !== u || s.insertAfter(w), w.detach()), s.css(e = {
                            position: "",
                            width: "",
                            top: ""
                        }).removeClass(S).trigger("sticky_kit:unstick")), E && (r = L.height()) < d + k && (h || (v -= t, v = Math.max(r - d, v), v = Math.min(k, v), f && s.css({top: v + "px"})))) : c < i && (f = !0, (e = {
                            position: "fixed",
                            top: v
                        }).width = "border-box" === s.css("box-sizing") ? s.outerWidth() + "px" : s.width() + "px", s.css(e).addClass(S), null == I && (s.after(w), "left" !== u && "right" !== u || w.append(s)), s.trigger("sticky_kit:stick")), f && A && (null == n && (n = l + o < i + d + v), !h) && n ? (h = !0, "static" === y.css("position") && y.css({position: "relative"}), s.css({
                            position: "absolute",
                            bottom: a,
                            top: "auto"
                        ...
                        if (p = !0, L.off("touchmove", n), L.off("scroll", n), L.off("resize", t), O(document.body).off("sticky_kit:recalc", t), s.off("sticky_kit:detach", e), s.removeData("sticky_kit"), s.css({
                            position: "",
                            bottom: "",
                            top: "",
                            width: ""
                        }), y.position("position", ""), f) return null == I && ("left" !== u && "right" !== u || s.insertAfter(w), w.remove()), s.removeClass(S)
                    }, L.on("touchmove", n), L.on("scroll", n), L.on("resize", t), O(document.body).on("sticky_kit:recalc", t), s.on("sticky_kit:detach", e), setTimeout(n, 0)
                }
            }, n = 0, r = this.length; n < r; n++) t = this[n], i(O(t));
            return this
        }
    }.call(this);
/*!
...
var Swiper = function () {
    ...
    function I(e, t) {
        ...
        return i.WebKitCSSMatrix ? (6 < (r = e.transform || e.webkitTransform).split(",").length && (r = r.split(", ").map(e => e.replace(",", ".")).join(", ")), s = new i.WebKitCSSMatrix("none" === r ? "" : r)) : (s = e.MozTransform || e.OTransform || e.MsTransform || e.msTransform || e.transform || e.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"), n = s.toString().split(",")), "x" === t && (r = i.WebKitCSSMatrix ? s.m41 : 16 === n.length ? parseFloat(n[12]) : parseFloat(n[4])), (r = "y" === t ? i.WebKitCSSMatrix ? s.m42 : 16 === n.length ? parseFloat(n[13]) : parseFloat(n[5]) : r) || 0
    }
        ...
        for (let e = 1; e < arguments.length; e += 1) {
            ...
            if (null != r && (t = r, !("undefined" != typeof window && void 0 !== window.HTMLElement ? t instanceof HTMLElement : t && (1 === t.nodeType || 11 === t.nodeType)))) {
                ...
                for (let e = 0, t = s.length; e < t; e += 1) {
                    var a = s[e], o = Object.getOwnPropertyDescriptor(r, a);
                    void 0 !== o && o.enumerable && (l(i[a]) && l(r[a]) ? r[a].__swiper__ ? i[a] = r[a] : p(i[a], r[a]) : l(i[a]) || !l(r[a]) || (i[a] = {}, r[a].__swiper__) ? i[a] = r[a] : p(i[a], r[a]))
                }
            }
        }
        return i
    ...
    function T(e) {
        ...
        const s = k(), a = -i.translate;
        let o = null, l;
        const c = i.params.speed,
            d = (i.wrapperEl.style.scrollSnapType = "none", s.cancelAnimationFrame(i.cssModeFrameID), n > a ? "next" : "prev"),
            u = (e, t) => "next" === d && t <= e || "prev" === d && e <= t, p = () => {
                l = (new Date).getTime(), null === o && (o = l);
                var e = Math.max(Math.min((l - o) / c, 1), 0), e = .5 - Math.cos(e * Math.PI) / 2;
                let t = a + e * (n - a);
                u(t, n) && (t = n), i.wrapperEl.scrollTo({[r]: t}), u(t, n) ? (i.wrapperEl.style.overflow = "hidden", i.wrapperEl.style.scrollSnapType = "", setTimeout(() => {
    ...
    function L(e) {
        var t = k(), i = A(), n = e.getBoundingClientRect(), i = i.body, r = e.clientTop || i.clientTop || 0,
            i = e.clientLeft || i.clientLeft || 0, s = e === t ? t.scrollY : e.scrollTop,
    ...
    function R(e) {
        return void 0 === e && (e = {}), _ = _ || function (e) {
            var e = (void 0 === e ? {} : e)["userAgent"], t = b(), i = (s = k()).navigator.platform,
                e = e || s.navigator.userAgent, n = {ios: !1, android: !1}, r = s.screen.width, s = s.screen.height,
                a = e.match(/(Android);?[\s\/]+([\d.]+)?/);
            let o = e.match(/(iPad).*OS\s([\d_]+)/);
            var l = e.match(/(iPod)(.*OS\s([\d_]+))?/), c = !o && e.match(/(iPhone\sOS|iOS)\s([\d_]+)/),
                d = "Win32" === i, i = "MacIntel" === i;
            return !o && i && t.touch && 0 <= ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(r + "x" + s) && (o = (o = e.match(/(Version)\/([\d.]+)/)) || [0, 1, "13_0_0"]), a && !d && (n.os = "android", n.android = !0), (o || c || l) && (n.os = "ios", n.ios = !0), n
        }(e)
    }
    ...
    function j() {
        return e = e || function () {
            ...
            var n, r;
            return i() && (n = String(t.navigator.userAgent)).includes("Version/") && ([n, r] = n.split("Version/")[1].split(" ")[0].split(".").map(e => Number(e)), e = n < 16 || 16 === n && r < 2), {
                isSafari: e || i(),
    ...
    const o = (t, e) => {
        ...
        if (i && !i.destroyed && i.params) {
            var t = i.params.lazyPreloadPrevNext, n = i.slides.length;
            if (n && t && !(t < 0)) {
                t = Math.min(t, n);
                ...
                if (i.params.grid && 1 < i.params.grid.rows) {
                    const l = r, c = [l - t];
                    c.push(...Array.from({length: t}).map((e, t) => l + o + t)), void i.slides.forEach((e, t) => {
                        c.includes(e.column) && d(i, t)
                    })
                } else {
                    var s = r + o - 1;
                    if (i.params.rewind || i.params.loop) for (let e = r - t; e <= s + t; e += 1) {
                        var a = (e % n + n) % n;
                        (a < r || s < a) && d(i, a)
                    } else for (let e = Math.max(r - t, 0); e <= Math.min(s + t, n - 1); e += 1) e !== r && (e > s || e < r) && d(i, e)
                }
            }
        }
    };
    ...
    function B(e) {
        var {swiper: e, runCallbacks: t, direction: i, step: n} = e, {activeIndex: r, previousIndex: s} = e;
        let a = i;
        a = a || (s < r ? "next" : r < s ? "prev" : "reset"), e.emit("transition" + n), t && r !== s && ("reset" === a ? e.emit("slideResetTransition" + n) : (e.emit("slideChangeTransition" + n), "next" === a ? e.emit("slideNextTransition" + n) : e.emit("slidePrevTransition" + n)))
    }
    ...
    function N(e, t, i) {
        var n = k(), e = e["params"], r = e.edgeSwipeDetection, e = e.edgeSwipeThreshold;
        return !r || !(i <= e || i >= n.innerWidth - e) || "prevent" === r && (t.preventDefault(), 1)
    }
    ...
    const W = (e, t) => {
        var i = A(), {params: n, el: r, wrapperEl: s, device: a} = e, o = !!n.nested,
            l = "on" === t ? "addEventListener" : "removeEventListener";
        i[l]("touchstart", e.onDocumentTouchStart, {
            passive: !1,
            capture: o
        }), r[l]("touchstart", e.onTouchStart, {passive: !1}), r[l]("pointerdown", e.onTouchStart, {passive: !1}), i[l]("touchmove", e.onTouchMove, {
            passive: !1,
            capture: o
        }), i[l]("pointermove", e.onTouchMove, {
            passive: !1,
            capture: o
        }), i[l]("touchend", e.onTouchEnd, {passive: !0}), i[l]("pointerup", e.onTouchEnd, {passive: !0}), i[l]("pointercancel", e.onTouchEnd, {passive: !0}), i[l]("touchcancel", e.onTouchEnd, {passive: !0}), i[l]("pointerout", e.onTouchEnd, {passive: !0}), i[l]("pointerleave", e.onTouchEnd, {passive: !0}), i[l]("contextmenu", e.onTouchEnd, {passive: !0}), (n.preventClicks || n.preventClicksPropagation) && r[l]("click", e.onClick, !0), n.cssMode && s[l]("scroll", e.onScroll), n.updateOnWindowResize ? e[t](a.ios || a.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", H, !0) : e[t]("observerUpdate", H, !0), r[l]("load", e.onLoad, {capture: !0})
    };
        ...
        eventsEmitter: {
            on(e, t, i) {
                ...
                if (r.eventsListeners && !r.destroyed && r.eventsListeners) {
                    ...
                    n = "string" == typeof s[0] || Array.isArray(s[0]) ? (e = s[0], i = s.slice(1, s.length), r) : (e = s[0].events, i = s[0].data, s[0].context || r), i.unshift(n), (Array.isArray(e) ? e : e.split(" ")).forEach(t => {
            ...
            updateSize: function () {
                ...
                let t, i;
                var n = e.el;
                t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : n.clientWidth, i = void 0 !== e.params.height && null !== e.params.height ? e.params.height : n.clientHeight, 0 === t && e.isHorizontal() || 0 === i && e.isVertical() || (t = t - parseInt($(n, "padding-left") || 0, 10) - parseInt($(n, "padding-right") || 0, 10), i = i - parseInt($(n, "padding-top") || 0, 10) - parseInt($(n, "padding-bottom") || 0, 10), Number.isNaN(t) && (t = 0), Number.isNaN(i) && (i = 0), Object.assign(e, {
                    width: t,
                    height: i,
                ...
                const s = n.params, {wrapperEl: e, slidesEl: i, size: a, rtlTranslate: t, wrongRTL: j} = n;
                var o = n.virtual && s.virtual.enabled, l = (o ? n.virtual : n).slides.length;
                ...
                let f = s.slidesOffsetBefore,
                    m = ("function" == typeof f && (f = s.slidesOffsetBefore.call(n)), s.slidesOffsetAfter);
                "function" == typeof m && (m = s.slidesOffsetAfter.call(n));
                var g = n.snapGrid.length, B = n.slidesGrid.length;
                let v = s.spaceBetween, y = -f, b = 0, _ = 0;
                if (void 0 !== a) {
                    "string" == typeof v && 0 <= v.indexOf("%") ? v = parseFloat(v.replace("%", "")) / 100 * a : "string" == typeof v && (v = parseFloat(v)), n.virtualSize = -v, c.forEach(e => {
                        t ? e.style.marginLeft = "" : e.style.marginRight = "", e.style.marginBottom = "", e.style.marginTop = ""
                    }), s.centeredSlides && s.cssMode && (q(e, "--swiper-centered-offset-before", ""), q(e, "--swiper-centered-offset-after", ""));
                    var w = s.grid && 1 < s.grid.rows && n.grid;
                    w ? n.grid.initSlides(c) : n.grid && n.grid.unsetSlides();
                    let i;
                    var x, T, S, E, C, M, k, I, A,
                        F = "auto" === s.slidesPerView && s.breakpoints && 0 < Object.keys(s.breakpoints).filter(e => void 0 !== s.breakpoints[e].slidesPerView).length;
                    for (let t = 0; t < d; t += 1) {
                        i = 0;
                        let e;
                        c[t] && (e = c[t]), w && n.grid.updateSlide(t, e, c), c[t] && "none" === $(e, "display") || ("auto" === s.slidesPerView ? (F && (c[t].style[n.getDirectionLabel("width")] = ""), I = getComputedStyle(e), x = e.style.transform, T = e.style.webkitTransform, x && (e.style.transform = "none"), T && (e.style.webkitTransform = "none"), i = s.roundLengths ? n.isHorizontal() ? X(e, "width", !0) : X(e, "height", !0) : (S = r(I, "width"), E = r(I, "padding-left"), C = r(I, "padding-right"), M = r(I, "margin-left"), k = r(I, "margin-right"), (I = I.getPropertyValue("box-sizing")) && "border-box" === I ? S + M + k : ({
                            clientWidth: I,
                            offsetWidth: A
                        } = e, S + E + C + M + k + (A - I))), x && (e.style.transform = x), T && (e.style.webkitTransform = T), s.roundLengths && (i = Math.floor(i))) : (i = (a - (s.slidesPerView - 1) * v) / s.slidesPerView, s.roundLengths && (i = Math.floor(i)), c[t] && (c[t].style[n.getDirectionLabel("width")] = i + "px")), c[t] && (c[t].swiperSlideSize = i), h.push(i), s.centeredSlides ? (y = y + i / 2 + b / 2 + v, 0 === b && 0 !== t && (y = y - a / 2 - v), 0 === t && (y = y - a / 2 - v), Math.abs(y) < .001 && (y = 0), s.roundLengths && (y = Math.floor(y)), _ % s.slidesPerGroup == 0 && u.push(y), p.push(y)) : (s.roundLengths && (y = Math.floor(y)), (_ - Math.min(n.params.slidesPerGroupSkip, _)) % n.params.slidesPerGroup == 0 && u.push(y), p.push(y), y = y + i + v), n.virtualSize += i + v, b = i, _ += 1)
                    }
                    if (n.virtualSize = Math.max(n.virtualSize, a) + m, t && j && ("slide" === s.effect || "coverflow" === s.effect) && (e.style.width = n.virtualSize + v + "px"), s.setWrapperSize && (e.style[n.getDirectionLabel("width")] = n.virtualSize + v + "px"), w && n.grid.updateWrapperSize(i, u), !s.centeredSlides) {
                        var O = [];
                        for (let t = 0; t < u.length; t += 1) {
                            let e = u[t];
                            s.roundLengths && (e = Math.floor(e)), u[t] <= n.virtualSize - a && O.push(e)
                        }
                        u = O, 1 < Math.floor(n.virtualSize - a) - Math.floor(u[u.length - 1]) && u.push(n.virtualSize - a)
                    }
                    if (o && s.loop) {
                        var L = h[0] + v;
                        ...
                        for (let e = 0; e < n.virtual.slidesBefore + n.virtual.slidesAfter; e += 1) 1 === s.slidesPerGroup && u.push(u[u.length - 1] + L), p.push(p[p.length - 1] + L), n.virtualSize += L
                    }
                    ...
                    if (Object.assign(n, {
                        ...
                        q(e, "--swiper-centered-offset-before", -u[0] + "px"), q(e, "--swiper-centered-offset-after", n.size / 2 - h[h.length - 1] / 2 + "px");
                        const R = -n.snapGrid[0], W = -n.slidesGrid[0];
                        n.snapGrid = n.snapGrid.map(e => e + R), n.slidesGrid = n.slidesGrid.map(e => e + W)
                    }
                    d !== l && n.emit("slidesLengthChange"), u.length !== g && (n.params.watchOverflow && n.checkOverflow(), n.emit("snapGridLengthChange")), p.length !== B && n.emit("slidesGridLengthChange"), s.watchSlidesProgress && n.updateSlidesOffset(), n.emit("slidesUpdated"), o || s.cssMode || "slide" !== s.effect && "fade" !== s.effect || (l = s.containerModifierClass + "backface-hidden", g = n.el.classList.contains(l), d <= s.maxBackfaceHiddenSlides ? g || n.el.classList.add(l) : g && n.el.classList.remove(l))
                }
                ...
                for (s = 0; s < i.length; s += 1) void 0 !== i[s] && (a = i[s].offsetHeight, r = a > r ? a : r);
                ...
                if (0 !== a.length) {
                    ...
                    let i = o ? e : -e, n = (a.forEach(e => {
                        e.classList.remove(s.slideVisibleClass, s.slideFullyVisibleClass)
                    }), r.visibleSlidesIndexes = [], r.visibleSlides = [], s.spaceBetween);
                    ...
                    for (let t = 0; t < a.length; t += 1) {
                        ...
                        var d = (i + (s.centeredSlides ? r.minTranslate() : 0) - e) / (c.swiperSlideSize + n),
                            ...
                            p = -(i - e), h = p + r.slidesSizesGrid[t],
                            f = 0 <= p && p <= r.size - r.slidesSizesGrid[t];
                        (0 <= p && p < r.size - 1 || 1 < h && h <= r.size || p <= 0 && h >= r.size) && (r.visibleSlides.push(c), r.visibleSlidesIndexes.push(t), a[t].classList.add(s.slideVisibleClass)), f && a[t].classList.add(s.slideFullyVisibleClass), c.progress = o ? -d : d, c.originalProgress = o ? -u : u
                    }
                }
                ...
                var l, c, d, u = s, p = a;
                0 == n ? (r = 0, s = !0, a = !0) : (r = (e - t.minTranslate()) / n, n = Math.abs(e - t.minTranslate()) < 1, l = Math.abs(e - t.maxTranslate()) < 1, s = n || r <= 0, a = l || 1 <= r, n && (r = 0), l && (r = 1)), i.loop && (n = t.getSlideIndexByData(0), l = t.getSlideIndexByData(t.slides.length - 1), n = t.slidesGrid[n], l = t.slidesGrid[l], c = t.slidesGrid[t.slidesGrid.length - 1], d = Math.abs(e), 1 < (o = n <= d ? (d - n) / c : (d + c - l) / c)) && --o, Object.assign(t, {
                    progress: r,
                    progressLoop: o,
                    isBeginning: s,
                    isEnd: a
                }), (i.watchSlidesProgress || i.centeredSlides && i.autoHeight) && t.updateSlidesProgress(e), s && !u && t.emit("reachBeginning toEdge"), a && !p && t.emit("reachEnd toEdge"), (u && !s || p && !a) && t.emit("fromEdge"), t.emit("progress", r)
            }, updateSlidesClasses: function () {
                const {slides: e, params: t, slidesEl: i, activeIndex: n} = this;
                var r = this.virtual && t.virtual.enabled, s = this.grid && t.grid && 1 < t.grid.rows,
                ...
                if (r) if (t.loop) {
                    ...
                    (e = e < 0 ? this.virtual.slides.length + e : e) >= this.virtual.slides.length && (e -= this.virtual.slides.length), o = a(`[data-swiper-slide-index="${e}"]`)
                } else o = a(`[data-swiper-slide-index="${n}"]`); else s ? (o = e.filter(e => e.column === n)[0], c = e.filter(e => e.column === n + 1)[0], l = e.filter(e => e.column === n - 1)[0]) : o = e[n];
                o && (o.classList.add(t.slideActiveClass), s ? (c && c.classList.add(t.slideNextClass), l && l.classList.add(t.slidePrevClass)) : (c = function (e, t) {
                    for (var i = []; e.nextElementSibling;) {
                        var n = e.nextElementSibling;
                        (!t || n.matches(t)) && i.push(n), e = n
                    }
                    return i
                }(o, `.${t.slideClass}, swiper-slide`)[0], (c = t.loop && !c ? e[0] : c) && c.classList.add(t.slideNextClass), l = function (e, t) {
                    for (var i = []; e.previousElementSibling;) {
                        var n = e.previousElementSibling;
                        (!t || n.matches(t)) && i.push(n), e = n
                    }
                    return i
                }(o, `.${t.slideClass}, swiper-slide`)[0], (l = t.loop && 0 === !l ? e[e.length - 1] : l) && l.classList.add(t.slidePrevClass))), this.emitSlidesClasses()
                ...
                if (e = e => {
                    ...
                    var {slidesGrid: t, params: i} = e, n = e.rtlTranslate ? e.translate : -e.translate;
                    let r;
                ...
                }(i)), (d = 0 <= r.indexOf(n) ? r.indexOf(n) : (n = Math.min(s.slidesPerGroupSkip, c)) + Math.floor((c - n) / s.slidesPerGroup)) >= r.length && (d = r.length - 1), c !== a || i.params.loop) if (c === a && i.params.loop && i.virtual && i.params.virtual.enabled) i.realIndex = e(c); else {
                    n = i.grid && s.grid && 1 < s.grid.rows;
                    let t;
                    if (i.virtual && s.virtual.enabled && s.loop) t = e(c); else if (n) {
                        r = i.slides.filter(e => e.column === c)[0];
                        let e = parseInt(r.getAttribute("data-swiper-slide-index"), 10);
                        Number.isNaN(e) && (e = Math.max(i.slides.indexOf(r), 0)), t = Math.floor(e / s.grid.rows)
                    } else t = i.slides[c] && (e = i.slides[c].getAttribute("data-swiper-slide-index"), e) ? parseInt(e, 10) : c;
                    Object.assign(i, {
                        previousSnapIndex: l,
                        snapIndex: d,
                        previousRealIndex: o,
                        ...
                        previousIndex: a,
                        activeIndex: c
                    }), i.initialized && u(i), i.emit("activeIndexChange"), i.emit("snapIndexChange"), (i.initialized || i.params.runCallbacksOnInit) && (o !== t && i.emit("realIndexChange"), i.emit("slideChange"))
                } else d !== l && (i.snapIndex = d, i.emit("snapIndexChange"))
            }, updateClickedSlide: function (e, t) {
                var i = this;
                const n = i.params;
                let r = e.closest(`.${n.slideClass}, swiper-slide`),
                    s = (!r && i.isElement && t && 1 < t.length && t.includes(e) && [...t.slice(t.indexOf(e) + 1, t.length)].forEach(e => {
                ...
                r && s ? (i.clickedSlide = r, i.virtual && i.params.virtual.enabled ? i.clickedIndex = parseInt(r.getAttribute("data-swiper-slide-index"), 10) : i.clickedIndex = a, n.slideToClickedSlide && void 0 !== i.clickedIndex && i.clickedIndex !== i.activeIndex && i.slideToClickedSlide()) : (i.clickedSlide = void 0, i.clickedIndex = void 0)
            }
        }, translate: {
            getTranslate: function (e) {
                ...
                var i = this, {rtlTranslate: n, params: r, wrapperEl: s, progress: a} = i;
                let o = 0, l = 0;
                i.isHorizontal() ? o = n ? -e : e : l = e, r.roundLengths && (o = Math.floor(o), l = Math.floor(l)), i.previousTranslate = i.translate, i.translate = i.isHorizontal() ? o : l, r.cssMode ? s[i.isHorizontal() ? "scrollLeft" : "scrollTop"] = i.isHorizontal() ? -o : -l : r.virtualTranslate || (i.isHorizontal() ? o -= i.cssOverflowAdjustment() : l -= i.cssOverflowAdjustment(), s.style.transform = `translate3d(${o}px, ${l}px, 0px)`);
                let c;
                n = i.maxTranslate() - i.minTranslate(), (c = 0 == n ? 0 : (e - i.minTranslate()) / n) !== a && i.updateProgress(e), i.emit("setTranslate", i.translate, t)
                ...
                let d;
                if (d = n && l < e ? l : n && e < c ? c : e, s.updateProgress(d), a.cssMode) {
                    l = s.isHorizontal();
                ...
                } else 0 === t ? (s.setTransition(0), s.setTranslate(d), i && (s.emit("beforeTransitionStart", t, r), s.emit("transitionEnd"))) : (s.setTransition(t), s.setTranslate(d), i && (s.emit("beforeTransitionStart", t, r), s.emit("transitionStart")), s.animating || (s.animating = !0, s.onTranslateToWrapperTransitionEnd || (s.onTranslateToWrapperTransitionEnd = function (e) {
            ...
            slideTo: function (e, t, i, n, r) {
                ...
                if (o.normalizeSlideIndex) for (let e = 0; e < c.length; e += 1) {
                    var v = -Math.floor(100 * g), y = Math.floor(100 * c[e]), b = Math.floor(100 * c[e + 1]);
                ...
                a !== (d || 0) && i && s.emit("beforeSlideChangeStart"), s.updateProgress(g);
                let _;
                if (_ = a > u ? "next" : a < u ? "prev" : "reset", p && -g === s.translate || !p && g === s.translate) return s.updateActiveIndex(a), o.autoHeight && s.updateAutoHeight(), s.updateSlidesClasses(), "slide" !== o.effect && s.setTranslate(g), "reset" !== _ && (s.transitionStart(i, _), s.transitionEnd(i, _)), !1;
                if (o.cssMode) {
                    const w = s.isHorizontal(), x = p ? g : -g;
                    if (0 === t) {
                        r = s.virtual && s.params.virtual.enabled;
                        r && (s.wrapperEl.style.scrollSnapType = "none", s._immediateVirtual = !0), r && !s._cssModeVirtualInitialSet && 0 < s.params.initialSlide ? (s._cssModeVirtualInitialSet = !0, requestAnimationFrame(() => {
                            h[w ? "scrollLeft" : "scrollTop"] = x
                        })) : h[w ? "scrollLeft" : "scrollTop"] = x, r && requestAnimationFrame(() => {
                ...
                } else s.setTransition(t), s.setTranslate(g), s.updateActiveIndex(a), s.updateSlidesClasses(), s.emit("beforeTransitionStart", t, n), s.transitionStart(i, _), 0 === t ? s.transitionEnd(i, _) : s.animating || (s.animating = !0, s.onSlideToWrapperTransitionEnd || (s.onSlideToWrapperTransitionEnd = function (e) {
                    s && !s.destroyed && e.target === this && (s.wrapperEl.removeEventListener("transitionend", s.onSlideToWrapperTransitionEnd), s.onSlideToWrapperTransitionEnd = null, delete s.onSlideToWrapperTransitionEnd, s.transitionEnd(i, _))
                }), s.wrapperEl.addEventListener("transitionend", s.onSlideToWrapperTransitionEnd));
                return !0
            }, slideToLoop: function (n, e, t, i) {
                void 0 === e && (e = this.params.speed), void 0 === t && (t = !0), "string" == typeof (n = void 0 === n ? 0 : n) && (n = parseInt(n, 10));
                const r = this;
                ...
                if (r.params.loop) if (r.virtual && r.params.virtual.enabled) a += r.virtual.slidesBefore; else {
                    ...
                    let t = r.params.slidesPerView,
                        i = ("auto" === t ? t = r.slidesPerViewDynamic() : (t = Math.ceil(parseFloat(r.params.slidesPerView, 10)), o && t % 2 == 0 && (t += 1)), n - e < t);
                    if ((i = o ? i || e < Math.ceil(t / 2) : i) && (o = o ? e < r.activeIndex ? "prev" : "next" : e - r.activeIndex - 1 < r.params.slidesPerView ? "next" : "prev", r.loopFix({
                        direction: o,
                        slideTo: !0,
                ...
                if (r = n.virtual && s.virtual.enabled, s.loop) {
                    ...
                    if (n.loopFix({direction: "next"}), n._clientLeft = n.wrapperEl.clientLeft, n.activeIndex === n.slides.length - 1 && s.cssMode) return requestAnimationFrame(() => {
                ...
                let h = 0;
                return void 0 !== p && ((h = a.indexOf(p)) < 0 && (h = n.activeIndex - 1), "auto" === r.slidesPerView) && 1 === r.slidesPerGroup && r.slidesPerGroupAuto && (h = h - n.slidesPerViewDynamic("previous", !0) + 1, h = Math.max(h, 0)), r.rewind && n.isBeginning ? (l = n.params.virtual && n.params.virtual.enabled && n.virtual ? n.virtual.slides.length - 1 : n.slides.length - 1, n.slideTo(l, e, t, i)) : r.loop && 0 === n.activeIndex && r.cssMode ? (requestAnimationFrame(() => {
                    n.slideTo(h, e, t, i)
                }), !0) : n.slideTo(h, e, t, i)
                ...
                let s = r.activeIndex;
                var a,
                    o = (o = Math.min(r.params.slidesPerGroupSkip, s)) + Math.floor((s - o) / r.params.slidesPerGroup),
                    l = r.rtlTranslate ? r.translate : -r.translate;
                return l >= r.snapGrid[o] ? (a = r.snapGrid[o], (r.snapGrid[o + 1] - a) * n < l - a && (s += r.params.slidesPerGroup)) : l - (a = r.snapGrid[o - 1]) <= (r.snapGrid[o] - a) * n && (s -= r.params.slidesPerGroup), s = Math.max(s, 0), s = Math.min(s, r.slidesGrid.length - 1), r.slideTo(s, e, t, i)
            }, slideToClickedSlide: function () {
                const e = this;
                var t, {params: i, slidesEl: n} = e,
                ...
                i.loop ? e.animating || (t = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), i.centeredSlides ? s < e.loopedSlides - r / 2 || s > e.slides.length - e.loopedSlides + r / 2 ? (e.loopFix(), s = e.getSlideIndex(Y(n, a + `[data-swiper-slide-index="${t}"]`)[0]), E(() => {
                    e.slideTo(s)
                })) : e.slideTo(s) : s > e.slides.length - r ? (e.loopFix(), s = e.getSlideIndex(Y(n, a + `[data-swiper-slide-index="${t}"]`)[0]), E(() => {
                    e.slideTo(s)
                })) : e.slideTo(s)) : e.slideTo(s)
            }
        }, loop: {
            loopCreate: function (e) {
                const n = this, {params: r, slidesEl: t} = n;
                var i, s, a, o, l;
                !r.loop || n.virtual && n.params.virtual.enabled || (i = () => {
                    Y(t, `.${r.slideClass}, swiper-slide`).forEach((e, t) => {
                        e.setAttribute("data-swiper-slide-index", t)
                    })
                }, o = n.grid && r.grid && 1 < r.grid.rows, s = r.slidesPerGroup * (o ? r.grid.rows : 1), a = n.slides.length % s != 0, o = o && n.slides.length % r.grid.rows != 0, l = t => {
                    for (let e = 0; e < t; e += 1) {
                        var i = n.isElement ? C("swiper-slide", [r.slideBlankClass]) : C("div", [r.slideClass, r.slideBlankClass]);
                        n.slidesEl.append(i)
                    }
                }, a ? r.loopAddBlankSlides ? (l(s - n.slides.length % s), n.recalcSlides(), n.updateSlides()) : O("Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)") : o && (r.loopAddBlankSlides ? (l(r.grid.rows - n.slides.length % r.grid.rows), n.recalcSlides(), n.updateSlides()) : O("Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)")), i(), n.loopFix({
                    slideRealIndex: e,
                    ...
                    if (h.allowSlidePrev = !0, h.allowSlideNext = !0, h.virtual && M.virtual.enabled) o && (M.centeredSlides || 0 !== h.snapIndex ? M.centeredSlides && h.snapIndex < M.slidesPerView ? h.slideTo(h.virtual.slides.length + h.snapIndex, 0, !1, !0) : h.snapIndex === h.snapGrid.length - 1 && h.slideTo(h.virtual.slidesBefore, 0, !1, !0) : h.slideTo(h.virtual.slides.length, 0, !1, !0)), h.allowSlidePrev = S, h.allowSlideNext = E; else {
                        ...
                        if (_ < t) {
                            ...
                            for (let e = 0; e < t - _; e += 1) {
                                ...
                                if (m) {
                                    var x = b - w - 1;
                                    for (let e = T.length - 1; 0 <= e; --e) T[e].column === x && g.push(e)
                                } else g.push(b - w - 1)
                            }
                        } else if (_ + e > b - t) {
                        ...
                        if (h.__preventObserver__ = !0, requestAnimationFrame(() => {
                            ...
                            T[e].swiperLoopMoveDOM = !0, C.prepend(T[e]), T[e].swiperLoopMoveDOM = !1
                        }), v && k.forEach(e => {
                            T[e].swiperLoopMoveDOM = !0, C.append(T[e]), T[e].swiperLoopMoveDOM = !1
                        }), h.recalcSlides(), "auto" === M.slidesPerView ? h.updateSlides() : m && (0 < g.length && y || 0 < k.length && v) && h.slides.forEach((e, t) => {
            ...
            attachEvents: function () {
                ...
                e.onTouchStart = function (i) {
                    var n = this, r = A();
                    let s = i;
                    if (s.originalEvent && (s = s.originalEvent), i = n.touchEventsData, "pointerdown" === s.type) {
                        if (null !== i.pointerId && i.pointerId !== s.pointerId) return;
                        i.pointerId = s.pointerId
                    } else "touchstart" === s.type && 1 === s.targetTouches.length && (i.touchId = s.targetTouches[0].identifier);
                    if ("touchstart" === s.type) N(n, s, s.targetTouches[0].pageX); else {
                        ...
                        if (l && (a.simulateTouch || "mouse" !== s.pointerType) && (!n.animating || !a.preventInteractionOnTransition)) {
                            ...
                            if (("wrapper" !== a.touchEventsTarget || n.wrapperEl.contains(t)) && !("which" in s && 3 === s.which || "button" in s && 0 < s.button || i.isTouched && i.isMoved)) {
                                var l = !!a.noSwipingClass && "" !== a.noSwipingClass,
                                    ...
                                    l = (l && s.target && s.target.shadowRoot && c && (t = c[0]), a.noSwipingSelector || "." + a.noSwipingClass),
                                    c = !(!s.target || !s.target.shadowRoot);
                                if (a.noSwiping && (c ? F(l, t) : t.closest(l))) n.allowClick = !0; else if (!a.swipeHandler || t.closest(a.swipeHandler)) {
                                    ...
                                    if (N(n, s, c)) {
                                        Object.assign(i, {
                                            ...
                                            isScrolling: void 0,
                                            startMoving: void 0
                                        }), o.startX = c, o.startY = l, i.touchStartTime = v(), n.allowClick = !0, n.updateSize(), n.swipeDirection = void 0, 0 < a.threshold && (i.allowThresholdMove = !1);
                                        let e = !0;
                                        t.matches(i.focusableElements) && (e = !1, "SELECT" === t.nodeName) && (i.isTouched = !1), r.activeElement && r.activeElement.matches(i.focusableElements) && r.activeElement !== t && r.activeElement.blur();
                                        c = e && n.allowTouchMove && a.touchStartPreventDefault;
                                        !a.touchStartForcePreventDefault && !c || t.isContentEditable || s.preventDefault(), a.freeMode && a.freeMode.enabled && n.freeMode && n.animating && !a.cssMode && n.freeMode.onTouchStart(), n.emit("touchStart", s)
                                    }
                                }
                            }
                        }
                    ...
                    if (d && (o.simulateTouch || "mouse" !== t.pointerType)) {
                        ...
                        let e;
                        if ("touchmove" === n.type) {
                            if (!(e = [...n.changedTouches].filter(e => e.identifier === a.touchId)[0]) || e.identifier !== a.touchId) return
                        } else e = n;
                        if (a.isTouched) {
                            d = e.pageX, t = e.pageY;
                            if (n.preventedByNestedSwiper) l.startX = d, l.startY = t; else if (s.allowTouchMove) {
                                if (o.touchReleaseOnEdges && !o.loop) if (s.isVertical()) {
                                    if (t < l.startY && s.translate <= s.maxTranslate() || t > l.startY && s.translate >= s.minTranslate()) return a.isTouched = !1, void (a.isMoved = !1)
                                } else if (d < l.startX && s.translate <= s.maxTranslate() || d > l.startX && s.translate >= s.minTranslate()) return;
                                if (r.activeElement && n.target === r.activeElement && n.target.matches(a.focusableElements)) a.isMoved = !0, s.allowClick = !1; else {
                                    a.allowTouchCallbacks && s.emit("touchMove", n), l.previousX = l.currentX, l.previousY = l.currentY, l.currentX = d, l.currentY = t;
                                    var r = l.currentX - l.startX, u = l.currentY - l.startY;
                                    if (!(s.params.threshold && Math.sqrt(r ** 2 + u ** 2) < s.params.threshold)) if (void 0 === a.isScrolling && (s.isHorizontal() && l.currentY === l.startY || s.isVertical() && l.currentX === l.startX ? a.isScrolling = !1 : 25 <= r * r + u * u && (p = 180 * Math.atan2(Math.abs(u), Math.abs(r)) / Math.PI, a.isScrolling = s.isHorizontal() ? p > o.touchAngle : 90 - p > o.touchAngle)), a.isScrolling && s.emit("touchMoveOpposite", n), void 0 !== a.startMoving || l.currentX === l.startX && l.currentY === l.startY || (a.startMoving = !0), a.isScrolling) a.isTouched = !1; else if (a.startMoving) {
                                        s.allowClick = !1, !o.cssMode && n.cancelable && n.preventDefault(), o.touchMoveStopPropagation && !o.nested && n.stopPropagation();
                                        let i = s.isHorizontal() ? r : u,
                                            e = s.isHorizontal() ? l.currentX - l.previousX : l.currentY - l.previousY;
                                        o.oneWayMovement && (i = Math.abs(i) * (c ? 1 : -1), e = Math.abs(e) * (c ? 1 : -1)), l.diff = i, i *= o.touchRatio, c && (i = -i, e = -e);
                                        var p = s.touchesDirection,
                                            r = (s.swipeDirection = 0 < i ? "prev" : "next", s.touchesDirection = 0 < e ? "prev" : "next", s.params.loop && !o.cssMode),
                                            u = "next" === s.touchesDirection && s.allowSlideNext || "prev" === s.touchesDirection && s.allowSlidePrev;
                                        if (a.isMoved || (r && u && s.loopFix({direction: s.swipeDirection}), a.startTranslate = s.getTranslate(), s.setTransition(0), s.animating && (c = new window.CustomEvent("transitionend", {
                                            bubbles: !0,
                                            cancelable: !0
                                        }), s.wrapperEl.dispatchEvent(c)), a.allowMomentumBounce = !1, !o.grabCursor || !0 !== s.allowSlideNext && !0 !== s.allowSlidePrev || s.setGrabCursor(!0), s.emit("sliderFirstMove", n)), (new Date).getTime(), a.isMoved && a.allowThresholdMove && p !== s.touchesDirection && r && u && 1 <= Math.abs(i)) Object.assign(l, {
                                            startX: d,
                                            startY: t,
                                            currentX: d,
                                            currentY: t,
                                            ...
                                            s.emit("sliderMove", n), a.isMoved = !0, a.currentTranslate = i + a.startTranslate;
                                            let e = !0, t = o.resistanceRatio;
                                            if (o.touchReleaseOnEdges && (t = 0), 0 < i ? (r && u && a.allowThresholdMove && a.currentTranslate > (o.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] : s.minTranslate()) && s.loopFix({
                                                direction: "prev",
                                                setTranslate: !0,
                                                activeSlideIndex: 0
                                            }), a.currentTranslate > s.minTranslate() && (e = !1, o.resistance) && (a.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + a.startTranslate + i) ** t)) : i < 0 && (r && u && a.allowThresholdMove && a.currentTranslate < (o.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] : s.maxTranslate()) && s.loopFix({
                                                direction: "next",
                                                setTranslate: !0,
                                            ...
                                            o.followFinger && !o.cssMode && ((o.freeMode && o.freeMode.enabled && s.freeMode || o.watchSlidesProgress) && (s.updateActiveIndex(), s.updateSlidesClasses()), o.freeMode && o.freeMode.enabled && s.freeMode && s.freeMode.onTouchMove(), s.updateProgress(a.currentTranslate), s.setTranslate(a.currentTranslate))
                                        }
                                    }
                                }
                            } else n.target.matches(a.focusableElements) || (s.allowClick = !1), a.isTouched && (Object.assign(l, {
                                startX: d,
                                startY: t,
                                currentX: d,
                                currentY: t
                    ...
                    if (!["pointercancel", "pointerout", "pointerleave", "contextmenu"].includes(a.type) || ["pointercancel", "contextmenu"].includes(a.type) && (s.browser.isSafari || s.browser.isWebView)) {
                        ...
                        if (r && (o.simulateTouch || "mouse" !== a.pointerType)) if (t.allowTouchCallbacks && s.emit("touchEnd", a), t.allowTouchCallbacks = !1, t.isTouched) {
                            o.grabCursor && t.isMoved && t.isTouched && (!0 === s.allowSlideNext || !0 === s.allowSlidePrev) && s.setGrabCursor(!1);
                            var r = v(), c = r - t.touchStartTime;
                            if (s.allowClick && (u = a.path || a.composedPath && a.composedPath(), s.updateClickedSlide(u && u[0] || a.target, u), s.emit("tap click", a), c < 300) && r - t.lastClickTime < 300 && s.emit("doubleTap doubleClick", a), t.lastClickTime = v(), E(() => {
                                ...
                                let r;
                                if (r = o.followFinger ? n ? s.translate : -s.translate : -t.currentTranslate, !o.cssMode) if (o.freeMode && o.freeMode.enabled) s.freeMode.onTouchEnd({currentPos: r}); else {
                                    var d = r >= -s.maxTranslate() && !s.params.loop;
                                    let t = 0, i = s.slidesSizesGrid[0];
                                    for (let e = 0; e < l.length; e += e < o.slidesPerGroupSkip ? 1 : o.slidesPerGroup) {
                                        const p = e < o.slidesPerGroupSkip - 1 ? 1 : o.slidesPerGroup;
                                        void 0 !== l[e + p] ? (d || r >= l[e] && r < l[e + p]) && (t = e, i = l[e + p] - l[e]) : (d || r >= l[e]) && (t = e, i = l[l.length - 1] - l[l.length - 2])
                                    }
                                    let e = null, n = null;
                    ...
                    var t = this, {wrapperEl: i, rtlTranslate: n, enabled: r} = t;
                    if (r) {
                        ...
                        (e = 0 == r ? 0 : (t.translate - t.minTranslate()) / r) !== t.progress && t.updateProgress(n ? -t.translate : t.translate), t.emit("setTranslate", t.translate, !1)
                    }
            ...
            setBreakpoint: function () {
                const n = this, {realIndex: e, initialized: t, params: r, el: i} = n;
                if ((a = r.breakpoints) && 0 !== Object.keys(a).length) {
                    ...
                    if (s && n.currentBreakpoint !== s) {
                        ...
                        var a = G(n, r), o = G(n, u), l = r.enabled,
                            a = (a && !o ? (i.classList.remove(r.containerModifierClass + "grid", r.containerModifierClass + "grid-column"), n.emitContainerClasses()) : !a && o && (i.classList.add(r.containerModifierClass + "grid"), (u.grid.fill && "column" === u.grid.fill || !u.grid.fill && "column" === r.grid.fill) && i.classList.add(r.containerModifierClass + "grid-column"), n.emitContainerClasses()), ["navigation", "pagination", "scrollbar"].forEach(e => {
                                var t, i;
                                void 0 !== u[e] && (t = r[e] && r[e].enabled, i = u[e] && u[e].enabled, t && !i && n[e].disable(), !t) && i && n[e].enable()
                            }), u.direction && u.direction !== r.direction),
                            o = r.loop && (u.slidesPerView !== r.slidesPerView || a), c = r.loop,
                            a = (a && t && n.changeDirection(), p(n.params, u), n.params.enabled), d = n.params.loop;
                        Object.assign(n, {
                            allowTouchMove: n.params.allowTouchMove,
                            allowSlideNext: n.params.allowSlideNext,
                            allowSlidePrev: n.params.allowSlidePrev
                        }), l && !a ? n.disable() : !l && a && n.enable(), n.currentBreakpoint = s, n.emit("_beforeBreakpoint", u), t && (o ? (n.loopDestroy(), n.loopCreate(e), n.updateSlides()) : !c && d ? (n.loopCreate(e), n.updateSlides()) : c && !d && n.loopDestroy()), n.emit("breakpoint", u)
                    }
                }
            ...
            checkOverflow: function () {
                ...
                r ? (e = t.slides.length - 1, e = t.slidesGrid[e] + t.slidesSizesGrid[e] + 2 * r, t.isLocked = t.size > e) : t.isLocked = 1 === t.snapGrid.length, !0 === n.allowSlideNext && (t.allowSlideNext = !t.isLocked), !0 === n.allowSlidePrev && (t.allowSlidePrev = !t.isLocked), i && i !== t.isLocked && (t.isEnd = !1), i !== t.isLocked && t.emit(t.isLocked ? "lock" : "unlock")
            }
        }, classes: {
            addClasses: function () {
                var {classNames: e, params: t, rtl: i, el: n, device: r} = this, i = function (e, i) {
                    const n = [];
                    return e.forEach(t => {
                ...
                }(["initialized", t.direction, {"free-mode": this.params.freeMode && t.freeMode.enabled}, {autoheight: t.autoHeight}, {rtl: i}, {grid: t.grid && 1 < t.grid.rows}, {"grid-column": t.grid && 1 < t.grid.rows && "column" === t.grid.fill}, {android: r.android}, {ios: r.ios}, {"css-mode": t.cssMode}, {centered: t.cssMode && t.centeredSlides}, {"watch-progress": t.watchSlidesProgress}], t.containerModifierClass);
    ...
    class h {
        constructor() {
            ...
            1 === n.length && n[0].constructor && "Object" === Object.prototype.toString.call(n[0]).slice(8, -1) ? t = n[0] : [e, t] = n, t = p({}, t = t || {}), e && !t.el && (t.el = e);
            var s = A();
            ...
            const a = this,
                o = (a.__swiper__ = !0, a.support = b(), a.device = R({userAgent: t.userAgent}), a.browser = j(), a.eventsListeners = {}, a.eventsAnyListeners = [], a.modules = [...a.__modules__], t.modules && Array.isArray(t.modules) && a.modules.push(...t.modules), {});
            a.modules.forEach(e => {
                var n, r;
                e({
                    params: t, swiper: a, extendParams: (n = t, r = o, function (e) {
                        void 0 === e && (e = {});
                        var t = Object.keys(e)[0], i = e[t];
                        "object" == typeof i && null !== i && (!0 === n[t] && (n[t] = {enabled: !0}), "navigation" === t && n[t] && n[t].enabled && !n[t].prevEl && !n[t].nextEl && (n[t].auto = !0), 0 <= ["pagination", "scrollbar"].indexOf(t) && n[t] && n[t].enabled && !n[t].el && (n[t].auto = !0), t in n && "enabled" in i) && ("object" != typeof n[t] || "enabled" in n[t] || (n[t].enabled = !0), n[t] || (n[t] = {enabled: !1})), p(r, e)
                    }), on: a.on.bind(a), once: a.once.bind(a), off: a.off.bind(a), emit: a.emit.bind(a)
                })
            });
            s = p({}, V, o);
            return a.params = p({}, s, c, t), a.originalParams = p({}, a.params), a.passedParams = p({}, t), a.params && a.params.on && Object.keys(a.params.on).forEach(e => {
        ...
        getSlideIndex(e) {
            var {slidesEl: t, params: i} = this, t = M(Y(t, `.${i.slideClass}, swiper-slide`)[0]);
            return M(e) - t
        }
        ...
        setProgress(e, t) {
            ...
            var i = this.minTranslate(), n = this.maxTranslate();
            this.translateTo((n - i) * e + i, void 0 === t ? 0 : t), this.updateActiveIndex(), this.updateSlidesClasses()
        }
        ...
        slidesPerViewDynamic(e, t) {
            ...
            if (i.centeredSlides) {
                ...
                for (let e = o + 1; e < n.length; e += 1) n[e] && !i && (t += n[e].swiperSlideSize, l += 1, t > a) && (i = !0);
                for (let e = o - 1; 0 <= e; --e) n[e] && !i && (t += n[e].swiperSlideSize, l += 1, t > a) && (i = !0)
            } else if ("current" === e) for (let e = o + 1; e < n.length; e += 1) (t ? r[e] + s[e] - r[o] < a : r[e] - r[o] < a) && (l += 1); else for (let e = o - 1; 0 <= e; --e) r[o] - r[e] < a && (l += 1);
            return l
        }
        ...
        update() {
            ...
            if (t && !t.destroyed) {
                ...
                r.breakpoints && t.setBreakpoint(), [...t.el.querySelectorAll('[loading="lazy"]')].forEach(e => {
                    e.complete && o(t, e)
        ...
        mount(i) {
            ...
            if (!n.mounted) {
                ...
                e.swiper = n, e.parentNode && e.parentNode.host && "SWIPER-CONTAINER" === e.parentNode.host.nodeName && (n.isElement = !0);
                ...
                !t && n.params.createElements && (t = C("div", n.params.wrapperClass), e.append(t), Y(e, "." + n.params.slideClass).forEach(e => {
                    t.append(e)
                })), Object.assign(n, {
                    el: e,
                    wrapperEl: t,
        ...
        destroy(e, t) {
            ...
            const i = this, {params: n, el: r, wrapperEl: s, slides: a} = i;
            if (void 0 !== i.params && !i.destroyed) {
                if (i.emit("beforeDestroy"), i.initialized = !1, i.detachEvents(), n.loop && i.loopDestroy(), t && (i.removeClasses(), r.removeAttribute("style"), s.removeAttribute("style"), a) && a.length && a.forEach(e => {
    ...
    function z(i, n, r, s) {
        return i.params.createElements && Object.keys(s).forEach(t => {
            if (!r[t] && !0 === r.auto) {
                let e = Y(i.el, "." + s[t])[0];
                e || ((e = C("div", s[t])).className = s[t], i.el.append(e)), r[t] = e, n[t] = e
            }
        }), r
    }
    ...
    function m(e) {
        ...
        if (i.params.virtualTranslate && 0 !== t) {
            ...
            (e = r ? n : n.filter(e => {
                var t,
                    e = e.classList.contains("swiper-slide-transform") ? (t = e).parentElement || i.slides.filter(e => e.shadowRoot && e.shadowRoot === t.parentNode)[0] : e;
    ...
    function x(e, t, i) {
        i = "swiper-slide-shadow" + (i ? "-" + i : "") + (e ? " swiper-slide-shadow-" + e : ""), e = a(t);
    ...
    return Object.keys(s).forEach(t => {
        ...
        t("init", () => {
            ...
            })).observe(s.el) : (n.addEventListener("resize", o), n.addEventListener("orientationchange", l))
        }), t("destroy", () => {
        ...
        t({observer: !1, observeParents: !1, observeSlideChildren: !1}), i("init", () => {
            if (n.params.observer) {
                ...
                s(n.hostEl, {childList: n.params.observeSlideChildren}), s(n.wrapperEl, {attributes: !1})
            }
        }), i("destroy", () => {
            a.forEach(e => {
                e.disconnect()
        ...
        let n;
        e = A(), M.virtual = {cache: {}, from: void 0, to: void 0, slides: [], offset: 0, slidesGrid: []};
        ...
        function I(e, t) {
            ...
            let n;
            return i.renderSlide ? "string" == typeof (n = i.renderSlide.call(M, e, t)) && (r.innerHTML = n, n = r.children[0]) : n = M.isElement ? C("swiper-slide") : C("div", M.params.slideClass), n.setAttribute("data-swiper-slide-index", t), i.renderSlide || (n.innerHTML = e), i.cache && (M.virtual.cache[t] = n), n
        }
        ...
        function a(t) {
            ...
            let f, m,
                g = p - (m = n ? (f = Math.floor(e / 2) + i + a, Math.floor(e / 2) + i + s) : (f = e + (i - 1) + a, (r ? e : i) + s)),
                v = p + f,
                y = (r || (g = Math.max(g, 0), v = Math.min(v, c.length - 1)), (M.slidesGrid[g] || 0) - (M.slidesGrid[0] || 0));

            function b() {
                M.updateSlides(), M.updateProgress(), M.updateSlidesClasses(), k("virtualUpdate")
            }

            if (r && p >= m ? (g -= m, n || (y += M.slidesGrid[0])) : r && p < m && (g = -m, n) && (y += M.slidesGrid[0]), Object.assign(M.virtual, {
                from: g,
                to: v,
                offset: y,
            ...
            }), M.params.virtual.renderExternalUpdate ? b() : k("virtualUpdate"); else {
                var _ = [], w = [], x = e => {
                    let t = e;
                ...
                for (let e = a; e < S; e += 1) e >= g && e <= v && (T = x(e), void 0 === l || t ? w.push(T) : (e > l && w.push(T), e < o && _.push(T)));
                if (w.forEach(e => {
                    M.slidesEl.append(I(c[e], e))
                }), r) for (let e = _.length - 1; 0 <= e; --e) {
                    var E = _[e];
                    M.slidesEl.prepend(I(c[E], E))
                } else _.sort((e, t) => t - e), _.forEach(e => {
                    M.slidesEl.prepend(I(c[e], e))
                });
                Y(M.slidesEl, ".swiper-slide, swiper-slide").forEach(e => {
                    e.style[h] = y - Math.abs(M.cssOverflowAdjustment()) + "px"
                }), b()
            } else M.slidesGrid !== d && y !== u && M.slides.forEach(e => {
                e.style[h] = y - Math.abs(M.cssOverflowAdjustment()) + "px"
            }), M.updateProgress(), k("virtualUpdate")
        }
        ...
        i("beforeInit", () => {
            if (M.params.virtual.enabled) {
                let e;
                var t;
                void 0 === M.passedParams.virtual.slides && (t = [...M.slidesEl.children].filter(e => e.matches(`.${M.params.slideClass}, swiper-slide`))) && t.length && (M.virtual.slides = [...t], e = !0, t.forEach((e, t) => {
                    e.setAttribute("data-swiper-slide-index", t), (M.virtual.cache[t] = e).remove()
                })), e || (M.virtual.slides = M.params.virtual.slides), M.classNames.push(M.params.containerModifierClass + "virtual"), M.params.watchSlidesProgress = !0, M.originalParams.watchSlidesProgress = !0, a()
            }
        }), i("setTranslate", () => {
            M.params.virtual.enabled && (M.params.cssMode && !M._immediateVirtual ? (clearTimeout(n), n = setTimeout(() => {
                a()
            }, 100)) : a())
            ...
            appendSlide: function (t) {
                ...
                if (M.params.virtual.cache) {
                    const r = M.virtual.cache, s = {};
                    Object.keys(r).forEach(e => {
                        var t = r[e], i = t.getAttribute("data-swiper-slide-index");
                        i && t.setAttribute("data-swiper-slide-index", parseInt(i, 10) + n), s[parseInt(e, 10) + n] = t
                    }), M.virtual.cache = s
                }
                a(!0), M.slideTo(i, 0)
                ...
                if (null != i) {
                    let t = M.activeIndex;
                    if (Array.isArray(i)) for (let e = i.length - 1; 0 <= e; --e) M.params.virtual.cache && (delete M.virtual.cache[i[e]], Object.keys(M.virtual.cache).forEach(e => {
                        i < e && (M.virtual.cache[e - 1] = M.virtual.cache[e], M.virtual.cache[e - 1].setAttribute("data-swiper-slide-index", e - 1), delete M.virtual.cache[e])
                    })), M.virtual.slides.splice(i[e], 1), i[e] < t && --t, t = Math.max(t, 0); else M.params.virtual.cache && (delete M.virtual.cache[i], Object.keys(M.virtual.cache).forEach(e => {
                        i < e && (M.virtual.cache[e - 1] = M.virtual.cache[e], M.virtual.cache[e - 1].setAttribute("data-swiper-slide-index", e - 1), delete M.virtual.cache[e])
                    })), M.virtual.slides.splice(i, 1), i < t && --t, t = Math.max(t, 0);
                    a(!0), M.slideTo(t, 0)
                }
            }, removeAllSlides: function () {
                M.virtual.slides = [], M.params.virtual.cache && (M.virtual.cache = {}), a(!0), M.slideTo(0, 0)
            }, update: a
        })
    }, function (e) {
        ...
        function n(t) {
            if (v.enabled) {
                ...
                var t = (e = e.originalEvent ? e.originalEvent : e).keyCode || e.charCode,
                    n = v.params.keyboard.pageUpDown, r = n && 33 === t, n = n && 34 === t, s = 37 === t, a = 39 === t,
                    o = 38 === t, l = 40 === t;
                if (!v.allowSlideNext && (v.isHorizontal() && a || v.isVertical() && l || n)) return !1;
                if (!v.allowSlidePrev && (v.isHorizontal() && s || v.isVertical() && o || r)) return !1;
                if (!(e.shiftKey || e.altKey || e.ctrlKey || e.metaKey || b.activeElement && b.activeElement.nodeName && ("input" === b.activeElement.nodeName.toLowerCase() || "textarea" === b.activeElement.nodeName.toLowerCase()))) {
                    if (v.params.keyboard.onlyInViewport && (r || n || s || a || o || l)) {
                        let t = !1;
                        if (0 < P(v.el, `.${v.params.slideClass}, swiper-slide`).length && 0 === P(v.el, "." + v.params.slideActiveClass).length) return;
                        var c = v.el, d = c.clientWidth, u = c.clientHeight, p = _.innerWidth, h = _.innerHeight,
                            f = L(c),
                            m = (i && (f.left -= c.scrollLeft), [[f.left, f.top], [f.left + d, f.top], [f.left, f.top + u], [f.left + d, f.top + u]]);
                    ...
                    v.isHorizontal() ? ((r || n || s || a) && (e.preventDefault ? e.preventDefault() : e.returnValue = !1), ((n || a) && !i || (r || s) && i) && v.slideNext(), ((r || s) && !i || (n || a) && i) && v.slidePrev()) : ((r || n || o || l) && (e.preventDefault ? e.preventDefault() : e.returnValue = !1), (n || l) && v.slideNext(), (r || o) && v.slidePrev()), y("keyPress", t)
                }
            }
        }

        function r() {
            v.keyboard.enabled || (b.addEventListener("keydown", n), v.keyboard.enabled = !0)
        }

        function s() {
            v.keyboard.enabled && (b.removeEventListener("keydown", n), v.keyboard.enabled = !1)
        }

        v.keyboard = {enabled: !1}, t({keyboard: {enabled: !1, onlyInViewport: !0, pageUpDown: !0}}), i("init", () => {
        ...
        function g(e) {
            u.params.mousewheel.thresholdDelta && e.delta < u.params.mousewheel.thresholdDelta || u.params.mousewheel.thresholdTime && v() - r < u.params.mousewheel.thresholdTime || 6 <= e.delta && v() - r < 60 || (e.direction < 0 ? u.isEnd && !u.params.loop || u.animating || (u.slideNext(), p("scroll", e.raw)) : u.isBeginning && !u.params.loop || u.animating || (u.slidePrev(), p("scroll", e.raw)), r = (new n.Date).getTime())
        }
        ...
        function o(n) {
            ...
            if (u.enabled && !n.target.closest("." + u.params.mousewheel.noMousewheelClass)) {
                ...
                if (s.forceToAxis) if (u.isHorizontal()) {
                ...
                if ((i = i >= u.minTranslate() ? u.minTranslate() : i) <= u.maxTranslate() && (i = u.maxTranslate()), (!!u.params.loop || !(i === u.minTranslate() || i === u.maxTranslate())) && u.params.nested && r.stopPropagation(), u.params.freeMode && u.params.freeMode.enabled) {
                    ...
                    if (!a) {
                        ...
                        if ((e = e >= u.minTranslate() ? u.minTranslate() : e) <= u.maxTranslate() && (e = u.maxTranslate()), u.setTransition(0), u.setTranslate(e), u.updateProgress(), u.updateActiveIndex(), u.updateSlidesClasses(), (!o && u.isBeginning || !l && u.isEnd) && u.updateSlidesClasses(), u.params.loop && u.loopFix({
                            direction: c.direction < 0 ? "next" : "prev",
                            byMousewheel: !0
                        }), u.params.freeMode.sticky) {
                            clearTimeout(h), h = void 0, 15 <= m.length && m.shift();
                            o = m.length ? m[m.length - 1] : void 0, l = m[0];
                            if (m.push(c), o && (c.delta > o.delta || c.direction !== o.direction)) m.splice(0); else if (15 <= m.length && c.time - l.time < 500 && 1 <= l.delta - c.delta && c.delta <= 6) {
                                const d = 0 < t ? .8 : .2;
                                f = c, m.splice(0), h = E(() => {
                            ...
                            h = h || E(() => {
                                f = c, m.splice(0), u.slideToClosest(u.params.speed, !0, void 0, .5)
                            }, 500)
                        }
                        if (a || p("scroll", r), u.params.autoplay && u.params.autoplayDisableOnInteraction && u.autoplay.stop(), s.releaseOnEdges && (e === u.minTranslate() || e === u.maxTranslate())) return !0
                    }
                } else {
                    o = {
                        time: v(),
                        ...
                        raw: n
                    }, l = (2 <= m.length && m.shift(), m.length ? m[m.length - 1] : void 0);
                    if (m.push(o), (!l || o.direction !== l.direction || o.delta > l.delta || o.time > l.time + 150) && g(o), function (e) {
        ...
        function l(e) {
            let t = u.el;
            (t = "container" !== u.params.mousewheel.eventsTarget ? document.querySelector(u.params.mousewheel.eventsTarget) : t)[e]("mouseenter", s), t[e]("mouseleave", a), t[e]("wheel", o)
        }
        ...
        function o(e) {
            let t;
            return !(e && "string" == typeof e && r.isElement && (t = r.el.querySelector(e))) && (e && ("string" == typeof e && (t = [...document.querySelectorAll(e)]), r.params.uniqueNavElements) && "string" == typeof e && 1 < t.length && 1 === r.el.querySelectorAll(e).length && (t = r.el.querySelector(e)), e) && !t ? e : t
        }

        function n(e, t) {
            const i = r.params.navigation;
            (e = a(e)).forEach(e => {
                e && (e.classList[t ? "add" : "remove"](...i.disabledClass.split(" ")), "BUTTON" === e.tagName && (e.disabled = t), r.params.watchOverflow) && r.enabled && e.classList[r.isLocked ? "add" : "remove"](i.lockClass)
            })
        }

        function l() {
            var {nextEl: e, prevEl: t} = r.navigation;
            r.params.loop ? (n(t, !1), n(e, !1)) : (n(t, r.isBeginning && !r.params.rewind), n(e, r.isEnd && !r.params.rewind))
        }
        ...
        function u() {
            ...
            if (r.params.navigation = z(r, r.originalParams.navigation, r.params.navigation, {
                ...
                Object.assign(r.navigation, {nextEl: e, prevEl: t}), e = a(e), t = a(t);
                const n = (e, t) => {
                    e && e.addEventListener("click", "next" === t ? d : c), !r.enabled && e && e.classList.add(...i.lockClass.split(" "))
                };
        ...
        function p() {
            var {nextEl: e, prevEl: t} = r.navigation, e = a(e), t = a(t);
            const i = (e, t) => {
                e.removeEventListener("click", "next" === t ? d : c), e.classList.remove(...r.params.navigation.disabledClass.split(" "))
            };
        ...
        i("init", () => {
            ...
            var {nextEl: i, prevEl: n} = r.navigation, i = a(i), n = a(n), t = t.target;
            if (r.params.navigation.hideOnClick && !n.includes(t) && !i.includes(t) && (!(r.pagination && r.params.pagination && r.params.pagination.clickable) || r.pagination.el !== t && !r.pagination.el.contains(t))) {
                let e;
                i.length ? e = i[0].classList.contains(r.params.navigation.hiddenClass) : n.length && (e = n[0].classList.contains(r.params.navigation.hiddenClass)), !0 === e ? s("navigationShow") : s("navigationHide"), [...i, ...n].filter(e => !!e).forEach(e => e.classList.toggle(r.params.navigation.hiddenClass))
            }
        });
        const h = () => {
        ...
        Object.assign(r.navigation, {
            enable: () => {
                r.el.classList.remove(...r.params.navigation.navigationDisabledClass.split(" ")), u(), l()
            }, disable: h, update: l, init: u, destroy: p
        })
    }, function (e) {
        ...
        function n(e) {
            ...
            t && (e.preventDefault(), e = M(t) * f.params.slidesPerGroup, f.params.loop ? f.realIndex !== e && f.slideToLoop(e) : f.slideTo(e))
        }
        ...
        function r() {
            ...
            if (!s()) {
                ...
                if (f.params.loop ? (t = f.previousRealIndex || 0, s = 1 < f.params.slidesPerGroup ? Math.floor(f.realIndex / f.params.slidesPerGroup) : f.realIndex) : void 0 !== f.snapIndex ? (s = f.snapIndex, t = f.previousSnapIndex) : (t = f.previousIndex || 0, s = f.activeIndex || 0), "bullets" === a.type && f.pagination.bullets && 0 < f.pagination.bullets.length) {
                    var c = f.pagination.bullets;
                    let i, n, e;
                    if (a.dynamicBullets && (g = X(c[0], f.isHorizontal() ? "width" : "height", !0), o.forEach(e => {
                        e.style[f.isHorizontal() ? "width" : "height"] = g * (a.dynamicMainBullets + 4) + "px"
                    }), 1 < a.dynamicMainBullets && void 0 !== t && ((v += s - (t || 0)) > a.dynamicMainBullets - 1 ? v = a.dynamicMainBullets - 1 : v < 0 && (v = 0)), i = Math.max(s - v, 0), n = i + (Math.min(c.length, a.dynamicMainBullets) - 1), e = (n + i) / 2), c.forEach(e => {
                        var t = [...["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map(e => "" + a.bulletActiveClass + e)].map(e => "string" == typeof e && e.includes(" ") ? e.split(" ") : e).flat();
                        e.classList.remove(...t)
                    }), 1 < o.length) c.forEach(e => {
                        var t = M(e);
                        t === s ? e.classList.add(...a.bulletActiveClass.split(" ")) : f.isElement && e.setAttribute("part", "bullet"), a.dynamicBullets && (t >= i && t <= n && e.classList.add(...(a.bulletActiveClass + "-main").split(" ")), t === i && b(e, "prev"), t === n) && b(e, "next")
                    }); else {
                        l = c[s];
                        if (l && l.classList.add(...a.bulletActiveClass.split(" ")), f.isElement && c.forEach((e, t) => {
                    ...
                    if (a.dynamicBullets) {
                        ...
                        const p = (g * l - g) / 2 - e * g, h = r ? "right" : "left";
                        c.forEach(e => {
                ...
                o.forEach((n, e) => {
                    if ("fraction" === a.type && (n.querySelectorAll(D(a.currentClass)).forEach(e => {
                        ...
                        var r = (s + 1) / u;
                        let t = 1, i = 1;
                        "horizontal" === e ? t = r : i = r, n.querySelectorAll(D(a.progressbarFillClass)).forEach(e => {
                            e.style.transform = `translate3d(0,0,0) scaleX(${t}) scaleY(${i})`, e.style.transitionDuration = f.params.speed + "ms"
                        })
                    }
                    "custom" === a.type && a.renderCustom ? (n.innerHTML = a.renderCustom(f, s + 1, u), 0 === e && m("paginationRender", n)) : (0 === e && m("paginationRender", n), m("paginationUpdate", n)), f.params.watchOverflow && f.enabled && n.classList[f.isLocked ? "add" : "remove"](a.lockClass)
                })
            }
        }
        ...
        function a() {
            ...
            if (!s()) {
                ...
                if ("bullets" === n.type) {
                    ...
                    for (let e = 0; e < t; e += 1) n.renderBullet ? i += n.renderBullet.call(f, e, n.bulletClass) : i += `<${n.bulletElement} ${f.isElement ? 'part="bullet"' : ""} class="${n.bulletClass}"></${n.bulletElement}>`
                }
                "fraction" === n.type && (i = n.renderFraction ? n.renderFraction.call(f, n.currentClass, n.totalClass) : `<span class="${n.currentClass}"></span>` + " / " + `<span class="${n.totalClass}"></span>`), "progressbar" === n.type && (i = n.renderProgressbar ? n.renderProgressbar.call(f, n.progressbarFillClass) : `<span class="${n.progressbarFillClass}"></span>`), f.pagination.bullets = [], t.forEach(e => {
                    "custom" !== n.type && (e.innerHTML = i || ""), "bullets" === n.type && f.pagination.bullets.push(...e.querySelectorAll(D(n.bulletClass)))
                }), "custom" !== n.type && m("paginationRender", t[0])
            }
        }

        function o() {
            f.params.pagination = z(f, f.originalParams.pagination, f.params.pagination, {el: "swiper-pagination"});
            const t = f.params.pagination;
            if (t.el) {
                let e;
                (e = (e = (e = "string" == typeof t.el && f.isElement ? f.el.querySelector(t.el) : e) || "string" != typeof t.el ? e : [...document.querySelectorAll(t.el)]) || t.el) && 0 !== e.length && (f.params.uniqueNavElements && "string" == typeof t.el && Array.isArray(e) && 1 < e.length && 1 < (e = [...f.el.querySelectorAll(t.el)]).length && (e = e.filter(e => P(e, ".swiper")[0] === f.el)[0]), Array.isArray(e) && 1 === e.length && (e = e[0]), Object.assign(f.pagination, {el: e}), (e = y(e)).forEach(e => {
                    "bullets" === t.type && t.clickable && e.classList.add(...(t.clickableClass || "").split(" ")), e.classList.add(t.modifierClass + t.type), e.classList.add(f.isHorizontal() ? t.horizontalClass : t.verticalClass), "bullets" === t.type && t.dynamicBullets && (e.classList.add("" + t.modifierClass + t.type + "-dynamic"), v = 0, t.dynamicMainBullets < 1) && (t.dynamicMainBullets = 1), "progressbar" === t.type && t.progressbarOpposite && e.classList.add(t.progressbarOppositeClass), t.clickable && e.addEventListener("click", n), f.enabled || e.classList.add(t.lockClass)
                }))
            }
        }
        ...
        function l() {
            ...
            s() || ((e = f.pagination.el) && (e = y(e)).forEach(e => {
                e.classList.remove(t.hiddenClass), e.classList.remove(t.modifierClass + t.type), e.classList.remove(f.isHorizontal() ? t.horizontalClass : t.verticalClass), t.clickable && (e.classList.remove(...(t.clickableClass || "").split(" ")), e.removeEventListener("click", n))
        ...
        i("changeDirection", () => {
            if (f.pagination && f.pagination.el) {
                ...
                (e = y(e)).forEach(e => {
                    e.classList.remove(t.horizontalClass, t.verticalClass), e.classList.add(f.isHorizontal() ? t.horizontalClass : t.verticalClass)
                })
            }
        }), i("init", () => {
            ...
            var t = t.target, i = y(f.pagination.el);
        ...
        const c = () => {
            ...
            var e = f.pagination["el"];
            e && (e = y(e)).forEach(e => e.classList.add(f.params.pagination.paginationDisabledClass)), l()
        };
        Object.assign(f.pagination, {
            enable: () => {
                f.el.classList.remove(f.params.pagination.paginationDisabledClass);
                var e = f.pagination["el"];
                e && (e = y(e)).forEach(e => e.classList.remove(f.params.pagination.paginationDisabledClass)), o(), a(), r()
            }, disable: c, render: a, update: r, init: o, destroy: l
        })
    }, function (e) {
        ...
        function r() {
            if (o.params.scrollbar.el && o.scrollbar.el) {
                ...
                var i = o.params.scrollbar, r = o.params.loop ? o.progressLoop : o.progress;
                let e = p, t = (h - p) * r;
                n ? 0 < (t = -t) ? (e = p - t, t = 0) : -t + p > h && (e = h + t) : t < 0 ? (e = p + t, t = 0) : t + p > h && (e = h - t), o.isHorizontal() ? (s.style.transform = `translate3d(${t}px, 0, 0)`, s.style.width = e + "px") : (s.style.transform = `translate3d(0px, ${t}px, 0)`, s.style.height = e + "px"), i.hide && (clearTimeout(c), a.style.opacity = 1, c = setTimeout(() => {
        ...
        function f() {
            ...
            o.params.scrollbar.el && o.scrollbar.el && (e = o["scrollbar"], {
                dragEl: t,
                el: i
            } = e, t.style.width = "", t.style.height = "", h = o.isHorizontal() ? i.offsetWidth : i.offsetHeight, n = o.size / (o.virtualSize + o.params.slidesOffsetBefore - (o.params.centeredSlides ? o.snapGrid[0] : 0)), p = "auto" === o.params.scrollbar.dragSize ? h * n : parseInt(o.params.scrollbar.dragSize, 10), o.isHorizontal() ? t.style.width = p + "px" : t.style.height = p + "px", 1 <= n ? i.style.display = "none" : i.style.display = "", o.params.scrollbar.hide && (i.style.opacity = 0), o.params.watchOverflow) && o.enabled && e.el.classList[o.isLocked ? "add" : "remove"](o.params.scrollbar.lockClass)
        }
        ...
        function g(e) {
            ...
            let n;
            n = (m(e) - L(t)[o.isHorizontal() ? "left" : "top"] - (null !== u ? u : p / 2)) / (h - p), n = Math.max(Math.min(n, 1), 0), i && (n = 1 - n);
        ...
        function v(e) {
            var t = o.params.scrollbar, {scrollbar: i, wrapperEl: n} = o, {el: i, dragEl: r} = i;
            l = !0, u = e.target === r ? m(e) - e.target.getBoundingClientRect()[o.isHorizontal() ? "left" : "top"] : null, e.preventDefault(), e.stopPropagation(), n.style.transitionDuration = "100ms", r.style.transitionDuration = "100ms", g(e), clearTimeout(d), i.style.transitionDuration = "0ms", t.hide && (i.style.opacity = 1), o.params.cssMode && (o.wrapperEl.style["scroll-snap-type"] = "none"), s("scrollbarDragStart", e)
        }

        function y(e) {
            var {scrollbar: t, wrapperEl: i} = o, {el: t, dragEl: n} = t;
            l && (e.preventDefault ? e.preventDefault() : e.returnValue = !1, g(e), i.style.transitionDuration = "0ms", t.style.transitionDuration = "0ms", n.style.transitionDuration = "0ms", s("scrollbarDragMove", e))
        }

        function b(e) {
            var t = o.params.scrollbar, {scrollbar: i, wrapperEl: n} = o;
            const r = i["el"];
            l && (l = !1, o.params.cssMode && (o.wrapperEl.style["scroll-snap-type"] = "", n.style.transitionDuration = ""), t.hide && (clearTimeout(d), d = E(() => {
        ...
        function _(e) {
            ...
            i && (t = !!n.passiveListeners && {passive: !1, capture: !1}, n = !!n.passiveListeners && {
                passive: !0,
                capture: !1
            }, i = i) && (i[i = "on" === e ? "addEventListener" : "removeEventListener"]("pointerdown", v, t), a[i]("pointermove", y, t), a[i]("pointerup", b, n))
        }

        function w() {
            var {scrollbar: i, el: n} = o,
                r = (o.params.scrollbar = z(o, o.originalParams.scrollbar, o.params.scrollbar, {el: "swiper-scrollbar"}), o.params.scrollbar);
            if (r.el) {
                let e;
                if ((e = "string" == typeof r.el && o.isElement ? o.el.querySelector(r.el) : e) || "string" != typeof r.el) e = e || r.el; else if (!(e = a.querySelectorAll(r.el)).length) return;
                ...
                let t;
                !e || (t = e.querySelector(D(o.params.scrollbar.dragClass))) || (t = C("div", o.params.scrollbar.dragClass), e.append(t)), Object.assign(i, {
                    el: e,
                    dragEl: t
                }), r.draggable && o.params.scrollbar.el && o.scrollbar.el && _("on"), e && e.classList[o.enabled ? "remove" : "add"](...S(o.params.scrollbar.lockClass))
            }
        }

        function x() {
            var e = o.params.scrollbar, t = o.scrollbar.el;
            t && t.classList.remove(...S(o.isHorizontal() ? e.horizontalClass : e.verticalClass)), o.params.scrollbar.el && o.scrollbar.el && _("off")
        }
        ...
        }), o.scrollbar = {el: null, dragEl: null}, i("init", () => {
        ...
        const T = () => {
            o.el.classList.add(...S(o.params.scrollbar.scrollbarDisabledClass)), o.scrollbar.el && o.scrollbar.el.classList.add(...S(o.params.scrollbar.scrollbarDisabledClass)), x()
        };
        Object.assign(o.scrollbar, {
            enable: () => {
                o.el.classList.remove(...S(o.params.scrollbar.scrollbarDisabledClass)), o.scrollbar.el && o.scrollbar.el.classList.remove(...S(o.params.scrollbar.scrollbarDisabledClass)), w(), f(), r()
            }, disable: T, updateSize: f, setTranslate: r, init: w, destroy: x
        })
    }, function (e) {
        ...
        const s = "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]",
            a = (e, t) => {
                var i = d["rtl"], i = i ? -1 : 1, n = e.getAttribute("data-swiper-parallax") || "0";
                let r = e.getAttribute("data-swiper-parallax-x"), s = e.getAttribute("data-swiper-parallax-y");
                ...
                r || s ? (r = r || "0", s = s || "0") : d.isHorizontal() ? (r = n, s = "0") : (s = n, r = "0"), r = 0 <= r.indexOf("%") ? parseInt(r, 10) * t * i + "%" : r * t * i + "px", s = 0 <= s.indexOf("%") ? parseInt(s, 10) * t + "%" : s * t + "px", null != o && (n = o - (o - 1) * (1 - Math.abs(t)), e.style.opacity = n);
                let c = `translate3d(${r}, ${s}, 0px)`;
                null != a && (i = a - (a - 1) * (1 - Math.abs(t)), c += ` scale(${i})`), l && null != l && (c += ` rotate(${l * t * -1}deg)`), e.style.transform = c
            }, n = () => {
                const {el: e, slides: t, progress: n, snapGrid: r} = d;
                var i = Y(e, s);
                d.isElement && i.push(...Y(d.hostEl, s)), i.forEach(e => {
                    a(e, n)
                }), t.forEach((e, t) => {
                    let i = e.progress;
                    1 < d.params.slidesPerGroup && "auto" !== d.params.slidesPerView && (i += Math.ceil(t / 2) - n * (r.length - 1)), i = Math.min(Math.max(i, -1), 1), e.querySelectorAll(s + ", [data-swiper-parallax-rotate]").forEach(e => {
                        a(e, i)
                    })
                })
            };
        i("beforeInit", () => {
            ...
            d.params.parallax.enabled && ({
                el: t,
                hostEl: n
            } = (void 0 === (i = t) && (i = d.params.speed), d), t = [...t.querySelectorAll(s)], d.isElement && t.push(...n.querySelectorAll(s)), t.forEach(e => {
        ...
        function d() {
            var e, t, i, n;
            return o.length < 2 ? 1 : (e = o[0].pageX, t = o[0].pageY, i = o[1].pageX, n = o[1].pageY, Math.sqrt((i - e) ** 2 + (n - t) ** 2))
        }
            ...
            if ("mouse" === t.pointerType && o.splice(0, o.length), u(t)) {
                ...
                if (r = !1, a = !1, o.push(t), !(o.length < 2)) {
                    if (r = !0, m.scaleStart = d(), !m.slideEl) {
                        m.slideEl = t.target.closest(`.${p.params.slideClass}, swiper-slide`), m.slideEl || (m.slideEl = p.slides[p.activeIndex]);
                        let e = m.slideEl.querySelector("." + i.containerClass);
                        if (e = e && e.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0], (m.imageEl = e) ? m.imageWrapEl = P(m.imageEl, "." + i.containerClass)[0] : m.imageWrapEl = void 0, !m.imageWrapEl) return void (m.imageEl = void 0);
                        m.maxRatio = m.imageWrapEl.getAttribute("data-swiper-zoom") || i.maxRatio
                    }
                    m.imageEl && ([i, t] = o.length < 2 ? {
                        x: null,
                        y: null
                    } : (t = m.imageEl.getBoundingClientRect(), [(o[0].pageX + (o[1].pageX - o[0].pageX) / 2 - t.x - h.scrollX) / f, (o[0].pageY + (o[1].pageY - o[0].pageY) / 2 - t.y - h.scrollY) / f]), m.originX = i, m.originY = t, m.imageEl.style.transitionDuration = "0ms"), s = !0
                }
            }
        }
        ...
        function y(t) {
            var e, i, n;
            u(t) && (e = p.params.zoom, i = p.zoom, 0 <= (n = o.findIndex(e => e.pointerId === t.pointerId)) && (o[n] = t), o.length < 2 || (a = !0, m.scaleMove = d(), m.imageEl && (i.scale = m.scaleMove / m.scaleStart * f, i.scale > m.maxRatio && (i.scale = m.maxRatio - 1 + (i.scale - m.maxRatio + 1) ** .5), i.scale < e.minRatio && (i.scale = e.minRatio + 1 - (e.minRatio - i.scale + 1) ** .5), m.imageEl.style.transform = `translate3d(0,0,0) scale(${i.scale})`)))
        }

        function b(t) {
            var e, i, n;
            !u(t) || "mouse" === t.pointerType && "pointerout" === t.type || (e = p.params.zoom, i = p.zoom, 0 <= (n = o.findIndex(e => e.pointerId === t.pointerId)) && o.splice(n, 1), r && a && (r = !1, a = !1, m.imageEl) && (i.scale = Math.max(Math.min(i.scale, m.maxRatio), e.minRatio), m.imageEl.style.transitionDuration = p.params.speed + "ms", m.imageEl.style.transform = `translate3d(0,0,0) scale(${i.scale})`, f = i.scale, s = !1, 1 < i.scale && m.slideEl ? m.slideEl.classList.add("" + e.zoomedSlideClass) : i.scale <= 1 && m.slideEl && m.slideEl.classList.remove("" + e.zoomedSlideClass), 1 === i.scale) && (m.originX = 0, m.originY = 0, m.slideEl = void 0))
        }
        ...
        function _(e) {
            if (u(e) && (t = e, i = "." + p.params.zoom.containerClass, t.target.matches(i) || 0 < [...p.hostEl.querySelectorAll(i)].filter(e => e.contains(t.target)).length)) {
                ...
                if (m.imageEl && g.isTouched && m.slideEl) {
                    g.isMoved || (g.width = m.imageEl.offsetWidth, g.height = m.imageEl.offsetHeight, g.startX = I(m.imageWrapEl, "x") || 0, g.startY = I(m.imageWrapEl, "y") || 0, m.slideWidth = m.slideEl.offsetWidth, m.slideHeight = m.slideEl.offsetHeight, m.imageWrapEl.style.transitionDuration = "0ms");
                    var n = g.width * i.scale, r = g.height * i.scale;
                    if (!(n < m.slideWidth && r < m.slideHeight)) {
                        if (g.minX = Math.min(m.slideWidth / 2 - n / 2, 0), g.maxX = -g.minX, g.minY = Math.min(m.slideHeight / 2 - r / 2, 0), g.maxY = -g.minY, g.touchesCurrent.x = (0 < o.length ? o[0] : e).pageX, g.touchesCurrent.y = (0 < o.length ? o[0] : e).pageY, 5 < Math.max(Math.abs(g.touchesCurrent.x - g.touchesStart.x), Math.abs(g.touchesCurrent.y - g.touchesStart.y)) && (p.allowClick = !1), !g.isMoved && !s) {
                        ...
                        var n = (i.scale - f) / (m.maxRatio - p.params.zoom.minRatio), {originX: r, originY: e} = m;
                        g.currentX = g.touchesCurrent.x - g.touchesStart.x + g.startX + n * (g.width - 2 * r), g.currentY = g.touchesCurrent.y - g.touchesStart.y + g.startY + n * (g.height - 2 * e), g.currentX < g.minX && (g.currentX = g.minX + 1 - (g.minX - g.currentX + 1) ** .8), g.currentX > g.maxX && (g.currentX = g.maxX - 1 + (g.currentX - g.maxX + 1) ** .8), g.currentY < g.minY && (g.currentY = g.minY + 1 - (g.minY - g.currentY + 1) ** .8), g.currentY > g.maxY && (g.currentY = g.maxY - 1 + (g.currentY - g.maxY + 1) ** .8), l.prevPositionX || (l.prevPositionX = g.touchesCurrent.x), l.prevPositionY || (l.prevPositionY = g.touchesCurrent.y), l.prevTime || (l.prevTime = Date.now()), l.x = (g.touchesCurrent.x - l.prevPositionX) / (Date.now() - l.prevTime) / 2, l.y = (g.touchesCurrent.y - l.prevPositionY) / (Date.now() - l.prevTime) / 2, Math.abs(g.touchesCurrent.x - l.prevPositionX) < 2 && (l.x = 0), Math.abs(g.touchesCurrent.y - l.prevPositionY) < 2 && (l.y = 0), l.prevPositionX = g.touchesCurrent.x, l.prevPositionY = g.touchesCurrent.y, l.prevTime = Date.now(), m.imageWrapEl.style.transform = `translate3d(${g.currentX}px, ${g.currentY}px,0)`
                    }
                }
            }
        }
        ...
        function w() {
            var e = p.zoom;
            m.slideEl && p.activeIndex !== p.slides.indexOf(m.slideEl) && (m.imageEl && (m.imageEl.style.transform = "translate3d(0,0,0) scale(1)"), m.imageWrapEl && (m.imageWrapEl.style.transform = "translate3d(0,0,0)"), m.slideEl.classList.remove("" + p.params.zoom.zoomedSlideClass), e.scale = 1, f = 1, m.slideEl = void 0, m.imageEl = void 0, m.imageWrapEl = void 0, m.originX = 0, m.originY = 0)
        }

        function x(r) {
            var s, a, o, l, c = p.zoom, d = p.params.zoom;
            if (!m.slideEl) {
                r && r.target && (m.slideEl = r.target.closest(`.${p.params.slideClass}, swiper-slide`)), m.slideEl || (p.params.virtual && p.params.virtual.enabled && p.virtual ? m.slideEl = Y(p.slidesEl, "." + p.params.slideActiveClass)[0] : m.slideEl = p.slides[p.activeIndex]);
                let e = m.slideEl.querySelector("." + d.containerClass);
                e = e && e.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0], (m.imageEl = e) ? m.imageWrapEl = P(m.imageEl, "." + d.containerClass)[0] : m.imageWrapEl = void 0
            }
            if (m.imageEl && m.imageWrapEl) {
                p.params.cssMode && (p.wrapperEl.style.overflow = "hidden", p.wrapperEl.style.touchAction = "none"), m.slideEl.classList.add("" + d.zoomedSlideClass);
                let e, t;
                let i, n;
                t = void 0 === g.touchesStart.x && r ? (e = r.pageX, r.pageY) : (e = g.touchesStart.x, g.touchesStart.y);
                var u = "number" == typeof r ? r : null;
                1 === f && u && (e = void 0, t = void 0), c.scale = u || m.imageWrapEl.getAttribute("data-swiper-zoom") || d.maxRatio, f = u || m.imageWrapEl.getAttribute("data-swiper-zoom") || d.maxRatio, !r || 1 === f && u ? (i = 0, n = 0) : (d = m.slideEl.offsetWidth, r = m.slideEl.offsetHeight, s = L(m.slideEl).left + h.scrollX, a = L(m.slideEl).top + h.scrollY, s = s + d / 2 - e, a = a + r / 2 - t, o = m.imageEl.offsetWidth, l = m.imageEl.offsetHeight, o = o * c.scale, l = l * c.scale, o = -(d = Math.min(d / 2 - o / 2, 0)), l = -(r = Math.min(r / 2 - l / 2, 0)), i = s * c.scale, n = a * c.scale, (i = i < d ? d : i) > o && (i = o), (n = n < r ? r : n) > l && (n = l)), u && 1 === c.scale && (m.originX = 0, m.originY = 0), m.imageWrapEl.style.transitionDuration = "300ms", m.imageWrapEl.style.transform = `translate3d(${i}px, ${n}px,0)`, m.imageEl.style.transitionDuration = "300ms", m.imageEl.style.transform = `translate3d(0,0,0) scale(${c.scale})`
            }
        }
        ...
        function T() {
            ...
            if (!m.slideEl) {
                ...
                e = e && e.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0], (m.imageEl = e) ? m.imageWrapEl = P(m.imageEl, "." + t.containerClass)[0] : m.imageWrapEl = void 0
            }
            m.imageEl && m.imageWrapEl && (p.params.cssMode && (p.wrapperEl.style.overflow = "", p.wrapperEl.style.touchAction = ""), e.scale = 1, f = 1, m.imageWrapEl.style.transitionDuration = "300ms", m.imageWrapEl.style.transform = "translate3d(0,0,0)", m.imageEl.style.transitionDuration = "300ms", m.imageEl.style.transform = "translate3d(0,0,0) scale(1)", m.slideEl.classList.remove("" + t.zoomedSlideClass), m.slideEl = void 0, m.originX = 0, m.originY = 0)
        }
        ...
        function E() {
            return {
                passiveListener: !!p.params.passiveListeners && {passive: !0, capture: !1},
                activeListenerWithCapture: !p.params.passiveListeners || {passive: !1, capture: !0}
            }
        }
        ...
        function C() {
            ...
            if (!e.enabled) {
                ...
                p.wrapperEl.addEventListener("pointerdown", v, t), p.wrapperEl.addEventListener("pointermove", y, i), ["pointerup", "pointercancel", "pointerout"].forEach(e => {
        ...
        function M() {
            ...
            if (e.enabled) {
                e.enabled = !1;
                const {passiveListener: t, activeListenerWithCapture: i} = E();
                p.wrapperEl.removeEventListener("pointerdown", v, t), p.wrapperEl.removeEventListener("pointermove", y, i), ["pointerup", "pointercancel", "pointerout"].forEach(e => {
        ...
        Object.defineProperty(p.zoom, "scale", {
            get() {
                ...
                var t, i;
                c !== e && (t = m.imageEl, i = m.slideEl, n("zoomChange", e, t, i)), c = e
            }
        }), i("init", () => {
            ...
            var i;
            p.zoom.enabled && (t = t, i = p.device, m.imageEl) && !g.isTouched && (i.android && t.cancelable && t.preventDefault(), g.isTouched = !0, i = 0 < o.length ? o[0] : t, g.touchesStart.x = i.pageX, g.touchesStart.y = i.pageY)
        }), i("touchEnd", (e, t) => {
            if (p.zoom.enabled) {
                var i = p.zoom;
                if (m.imageEl) if (g.isTouched && g.isMoved) {
                    g.isTouched = !1, g.isMoved = !1;
                    let e = 300, t = 300;
                    var n = l.x * e, n = g.currentX + n, r = l.y * t, r = g.currentY + r,
                        s = (0 !== l.x && (e = Math.abs((n - g.currentX) / l.x)), 0 !== l.y && (t = Math.abs((r - g.currentY) / l.y)), Math.max(e, t)),
                        n = (g.currentX = n, g.currentY = r, g.width * i.scale), r = g.height * i.scale;
                    g.minX = Math.min(m.slideWidth / 2 - n / 2, 0), g.maxX = -g.minX, g.minY = Math.min(m.slideHeight / 2 - r / 2, 0), g.maxY = -g.minY, g.currentX = Math.max(Math.min(g.currentX, g.maxX), g.minX), g.currentY = Math.max(Math.min(g.currentY, g.maxY), g.minY), m.imageWrapEl.style.transitionDuration = s + "ms", m.imageWrapEl.style.transform = `translate3d(${g.currentX}px, ${g.currentY}px,0)`
        ...
        }), Object.assign(p.zoom, {enable: C, disable: M, in: x, out: T, toggle: S})
    }, function (e) {
        ...
        t({
            ...
            setTranslate: function (e, t) {
                ...
                function a(e) {
                    var t, i;
                    e.destroyed || (t = o.rtlTranslate ? -o.translate : o.translate, "slide" === o.params.controller.by && (i = e, o.controller.spline = o.params.loop ? new l(o.slidesGrid, i.slidesGrid) : new l(o.snapGrid, i.snapGrid), r = -o.controller.spline.interpolate(-t)), r && "container" !== o.params.controller.by || (n = (e.maxTranslate() - e.minTranslate()) / (o.maxTranslate() - o.minTranslate()), !Number.isNaN(n) && Number.isFinite(n) || (n = 1), r = (t - o.minTranslate()) * n + e.minTranslate()), o.params.controller.inverse && (r = e.maxTranslate() - r), e.updateProgress(r), e.setTranslate(r, o), e.updateActiveIndex(), e.updateSlidesClasses())
                }

                if (Array.isArray(i)) for (let e = 0; e < i.length; e += 1) i[e] !== t && i[e] instanceof s && a(i[e]); else i instanceof s && t !== i && a(i)
                ...
                function s(e) {
                    e.destroyed || (e.setTransition(t, o), 0 !== t && (e.transitionStart(), e.params.autoHeight && E(() => {
                        e.updateAutoHeight()
                    }), g(e.wrapperEl, () => {
                        n && e.transitionEnd()
                    })))
                ...
                if (Array.isArray(n)) for (r = 0; r < n.length; r += 1) n[r] !== e && n[r] instanceof i && s(n[r]); else n instanceof i && e !== n && s(n)
            }
        })
    }, function (e) {
        let {swiper: o, extendParams: t, on: i} = e, l = (t({
            a11y: {
                enabled: !0,
        ...
        function f(e) {
            var t, i;
            13 !== e.keyCode && 32 !== e.keyCode || (t = o.params.a11y, i = e.target, o.pagination && o.pagination.el && (i === o.pagination.el || o.pagination.el.contains(e.target)) && !e.target.matches(D(o.params.pagination.bulletClass))) || (o.navigation && o.navigation.nextEl && i === o.navigation.nextEl && (o.isEnd && !o.params.loop || o.slideNext(), o.isEnd ? n(t.lastSlideMessage) : n(t.nextSlideMessage)), o.navigation && o.navigation.prevEl && i === o.navigation.prevEl && (o.isBeginning && !o.params.loop || o.slidePrev(), o.isBeginning ? n(t.firstSlideMessage) : n(t.prevSlideMessage)), o.pagination && i.matches(D(o.params.pagination.bulletClass)) && i.click())
        }
        ...
        const v = (e, t, i) => {
            var n;
            r(e), "BUTTON" !== e.tagName && (a(e, "button"), e.addEventListener("keydown", f)), u(e, i), i = e, n = t, (i = c(i)).forEach(e => {
            ...
            const i = o.params.a11y,
                n = (i.itemRoleDescriptionMessage && d(o.slides, i.itemRoleDescriptionMessage), i.slideRole && a(o.slides, i.slideRole), o.slides.length);
            ...
            o.el.append(l);
            var e = o.el,
                e = (t.containerRoleDescriptionMessage && d(e, t.containerRoleDescriptionMessage), t.containerMessage && u(e, t.containerMessage), o.wrapperEl);
            ...
            var n, r, s = o.params.autoplay && o.params.autoplay.enabled ? "off" : "polite", {
                nextEl: e,
                prevEl: a
            } = (a = e, n = i, (a = c(a)).forEach(e => {
                e.setAttribute("id", n)
            }), a = e, r = s, (a = c(a)).forEach(e => {
                e.setAttribute("aria-live", r)
            }), w(), o.navigation || {}), e = c(e), a = c(a);
            e && e.forEach(e => v(e, i, t.nextSlideMessage)), a && a.forEach(e => v(e, i, t.prevSlideMessage)), g() && c(o.pagination.el).forEach(e => {
                e.addEventListener("keydown", f)
            }), o.el.addEventListener("focus", _, !0), o.el.addEventListener("pointerdown", y, !0), o.el.addEventListener("pointerup", b, !0)
        };
        i("beforeInit", () => {
            (l = C("span", o.params.a11y.notificationClass)).setAttribute("aria-live", "assertive"), l.setAttribute("aria-atomic", "true")
        }), i("afterInit", () => {
            ...
            o.params.a11y.enabled && !o.params.loop && !o.params.rewind && o.navigation && ({
                nextEl: e,
                prevEl: t
            } = o.navigation, t && (o.isBeginning ? (p(t), s) : (h(t), r))(t), e) && (o.isEnd ? (p(e), s) : (h(e), r))(e)
        }), i("paginationUpdate", () => {
            if (o.params.a11y.enabled) {
                const t = o.params.a11y;
                m() && o.pagination.bullets.forEach(e => {
                    o.params.pagination.clickable && (r(e), o.params.pagination.renderBullet || (a(e, "button"), u(e, t.paginationBulletMessage.replace(/\{\{index\}\}/, M(e) + 1)))), e.matches(D(o.params.pagination.bulletActiveClass)) ? e.setAttribute("aria-current", "true") : e.removeAttribute("aria-current")
                })
            }
        }), i("destroy", () => {
            var e, t;
            o.params.a11y.enabled && (l && l.remove(), {
                nextEl: e,
                prevEl: t
            } = o.navigation || {}, e = c(e), t = c(t), e && e.forEach(e => e.removeEventListener("keydown", f)), t && t.forEach(e => e.removeEventListener("keydown", f)), g() && c(o.pagination.el).forEach(e => {
                e.removeEventListener("keydown", f)
            }), o.el.removeEventListener("focus", _, !0), o.el.removeEventListener("pointerdown", y, !0), o.el.removeEventListener("pointerup", b, !0))
        })
    }, function (e) {
        let {swiper: a, extendParams: t, on: i} = e,
            s = (t({history: {enabled: !1, root: "", replaceState: !1, key: "slides", keepQuery: !1}}), !1), n = {};
        const o = e => e.toString().replace(/\s+/g, "-").replace(/[^\w-]+/g, "").replace(/--+/g, "-").replace(/^-+/, "").replace(/-+$/, ""),
            r = e => {
                ...
                if (s && a.params.history.enabled) {
                    ...
                    n = r.history.state;
                    n && n.value === t || (a.params.history.replaceState ? r.history.replaceState({value: t}, null, t) : r.history.pushState({value: t}, null, t))
                }
            }, c = (i, n, r) => {
                if (n) for (let e = 0, t = a.slides.length; e < t; e += 1) {
                    var s = a.slides[e];
                    o(s.getAttribute("data-history")) === n && (s = a.getSlideIndex(s), a.slideTo(s, i, r))
        ...
        i("init", () => {
            var e;
            a.params.history.enabled && (e = k(), a.params.history) && (e.history && e.history.pushState ? (s = !0, ((n = r(a.params.url)).key || n.value) && c(0, n.value, a.params.runCallbacksOnInit), a.params.history.replaceState || e.addEventListener("popstate", d)) : (a.params.history.enabled = !1, a.params.hashNavigation.enabled = !0))
        }), i("destroy", () => {
            var e;
            a.params.history.enabled && (e = k(), a.params.history.replaceState || e.removeEventListener("popstate", d))
        ...
        let {swiper: n, extendParams: t, emit: i, on: r} = e, s = !1;
        const a = A(), o = k(), l = (t({
            hashNavigation: {
            ...
            var e;
            s && n.params.hashNavigation.enabled && (e = (e = n.virtual && n.params.virtual.enabled ? n.slidesEl.querySelector(`[data-swiper-slide-index="${n.activeIndex}"]`) : n.slides[n.activeIndex]) ? e.getAttribute("data-hash") || e.getAttribute("data-history") : "", n.params.hashNavigation.replaceState && o.history && o.history.replaceState ? o.history.replaceState(null, null, "#" + e || "") : a.location.hash = e || "", i("hashSet"))
        };
        r("init", () => {
            var e;
            !n.params.hashNavigation.enabled || !n.params.hashNavigation.enabled || n.params.history && n.params.history.enabled || (s = !0, (e = a.location.hash.replace("#", "")) && (e = n.params.hashNavigation.getSlideIndex(n, e), n.slideTo(e || 0, 0, n.params.runCallbacksOnInit, !0)), n.params.hashNavigation.watchState && o.addEventListener("hashchange", l))
        }), r("destroy", () => {
        ...
        s.autoplay = {running: !1, paused: !1, timeLeft: 0}, t({
            autoplay: {
                enabled: !1,
                delay: 3e3,
                waitForTransition: !0,
        ...
        let o, l, c = n && n.autoplay ? n.autoplay.delay : 3e3, d = n && n.autoplay ? n.autoplay.delay : 3e3, u,
            p = (new Date).getTime(), r, h, f, m, g, v, y;

        function b(e) {
            !s || s.destroyed || !s.wrapperEl || e.target !== s.wrapperEl || (s.wrapperEl.removeEventListener("transitionend", b), y) || C()
        }

        const _ = () => {
            var e;
            !s.destroyed && s.autoplay.running && (s.autoplay.paused ? r = !0 : r && (d = u, r = !1), e = s.autoplay.paused ? u : p + d - (new Date).getTime(), s.autoplay.timeLeft = e, a("autoplayTimeLeft", e, e / c), l = requestAnimationFrame(() => {
                _()
            }))
        }, w = () => {
            let e;
            if (e = s.virtual && s.params.virtual.enabled ? s.slides.filter(e => e.classList.contains("swiper-slide-active"))[0] : s.slides[s.activeIndex]) return parseInt(e.getAttribute("data-swiper-autoplay"), 10)
        }, x = t => {
            if (!s.destroyed && s.autoplay.running) {
                ...
                var i = w();
                !Number.isNaN(i) && 0 < i && void 0 === t && (e = i, c = i, d = i), u = e;
                const n = s.params.speed, r = () => {
                    s && !s.destroyed && (s.params.autoplay.reverseDirection ? !s.isBeginning || s.params.loop || s.params.rewind ? (s.slidePrev(n, !0, !0), a("autoplay")) : s.params.autoplay.stopOnLastSlide || (s.slideTo(s.slides.length - 1, n, !0, !0), a("autoplay")) : !s.isEnd || s.params.loop || s.params.rewind ? (s.slideNext(n, !0, !0), a("autoplay")) : s.params.autoplay.stopOnLastSlide || (s.slideTo(0, n, !0, !0), a("autoplay")), s.params.cssMode) && (p = (new Date).getTime(), requestAnimationFrame(() => {
                        x()
                    }))
                };
            ...
            p = (new Date).getTime(), s.autoplay.running = !0, x(), a("autoplayStart")
        }, S = () => {
            s.autoplay.running = !1, clearTimeout(o), cancelAnimationFrame(l), a("autoplayStop")
        }, E = (e, t) => {
            !s.destroyed && s.autoplay.running && (clearTimeout(o), e || (v = !0), e = () => {
                a("autoplayPause"), s.params.autoplay.waitForTransition ? s.wrapperEl.addEventListener("transitionend", b) : C()
            }, s.autoplay.paused = !0, t ? (g && (u = s.params.autoplay.delay), g = !1, e()) : (t = u || s.params.autoplay.delay, u = t - ((new Date).getTime() - p), s.isEnd && u < 0 && !s.params.loop || (u < 0 && (u = 0), e())))
        }, C = () => {
            s.isEnd && u < 0 && !s.params.loop || s.destroyed || !s.autoplay.running || (p = (new Date).getTime(), v ? (v = !1, x(u)) : x(), s.autoplay.paused = !1, a("autoplayResume"))
        }, M = () => {
            var e;
            !s.destroyed && s.autoplay.running && ("hidden" === (e = A()).visibilityState && (v = !0, E(!0)), "visible" === e.visibilityState) && C()
        }, k = e => {
            "mouse" !== e.pointerType || (v = !0, y = !0, s.animating) || s.autoplay.paused || E(!0)
        }, I = e => {
            "mouse" === e.pointerType && (y = !1, s.autoplay.paused) && C()
        };
        i("init", () => {
            s.params.autoplay.enabled && (s.params.autoplay.pauseOnMouseEnter && (s.el.addEventListener("pointerenter", k), s.el.addEventListener("pointerleave", I)), A().addEventListener("visibilitychange", M), T())
        }), i("destroy", () => {
            s.el.removeEventListener("pointerenter", k), s.el.removeEventListener("pointerleave", I), A().removeEventListener("visibilitychange", M), s.autoplay.running && S()
            ...
            !s.destroyed && s.autoplay.running && (s.params.autoplay.disableOnInteraction ? S() : (h = !0, f = !1, v = !1, m = setTimeout(() => {
                v = !0, f = !0, E(!0)
            }, 200)))
        }), i("touchEnd", () => {
            !s.destroyed && s.autoplay.running && h && (clearTimeout(m), clearTimeout(o), h = (f = (s.params.autoplay.disableOnInteraction || f && s.params.cssMode && C(), !1), !1))
        }), i("slideChange", () => {
        ...
        function s() {
            ...
            if (t && !t.destroyed) {
                ...
                if (!(e && e.classList.contains(d.params.thumbs.slideThumbActiveClass) || null == i)) {
                    let e;
                    e = t.params.loop ? parseInt(t.clickedSlide.getAttribute("data-swiper-slide-index"), 10) : i, d.params.loop ? d.slideToLoop(e) : d.slideTo(e)
                }
            }
        }
        ...
        function a() {
            ...
            return e.swiper instanceof t ? (d.thumbs.swiper = e.swiper, Object.assign(d.thumbs.swiper.originalParams, {
                ...
                watchSlidesProgress: !0,
                slideToClickedSlide: !1
            }), d.thumbs.swiper.update()) : l(e.swiper) && (e = Object.assign({}, e.swiper), Object.assign(e, {
                watchSlidesProgress: !0,
                slideToClickedSlide: !1
            }), d.thumbs.swiper = new t(e), r = !0), d.thumbs.swiper.el.classList.add(d.params.thumbs.thumbsContainerClass), d.thumbs.swiper.on("tap", s), !0
        }
        ...
        function o(i) {
            ...
            if (n && !n.destroyed) {
                ...
                if (1 < d.params.slidesPerView && !d.params.centeredSlides && (t = d.params.slidesPerView), d.params.thumbs.multipleActiveThumbs || (t = 1), t = Math.floor(t), n.slides.forEach(e => e.classList.remove(c)), n.params.loop || n.params.virtual && n.params.virtual.enabled) for (let e = 0; e < t; e += 1) Y(n.slidesEl, `[data-swiper-slide-index="${d.realIndex + e}"]`).forEach(e => {
                    e.classList.add(c)
                }); else for (let e = 0; e < t; e += 1) n.slides[d.realIndex + e] && n.slides[d.realIndex + e].classList.add(c);
                var s = d.params.thumbs.autoScrollOffset, a = s && !n.params.loop;
                if (d.realIndex !== n.realIndex || a) {
                    var o, l = n.activeIndex;
                    let e, t;
                    t = n.params.loop ? (o = n.slides.filter(e => e.getAttribute("data-swiper-slide-index") === "" + d.realIndex)[0], e = n.slides.indexOf(o), d.activeIndex > d.previousIndex ? "next" : "prev") : (e = d.realIndex) > d.previousIndex ? "next" : "prev", a && (e += "next" === t ? s : -1 * s), n.visibleSlidesIndexes && n.visibleSlidesIndexes.indexOf(e) < 0 && (n.params.centeredSlides ? e = e > l ? e - Math.floor(r / 2) + 1 : e + Math.floor(r / 2) - 1 : e > l && n.params.slidesPerGroup, n.slideTo(e, i ? 0 : void 0))
                }
            }
        }
        ...
        d.thumbs = {swiper: null}, i("beforeInit", () => {
            ...
            if (n && n.swiper) if ("string" == typeof n.swiper || n.swiper instanceof HTMLElement) {
                const e = A(), t = () => {
                    const t = "string" == typeof n.swiper ? e.querySelector(n.swiper) : n.swiper;
                    if (t && t.swiper) n.swiper = t.swiper, a(), o(!0); else if (t) {
                        const i = e => {
                            n.swiper = e.detail[0], t.removeEventListener("init", i), a(), o(!0), n.swiper.update(), d.update()
                        };
                        t.addEventListener("init", i)
                    }
                    return t
        ...
        t({
            ...
            freeMode: {
                onTouchStart: function () {
                    var e;
                    h.params.cssMode || (e = h.getTranslate(), h.setTranslate(e), h.setTransition(0), h.touchEventsData.velocities.length = 0, h.freeMode.onTouchEnd({currentPos: h.rtl ? h.translate : -h.translate}))
                    ...
                    if (s = s.currentPos, !h.params.cssMode) {
                        ...
                        if (s < -h.minTranslate()) h.slideTo(h.activeIndex); else if (s > -h.maxTranslate()) h.slides.length < u.length ? h.slideTo(u.length - 1) : h.slideTo(h.slides.length - 1); else {
                            if (l.freeMode.momentum) {
                                (!(1 < p.velocities.length) || (s = p.velocities.pop(), o = p.velocities.pop(), a = s.position - o.position, o = s.time - o.time, h.velocity = a / o, h.velocity /= 2, Math.abs(h.velocity) < l.freeMode.minimumVelocity && (h.velocity = 0), 150 < o) || 300 < v() - s.time) && (h.velocity = 0), h.velocity *= l.freeMode.momentumVelocityRatio, p.velocities.length = 0;
                                let e = 1e3 * l.freeMode.momentumRatio;
                                var a = h.velocity * e;
                                let i = h.translate + a, t = (d && (i = -i), !1), n;
                                var o = 20 * Math.abs(h.velocity) * l.freeMode.momentumBounceRatio;
                                let r;
                                if (i < h.maxTranslate()) l.freeMode.momentumBounce ? (i + h.maxTranslate() < -o && (i = h.maxTranslate() - o), n = h.maxTranslate(), t = !0, p.allowMomentumBounce = !0) : i = h.maxTranslate(), l.loop && l.centeredSlides && (r = !0); else if (i > h.minTranslate()) l.freeMode.momentumBounce ? (i - h.minTranslate() > o && (i = h.minTranslate() + o), n = h.minTranslate(), t = !0, p.allowMomentumBounce = !0) : i = h.minTranslate(), l.loop && l.centeredSlides && (r = !0); else if (l.freeMode.sticky) {
                                    let t;
                                ...
                                if (r && m("transitionEnd", () => {
                                    h.loopFix()
                                }), 0 !== h.velocity) e = d ? Math.abs((-i - h.translate) / h.velocity) : Math.abs((i - h.translate) / h.velocity), l.freeMode.sticky && (s = Math.abs((d ? -i : i) - h.translate), a = h.slidesSizesGrid[h.activeIndex], e = s < a ? l.speed : s < 2 * a ? 1.5 * l.speed : 2.5 * l.speed); else if (l.freeMode.sticky) return void h.slideToClosest();
                                l.freeMode.momentumBounce && t ? (h.updateProgress(n), h.setTransition(e), h.setTranslate(i), h.transitionStart(!0, h.swipeDirection), h.animating = !0, g(c, () => {
                                    h && !h.destroyed && p.allowMomentumBounce && (f("momentumBounce"), h.setTransition(l.speed), setTimeout(() => {
                                        h.setTranslate(n), g(c, () => {
                                            h && !h.destroyed && h.transitionEnd()
                                        })
                                    }, 0))
                                })) : h.velocity ? (f("_freeModeNoMomentumRelease"), h.updateProgress(i), h.setTransition(e), h.setTranslate(i), h.transitionStart(!0, h.swipeDirection), h.animating || (h.animating = !0, g(c, () => {
                                    h && !h.destroyed && h.transitionEnd()
                            ...
                            (!l.freeMode.momentum || e >= l.longSwipesMs) && (f("_freeModeStaticRelease"), h.updateProgress(), h.updateActiveIndex(), h.updateSlidesClasses())
                        }
                    }
                }
            }
        ...
        const m = () => {
            ...
            return "string" == typeof e && 0 <= e.indexOf("%") ? e = parseFloat(e.replace("%", "")) / 100 * u.size : "string" == typeof e && (e = parseFloat(e)), e
        };
        i("init", () => {
            n = u.params.grid && 1 < u.params.grid.rows
        }), i("update", () => {
            var {params: e, el: t} = u, i = e.grid && 1 < e.grid.rows;
            n && !i ? (t.classList.remove(e.containerModifierClass + "grid", e.containerModifierClass + "grid-column"), f = 1, u.emitContainerClasses()) : !n && i && (t.classList.add(e.containerModifierClass + "grid"), "column" === e.grid.fill && t.classList.add(e.containerModifierClass + "grid-column"), u.emitContainerClasses()), n = i
        }), u.grid = {
            initSlides: e => {
                var t = u.params["slidesPerView"], {rows: i, fill: n} = u.params.grid,
                    e = (u.virtual && u.params.virtual.enabled ? u.virtual.slides : e).length;
                f = Math.floor(e / i), p = Math.floor(e / i) === e / i ? e : Math.ceil(e / i) * i, "auto" !== t && "row" === n && (p = Math.max(p, t * i)), h = p / i
            }, unsetSlides: () => {
                u.slides && u.slides.forEach(e => {
                    e.swiperSlideGridSet && (e.style.height = "", e.style[u.getDirectionLabel("margin-top")] = "")
                })
            }, updateSlide: (e, t, i) => {
                var n, r, s = u.params["slidesPerGroup"], a = m(), {rows: o, fill: l} = u.params.grid,
                    i = (u.virtual && u.params.virtual.enabled ? u.virtual.slides : i).length;
                let c, d;
                ...
                var {centeredSlides: t, roundLengths: n} = u.params, r = m(), s = u.params.grid["rows"];
                if (u.virtualSize = (e + r) * p, u.virtualSize = Math.ceil(u.virtualSize / s) - r, u.params.cssMode || (u.wrapperEl.style[u.getDirectionLabel("width")] = u.virtualSize + r + "px"), t) {
                    var a = [];
                    for (let t = 0; t < i.length; t += 1) {
                        let e = i[t];
                        n && (e = Math.floor(e)), i[t] < u.virtualSize + i[0] && a.push(e)
                    }
        ...
        e = e.swiper, Object.assign(e, {
            appendSlide: function (t) {
                ...
                if ("object" == typeof t && "length" in t) for (let e = 0; e < t.length; e += 1) t[e] && n(t[e]); else n(t);
                ...
                var s = e => {
                    var t;
                    "string" == typeof e ? ((t = document.createElement("div")).innerHTML = e, n.prepend(t.children[0]), t.innerHTML = "") : n.prepend(e)
                };
                if ("object" == typeof t && "length" in t) {
                    for (let e = 0; e < t.length; e += 1) t[e] && s(t[e]);
                    r = i + t.length
                } else s(t);
                this.recalcSlides(), e.loop && this.loopCreate(), e.observer && !this.isElement || this.update(), this.slideTo(r, 0, !1)
            }.bind(e), addSlide: function (t, i) {
                var n = this, {params: r, activeIndex: s, slidesEl: a} = n;
                let o = s;
                if (r.loop && (o -= n.loopedSlides, n.loopDestroy(), n.recalcSlides()), s = n.slides.length, t <= 0) n.prependSlide(i); else if (s <= t) n.appendSlide(i); else {
                    let e = o > t ? o + 1 : o;
                    var l = [];
                    for (let e = s - 1; e >= t; --e) {
                        var c = n.slides[e];
                    ...
                    n.recalcSlides(), r.loop && n.loopCreate(), r.observer && !n.isElement || n.update(), r.loop ? n.slideTo(e + n.loopedSlides, 0, !1) : n.slideTo(e, 0, !1)
                }
            }.bind(e), removeSlide: function (t) {
                var i = this, {params: e, activeIndex: n} = i;
                let r = n, s = (e.loop && (r -= i.loopedSlides, i.loopDestroy()), r), a;
                if ("object" == typeof t && "length" in t) for (let e = 0; e < t.length; e += 1) a = t[e], i.slides[a] && i.slides[a].remove(), a < s && --s; else a = t, i.slides[a] && i.slides[a].remove(), a < s && --s;
                s = Math.max(s, 0), i.recalcSlides(), e.loop && i.loopCreate(), e.observer && !i.isElement || i.update(), e.loop ? i.slideTo(s + i.loopedSlides, 0, !1) : i.slideTo(s, 0, !1)
        ...
        t({fadeEffect: {crossFade: !1}}), f({
            ...
            setTranslate: () => {
                ...
                for (let i = 0; i < e.length; i += 1) {
                    var n = s.slides[i];
                    let e = -n.swiperSlideOffset, t = (s.params.virtualTranslate || (e -= s.translate), 0);
                    ...
                    var r = s.params.fadeEffect.crossFade ? Math.max(1 - Math.abs(n.progress), 0) : 1 + Math.min(Math.max(n.progress, -1), 0),
                        n = w(0, n);
                    n.style.opacity = r, n.style.transform = `translate3d(${e}px, ${t}px, 0px)`
                }
            },
            setTransition: t => {
                ...
                }), m({swiper: s, duration: t, transformElements: e, allSlides: !0})
            },
            overwriteParams: () => ({
                slidesPerView: 1,
                slidesPerGroup: 1,
        ...
        const y = (e, t, i) => {
            ...
            n || (n = C("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (i ? "left" : "top")).split(" ")), e.append(n)), r || (r = C("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (i ? "right" : "bottom")).split(" ")), e.append(r)), n && (n.style.opacity = Math.max(-t, 0)), r && (r.style.opacity = Math.max(t, 0))
        };
        f({
            effect: "cube",
            swiper: v,
            on: i,
            setTranslate: () => {
                var e, {el: t, wrapperEl: i, slides: o, width: n, height: r, rtlTranslate: l, size: c, browser: s} = v,
                    d = v.params.cubeEffect, u = v.isHorizontal(), p = v.virtual && v.params.virtual.enabled;
                let h = 0, a;
                d.shadow && (u ? ((a = v.wrapperEl.querySelector(".swiper-cube-shadow")) || (a = C("div", "swiper-cube-shadow"), v.wrapperEl.append(a)), a.style.height = n + "px") : (a = t.querySelector(".swiper-cube-shadow")) || (a = C("div", "swiper-cube-shadow"), t.append(a)));
                for (let a = 0; a < o.length; a += 1) {
                    var f = o[a];
                    let e = a, t = 90 * (e = p ? parseInt(f.getAttribute("data-swiper-slide-index"), 10) : e),
                        i = Math.floor(t / 360);
                    l && (t = -t, i = Math.floor(-t / 360));
                    var m = Math.max(Math.min(f.progress, 1), -1);
                    let n = 0, r = 0, s = 0;
                    e % 4 == 0 ? (n = 4 * -i * c, s = 0) : (e - 1) % 4 == 0 ? (n = 0, s = 4 * -i * c) : (e - 2) % 4 == 0 ? (n = c + 4 * i * c, s = c) : (e - 3) % 4 == 0 && (n = -c, s = 3 * c + 4 * c * i), l && (n = -n), u || (r = n, n = 0);
                    var g = `rotateX(${u ? 0 : -t}deg) rotateY(${u ? t : 0}deg) translate3d(${n}px, ${r}px, ${s}px)`;
                    m <= 1 && -1 < m && (h = 90 * e + 90 * m, l && (h = 90 * -e - 90 * m), v.browser) && v.browser.isSafari && Math.abs(h) / 90 % 2 == 1 && (h += .001), f.style.transform = g, d.slideShadows && y(f, m, u)
                }
                i.style.transformOrigin = `50% 50% -${c / 2}px`, i.style["-webkit-transform-origin"] = `50% 50% -${c / 2}px`, d.shadow && (u ? a.style.transform = `translate3d(0px, ${n / 2 + d.shadowOffset}px, ${-n / 2}px) rotateX(89.99deg) rotateZ(0deg) scale(${d.shadowScale})` : (t = Math.abs(h) - 90 * Math.floor(Math.abs(h) / 90), n = 1.5 - (Math.sin(2 * t * Math.PI / 360) / 2 + Math.cos(2 * t * Math.PI / 360) / 2), t = d.shadowScale, n = d.shadowScale / n, e = d.shadowOffset, a.style.transform = `scale3d(${t}, 1, ${n}) translate3d(0px, ${r / 2 + e}px, ${-r / 2 / n}px) rotateX(-89.99deg)`));
                t = (s.isSafari || s.isWebView) && s.needPerspectiveFix ? -c / 2 : 0;
                i.style.transform = `translate3d(0px,0,${t}px) rotateX(${v.isHorizontal() ? 0 : h}deg) rotateY(${v.isHorizontal() ? -h : 0}deg)`, i.style.setProperty("--swiper-cube-translate-z", t + "px")
            },
            setTransition: t => {
                var {el: e, slides: i} = v;
                i.forEach(e => {
        ...
        const p = (e, t) => {
            ...
            i = i || x("flip", e, u.isHorizontal() ? "left" : "top"), n = n || x("flip", e, u.isHorizontal() ? "right" : "bottom"), i && (i.style.opacity = Math.max(-t, 0)), n && (n.style.opacity = Math.max(t, 0))
        };
        f({
            effect: "flip",
            swiper: u,
            on: i,
            setTranslate: () => {
                var {slides: a, rtlTranslate: o} = u, l = u.params.flipEffect;
                for (let s = 0; s < a.length; s += 1) {
                    var c = a[s];
                    let e = c.progress;
                    u.params.flipEffect.limitRotation && (e = Math.max(Math.min(c.progress, 1), -1));
                    var d = c.swiperSlideOffset;
                    let t = -180 * e, i = 0, n = u.params.cssMode ? -d - u.translate : -d, r = 0;
                    u.isHorizontal() ? o && (t = -t) : (r = n, n = 0, i = -t, t = 0), u.browser && u.browser.isSafari && (Math.abs(t) / 90 % 2 == 1 && (t += .001), Math.abs(i) / 90 % 2 == 1) && (i += .001), c.style.zIndex = -Math.abs(Math.round(e)) + a.length, l.slideShadows && p(c, e);
            ...
            recreateShadows: () => {
                u.params.flipEffect, u.slides.forEach(e => {
                    let t = e.progress;
                    u.params.flipEffect.limitRotation && (t = Math.max(Math.min(e.progress, 1), -1)), p(e, t)
                })
            },
        ...
        t({coverflowEffect: {rotate: 50, stretch: 0, depth: 100, scale: 1, modifier: 1, slideShadows: !0}}), f({
            effect: "coverflow", swiper: y, on: i, setTranslate: () => {
                var {width: e, height: t, slides: l, slidesSizesGrid: c} = y, d = y.params.coverflowEffect,
                    u = y.isHorizontal(), i = y.translate, p = u ? e / 2 - i : t / 2 - i, h = u ? d.rotate : -d.rotate,
                    f = d.depth;
                for (let o = 0, e = l.length; o < e; o += 1) {
                    var m = l[o], g = c[o], v = (p - m.swiperSlideOffset - g / 2) / g,
                        v = "function" == typeof d.modifier ? d.modifier(v) : v * d.modifier;
                    let e = u ? h * v : 0, t = u ? 0 : h * v, i = -f * Math.abs(v), n = d.stretch,
                        r = ("string" == typeof n && -1 !== n.indexOf("%") && (n = parseFloat(d.stretch) / 100 * g), u ? 0 : n * v),
                        s = u ? n * v : 0, a = 1 - (1 - d.scale) * Math.abs(v);
                    Math.abs(s) < .001 && (s = 0), Math.abs(r) < .001 && (r = 0), Math.abs(i) < .001 && (i = 0), Math.abs(e) < .001 && (e = 0), Math.abs(t) < .001 && (t = 0), Math.abs(a) < .001 && (a = 0), y.browser && y.browser.isSafari && (Math.abs(e) / 90 % 2 == 1 && (e += .001), Math.abs(t) / 90 % 2 == 1) && (t += .001);
                    g = `translate3d(${s}px,${r}px,${i}px)  rotateX(${t}deg) rotateY(${e}deg) scale(${a})`;
                    if (w(0, m).style.transform = g, m.style.zIndex = 1 - Math.abs(Math.round(v)), d.slideShadows) {
                        ...
                        e = e || x("coverflow", m, u ? "left" : "top"), t = t || x("coverflow", m, u ? "right" : "bottom"), e && (e.style.opacity = 0 < v ? v : 0), t && (t.style.opacity = 0 < -v ? -v : 0)
                    }
                }
            }, setTransition: t => {
        ...
        t({
            ...
            setTranslate: () => {
                ...
                for (let i = 0; i < r.length; i += 1) {
                    ...
                    let t = !1, n = (g.isHorizontal() || (f[1] = f[0], f[0] = 0), {
                        translate: [0, 0, 0],
                        rotate: [0, 0, 0],
                        scale: 1,
                        opacity: 1
                    });
                    h < 0 ? (n = s.next, t = !0) : 0 < h && (n = s.prev, t = !0), f.forEach((e, t) => {
                        f[t] = `calc(${e}px + (${e = n.translate[t], "string" == typeof e ? e : e + "px"} * ${Math.abs(h * a)}))`
                    }), m.forEach((e, t) => {
                        let i = n.rotate[t] * Math.abs(h * a);
                        g.browser && g.browser.isSafari && Math.abs(i) / 90 % 2 == 1 && (i += .001), m[t] = i
                    ...
                    if (t && n.shadow || !t) {
                        ...
                        (e = !e && n.shadow ? x("creative", l) : e) && (c = s.shadowPerProgress ? h * (1 / s.limitProgress) : h, e.style.opacity = Math.min(Math.max(Math.abs(c), 0), 1))
                    }
                    u = w(0, l);
                    u.style.transform = d, u.style.opacity = p, n.origin && (u.style.transformOrigin = n.origin)
                }
            },
            setTransition: t => {
                ...
                }), m({swiper: g, duration: t, transformElements: e, allSlides: !0})
            },
        ...
        t({cardsEffect: {slideShadows: !0, rotate: !0, perSlideRotate: 2, perSlideOffset: 8}}), f({
            effect: "cards",
            swiper: _,
            on: i,
            setTranslate: () => {
                var {slides: o, activeIndex: l, rtlTranslate: c} = _, d = _.params.cardsEffect, {
                    startTranslate: u,
                    isTouched: p
                } = _.touchEventsData, h = c ? -_.translate : _.translate;
                for (let a = 0; a < o.length; a += 1) {
                    var f = o[a], m = f.progress, g = Math.min(Math.max(m, -4), 4);
                    let e = f.swiperSlideOffset,
                        t = (_.params.centeredSlides && !_.params.cssMode && (_.wrapperEl.style.transform = `translateX(${_.minTranslate()}px)`), _.params.centeredSlides && _.params.cssMode && (e -= o[0].swiperSlideOffset), _.params.cssMode ? -e - _.translate : -e),
                        i = 0;
                    var v = -100 * Math.abs(g);
                    let n = 1, r = -d.perSlideRotate * g, s = d.perSlideOffset - .75 * Math.abs(g);
                    var y = _.virtual && _.params.virtual.enabled ? _.virtual.from + a : a,
                        ...
                        b = ((b || y) && (b = (1 - Math.abs((Math.abs(g) - .5) / .5)) ** .5, r += -28 * g * b, n += -.5 * b, s += 96 * b, i = -25 * b * Math.abs(g) + "%"), g < 0 ? t = `calc(${t}px ${c ? "-" : "+"} (${s * Math.abs(g)}%))` : 0 < g ? t = `calc(${t}px ${c ? "-" : "+"} (-${s * Math.abs(g)}%))` : t += "px", _.isHorizontal() || (y = i, i = t, t = y), g < 0 ? "" + (1 + (1 - n) * g) : "" + (1 - (1 - n) * g)),
                        y = `
      ...
      `;
                    ...
                    f.style.zIndex = -Math.abs(Math.round(m)) + o.length, w(0, f).style.transform = y
                }
            },
            setTransition: t => {
            ...
            perspective: () => !0,
            overwriteParams: () => ({watchSlidesProgress: !0, virtualTranslate: !_.params.cssMode})
        })
    }]), h
}();