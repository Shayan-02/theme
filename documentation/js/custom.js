...
$(document).ready(function () {
    ...
    var $buythemediv = '<div class="buy-theme alt-font sm-display-none"><a href="https://el-dorado.ir" target="_blank"><i class="ti-shopping-cart"></i><span>خرید کنید</span></a></div><div class="all-demo alt-font sm-display-none"><a href="mailto:info@el-dorado.ir?subject=Crafto – The Multipurpose HTML5 Template - Quick Question"><i class="ti-email"></i><span>سوال?</span></a></div>';
